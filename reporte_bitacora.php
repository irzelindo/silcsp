		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>REPORTE DE BITACORA DE AUDITORIA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="lista_bitacora_de_auditoria.php" target="_blank">
...
if ($_GET["mensage"]==4) 
 {
	echo "<script type=''>
      swal('','Debe indicar al menos un par\u00e1metro !','warning');
      </script>"; 
 }

	...
	<script>
		...
		$( function () {
			...
			jQuery( "#listapacientes" ).jqGrid( {
				url: 'datosresultadofecha.php?codsector=<?php echo $codsector; ?>&codestudio=<?php echo $codestudio; ?>&desde=<?php echo $desde; ?>&hasta=<?php echo $hasta; ?>',
				datatype: 'json',
				mtype: 'GET',
				loadonce: true,
				height: 330,
		...
		function gridReload() {
			...
			jQuery( "#listapacientes" ).jqGrid( 'setGridParam', {
				url: "datosresultadofecha.php?codsector=" + codsector + "&codestudio=" + codestudio + "&desde=" + desde + "&hasta=" + hasta,
				datatype: 'json'
			} ).trigger( "reloadGrid" );
		...
		function GenerarAgrupamiento()
		{
			...
			var s = jQuery("#listapacientes").jqGrid('getGridParam','selarrrow'), selnordentra = [], selestudio = [], selmicrobiologia = [];
			...
			if(cantidad != 0)
			{
				...
				jQuery.ajax({
						url:'nuevo_agrupadofecha.php',
						type:'POST',
						dataType:'json',
						data:{codsector:codsector, codestudio:codestudio, nordentra:selnordentra, microbiologia:selmicrobiologia, codresultado:codresultado, codestudio1:selestudio, cantidad:cantidad}
						...
						// 	}, 1000);
						// }
						// else{ swal("Registros ya Agrupados!", "", "warning"); }
					});
			}
			else
			{
				...
				<div class="row">
					<div id="page1Layer1_Container">
						...
						if ( $v_211 == 2 || $v_211 == 3 ) {
							...
							echo '<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" id="button">Cargar Resultado</button>';

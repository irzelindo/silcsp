...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $codanula    = $_SESSION['codanula'];
  $nomanula    = $_SESSION['nomanula'];  
  }
else
  {
  $codanula     = "";
...
{ 
     	if (window.document.formu.codanula.value == "" || window.document.formu.nomanula.value == "") 
		    {
            if(window.document.formu.codanula.value == "")
              {
    		    window.document.formu.codanula.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codanula.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_motivo_anulacion.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codanula" id="codanula" size="10" maxlength="10" value="<?php echo $codanula; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificamotivoanulacion()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

...
$(function() {
    ...
    jQuery("#listamedicos").jqGrid({
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Nombre','Ciudad'],
        colModel:[
...
<div id="page1Layer1">
    ...
    <?php
       if ($v_424==2 || $v_424==3)
          {
             echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_medicos.php\';">Agregar</span></button>';

           //echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_medicos.php\';" name="agregar" value="Agregar">';

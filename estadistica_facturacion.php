		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>REPORTE DE ESTADISTICAS DE FACTURACION</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<form name="formu" method="post" action="estadistica_facturacion2.php" target="_blank">
...
<div id="wb_LayoutGrid6">
	<div id="LayoutGrid6">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line14"/>
				<input type="date" id="fecha1" name="desde" value="<?php echo $fecha1 = date("Y-m-d"); ?>" spellcheck="false"/>
				<hr id="Line15"/>
			</div>
		</div>
	</div>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line12"/>
				<input type="date" id="fecha2" name="hasta" value="<?php echo $fecha2 = date("Y-m-d");?>" spellcheck="false"/>
				<hr id="Line16"/>
			</div>
		</div>
	</div>
				...
				<tr>
					<td class="cell0">
						<div id="wb_RadioButton3">
							<input type="radio" id="ambos" name="tipo" value="3"<?php if($tipo == 3){ echo  "checked";}?>/><label for="ambos"></label>
						</div>
					</td>
					<td class="cell0">

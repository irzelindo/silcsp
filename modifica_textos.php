...
$codtexto  = $_GET["id"]; //Identificador del registro
$query = "select * from textos where codtexto = '$codtexto'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomtexto = $row["nomtexto"];
$eltexto = $row["texto"];
...
$accion="Accede a Textos: ".$codtexto."-".$nomtexto;
...
{ 
     	if (window.document.formu.codtexto.value == "" || window.document.formu.nomtexto.value == "" || window.document.formu.eltexto.value == "") 
		    {
            if(window.document.formu.codtexto.value == "")
              {
    		    window.document.formu.codtexto.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codtexto.style.backgroundColor='white';    
              }  
            if(window.document.formu.nomtexto.value == "")
              {
    		    window.document.formu.nomtexto.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomtexto.style.backgroundColor='white';    
              }  
            if(window.document.formu.eltexto.value == "")
              {
    		    window.document.formu.eltexto.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.eltexto.style.backgroundColor='white';    
              }  
...
{
   var anterior=window.document.formu.eltexto.value;
   window.document.formu.eltexto.value=''+anterior.trim();	
   window.document.formu.eltexto.focus();  
}
</script>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR TEXTOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_textos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codtexto" id="codtexto" size="10" maxlength="10" readonly="" value="<?php echo $codtexto; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomtexto" name="nomtexto" size="100" maxlength="100" value="<?php echo $nomtexto;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomtextox" name="nomtextox" value="<?php echo $nomtexto;?>"/>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <textarea class="form-control" id="eltexto" name="eltexto" rows="3" cols="71" spellcheck="false" onfocus="poneralcomienzo();" ><?php echo $eltexto; ?></textarea>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_438==2 || $v_438==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificatextos()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='textos.php';"> VOLVER </a>&nbsp;]</span>

...
$(function() {
    ...
    jQuery("#listaroles").jqGrid({
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Descripci&oacute;n','estado'],
        colModel:[
                ...
                {name:'codrol',index:'codrol', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                
                {name:'nomrol',index: "nomrol", width: 577, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'estado',index: "estado", width: 177, editable: true, searchoptions: {attr: {maxlength: 20,size: 20,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
	...
	grid = $("#listaroles");							
//	jQuery("#listaroles").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaroles").jqGrid('setFrozenColumns');

    jQuery("#listaroles").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_roles.php?id=" + cod ;
			  } 
			  else 
			  {
	...
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_413==2 || $v_413==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_roles.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_roles.php\';" name="agregar" value="Agregar">';

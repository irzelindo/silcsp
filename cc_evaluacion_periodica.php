		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>CONTROL DE CALIDAD DE EVALUACION PERIODICA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<form name="formu" method="post" action="cc_evaluacion_periodica2.php" target="_blank">
<div id="wb_LayoutGrid6">
	<div id="LayoutGrid6">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line14"/>
				<input type="text" id="mes" name="mes" value="" maxlength="2" spellcheck="false" placeholder="mm"/>
				<hr id="Line15"/>
			</div>
		</div>
	</div>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line12"/>
				<input type="text" id="anho" name="anho" value="" maxlength="4" spellcheck="false" placeholder="aaaa"/>
				<hr id="Line16"/>
			</div>
		</div>
	</div>

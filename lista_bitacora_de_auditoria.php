...
$codigo_opc=trim($_POST['codigo_opc']);
...
if ($tiporeporte==1)//Navegador
   ...
   print '<head><link rel="shortcut icon" href="images/icono.ico"/><link rel="stylesheet" type="text/css" href="images/style.css" />'
         .'<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes"/><title>Reporte - Bit&aacute;cora de Auditoria</title><script type="text/javascript" src="reflection.js"></script></head><body style="color: black;background: white;font-size: 90%;">';	
   }
   ...
   else // esta con algo cargado
      {
         ...
         if ($di2=="" && $me2=="" && $an2=="")  // SI FECHA HASTA ES BLANCO
            ...
            if ($ok1=="SI" && $ok2=="SI")
               ...
               if ($codigo_opc!="")
                  {
   	              $sql1 = "select * from opciones where codopc='$codigo_opc'";
   	              ...
   	              if ($condicion=="")
   	                 {
   	   	             ...
   	   	             if ($subtit=="")
   	   	                {
   	   	   	            $subtit="Opci&oacute;n del sistema: ".$nomopc;
   	   	                }
   	   	             else
   	   	                {
   	   	   	            $subtit=$subtit.", Opci&oacute;n del sistema: ".$nomopc;
   	   	                }
   	                 }
   	              else
   	                 {
              ...
              if ($mensage==5)
                 ...
                 {
                 $sql = "select * from bitacora where codusu<>'' and ".$condicion." order by codusu,fecha,hora";
                 ...
                 if ($numeroRegistros<=0)
                  ...
                  //  echo '<br /><strong>Sistema Nacional de Informaci&oacute;n en Salud (SINAIS)</strong>';
                    ...
                    echo '<p style="margin-left:0px"><strong>&nbsp;REPORTE DE AUDITORIA</strong></p></td>';
	                echo '</tr></table>';
                    ...
                    print '<br><table class="cuadro">'
		                  ...
		                  .'<td class="hr">Hora</td>'
		                  .'<td class="hr">Acci&oacute;n realizada</td>'
		                  .'<td class="hr">Nro. IP</td></tr>';
                    ...
                    while ($row = pg_fetch_array($res))
                          ...
                          $acc=acentos($row['accion']);
 		                  print '<tr>'
		                       ...
		                       .'<td class="tr" width="540px">'.$row['accion'] .'</td>'
		                       .'<td class="tr">'.$row['nroip'] .'</td>'
		                       .'</tr>';
	                       }
	                 print '</table><br />';
                     ...
                     $accion="Reporte Bitacora: ".$subtit;
					 ...
					 else // EXCEL
					 {
                      ...
                      print  '<table border=1>'
	                        .'<tr><td style="font-weight:bold;font-size:1em;background-color:#F1F1F1;color:black;" colspan="5">REPORTE DE AUDITORIA</td></tr>'
	                        .'<tr>'
                      ...
                      print  '<tr style="background-color:#F1F1F1;color:black;">'	
                            ...
                            .'<td style="font-size:1em; width:900px;font-weight: bold;">Acci&oacute;n realizada</td>'
                            .'<td style="font-size:1em; width:100px;font-weight: bold;">Nro. de IP</td>'
                            .'</tr>';
                    while ($row = pg_fetch_array($res))
	                      {
                          $fu = $row["fecha"];
                     ...
                     $fechaxx=date("Y-n-j", time());
                     $hora=date("G:i:s",time());
                     $accion="Reporte Bitacora XLS: ".$subtit;
                     $terminal = $_SERVER['REMOTE_ADDR'];
                     $a=archdlog($codusu,$codopcx,$fechaxx,$hora,$accion,$terminal);
                     // Fin grabacion de registro de auditoria					 	
					 }	

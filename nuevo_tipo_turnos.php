...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  ...
  $nomturno      = $_SESSION['nomturno'];

  $cantlun      = $_SESSION['cantlun'];
  $cantmar      = $_SESSION['cantmar'];
  $cantmie      = $_SESSION['cantmie'];
  $cantjue      = $_SESSION['cantjue'];
  $cantvie      = $_SESSION['cantvie'];
  $cantsab      = $_SESSION['cantsab'];
  $cantdom      = $_SESSION['cantdom'];
  $horarlun      = $_SESSION['horarlun'];
  $horarmar      = $_SESSION['horarmar'];
  $horarmie      = $_SESSION['horarmie'];
  $horarjue      = $_SESSION['horarjue'];
  $horarvie      = $_SESSION['horarvie'];
  $horarsab      = $_SESSION['horarsab'];
  $horardom      = $_SESSION['horardom'];
  }
else
  {
  $region       = "";
...
<form name="formu" method="post" action="insertar_tipo_turnos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="asigna el sistema" name="codturno" id="codturno" style="background-color: #CCCCCC;" size="10" maxlength="10" value="<?php echo $codturno; ?>" onkeypress="return validarcar(event)" spellcheck="false" readonly=""/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificatiposturnos()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

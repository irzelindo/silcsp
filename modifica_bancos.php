...
$codbco  = $_GET["id"]; //Identificador del registro
$query = "select * from bancos where codbco = '$codbco'";
...
$accion="Accede a Bancos ".$codbco."-".$nombco;
...
{ 
     	if (window.document.formu.nombco.value == "") 
		    {
  
            if(window.document.formu.nombco.value == "")
              {
    		    window.document.formu.nombco.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nombco.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR BANCOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_bancos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codbco" id="codbco" size="10" maxlength="10" readonly="" value="<?php echo $codbco; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nombco" name="nombco" size="100" maxlength="100" value="<?php echo $nombco;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nombcox" name="nombcox" value="<?php echo $nombco;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_443==2 || $v_443==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificabancos()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='bancos.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codbco.style.backgroundColor='yellow';

...
#cuadros_configurados_pacientesCombobox1
{
   border: 1px #CCCCCC solid;
   border-radius: 4px;
   background-color: #FFFFFF;
...
#cuadros_configurados_pacientesCombobox1:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>CUADROS CONFIGURADOS DE RESULTADOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
		...
		<div class="row">
			...
			<div class="col-2">
				...
				<select name="empresas_detallesCombobox1" size="1" id="estadistica_pacientesCombobox1">
					...
					<option>REGIONES SANITARIAS</option>
	...
	<div id="cuadros_configurados_pacientesLayoutGrid1">
		<div class="row">
			...
			<div class="col-2">
				...
				<select name="empresas_detallesCombobox1" size="1" id="cuadros_configurados_pacientesCombobox1">
					<option></option>
					<option value="001">MESES</option>
					<option value="002">SEMESTRES</option>
					<option>REGIONES SANITARIAS</option>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_reporte_bitacoraImage1">
					<a href="./resultados_configurados2.html" target="_blank"><img src="images/navegador.png" id="reporte_bitacoraImage1" alt=""/></a>
				</div>
				<hr id="Line17"/>
				<hr id="Line18"/>
			</div>

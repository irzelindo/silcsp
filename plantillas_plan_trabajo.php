...
$(function() {
    ...
    jQuery("#listaplantillaplan").jqGrid({
        url:'datosplantillasplantrabajo.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Nombre de la Plantilla'],
        colModel:[
                ...
                {name:'codplatilla',index:'codplatilla', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomplatilla',index: "nomplatilla", width: 727, editable: true, searchoptions: {attr: {maxlength: 200,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
                                  
                caption: "PLANTILLAS DE PLANES DE TRABAJO",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],

                sortname: 'nomplatilla',
                sortorder: 'asc',
                viewrecords: true,
				editable: true,    
	...
	grid = $("#listaplantillaplan");							
//	jQuery("#listaplantillaplan").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaplantillaplan").jqGrid('setFrozenColumns');

    jQuery("#listaplantillaplan").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_plantillas_plan_trabajo.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listaplantillaplan"></table>
        <div id="perpage"></div>
      </div>        
        <br />
    	...
    	<?php
         if ($v_4318==2 || $v_4318==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_plantillas_plan_trabajo.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_plantillas_plan_trabajo.php\';" name="agregar" value="Agregar">';

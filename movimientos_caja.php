		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>REPORTE DE MOVIMIENTOS DE CAJA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<form name="formu" method="post" action="movimientos_caja2.php" target="_blank">
				...
				<tr>
                    <td class="cell0">
						<div id="wb_RadioButton6">
							<input type="radio" id="estadoambos" name="estado" value="3" checked="true" <?php if($estado == 3){ echo  "checked";}?>/><label for="ambos"></label>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_page1Text3">
							<span style="color:#808080;font-family:Arial;font-size:13px;"> Ambos</span>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_RadioButton4">
							<input type="radio" id="vigente" name="estado" value="1"<?php if($estado == 1){ echo  "checked";}?>/><label for="vigente"></label>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_page1Text1">
							<span style="color:#808080;font-family:Arial;font-size:13px;"> Vigente</span>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_RadioButton5">
							<input type="radio" id="anulado" name="estado" value="2"<?php if($estado == 2){ echo  "checked";}?>/><label for="anulado"></label>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_Text6">
							<span style="color:#808080;font-family:Arial;font-size:13px;"> Anulado</span>
						</div>
					</td>
				</tr>
				</table>
	...
	<div id="LayoutGrid5">
		<div class="row">
			<div class="col-1">
				<hr id="Line6"/>
				<div id="wb_Text3">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Forma de pago: <br/>
					</strong></span>
				</div>
			</div>
			<div class="col-2">
				...
				<tr>
                    <td class="cell0">
						<div id="wb_RadioButton3">
							<input type="radio" id="ambos" name="tipo" value="3" checked="true" <?php if($tipo == 3){ echo  "checked";}?>/><label for="ambos"></label>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_page1Text3">
					...
					<td class="cell0">
						<div id="wb_RadioButton1">
							<input type="radio" id="caja" name="tipo" value="1"<?php if($tipo == 1){ echo  "checked";}?>/><label for="caja"></label>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_page1Text1">
							<span style="color:#808080;font-family:Arial;font-size:13px;"> En Caja</span>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_RadioButton2">
							<input type="radio" id="banco" name="tipo" value="2"<?php if($tipo == 2){ echo  "checked";}?>/><label for="banco"></label>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_Text6">
							<span style="color:#808080;font-family:Arial;font-size:13px;"> Homebanking</span>
						</div>
					</td>
				</tr>
				</table>

...
$codantibiogr  = $_GET["codantibiogr"]; //Identificador del registro
$codantibiot  = $_GET["codantibiot"]; //Identificador del registro

$_SESSION['codantibiogr']=$codantibiogr;
$_SESSION['codantibiot']=$codantibiot;
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR ANTIBIOTICOS RELACIONADOS A ANTIBIOGRAMAS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_antibioticosrel.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codantibiogr" id="codantibiogr" style="background-color: #CCCCCC;" size="10" maxlength="10" value="<?php echo $codantibiogr; ?>" onkeypress="return validarcar(event)" readonly="" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomantibiogr" name="nomantibiogr" style="background-color: #CCCCCC;" size="100" maxlength="100" value="<?php echo $nomantibiogr;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" readonly="" spellcheck="false"/>
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Antibi&oacute;tico: </strong></span>
    				</div>
    			</div>
    			<div class="col-2">
    				<hr id="Line1"/>
    				<select name="codantibiot" size="1" id="codantibiot">
    					<option value=""></option>
                        <?php
            			$tabla_dpto = pg_query($link, "select * from antibioticos order by nomantibiot");
            			while($depto = pg_fetch_array($tabla_dpto)) 
            			{
            		       if($depto["codantibiot"]==$codantibiot)
                             {//Para que ponga predeterminado el que hay guardado
                             ?>
            		          <option value = "<?php echo $depto['codantibiot']; ?>" selected="" > 
            	              <?php echo $depto['nomantibiot']; ?></option>
                              <?php 
            			  	  }
                              else
            				  {?>
            		          <option value = "<?php echo $depto['codantibiot']; ?>" > 
            		          <?php echo $depto['nomantibiot']; ?></option>
                              <?php
            				  }?> 
                        <?php
                    ...
                    <input type="hidden" name="codantibiotx" id="codantibiotx" value="<?php echo $codantibiot; ?>"/>
    				<hr id="Line8"/>
    			</div>
    		</div>
    	</div>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaantibiotico()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_antibiogramas.php?id=<?php echo $codantibiogr; ?>';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
	...
	echo "<script type=''>
    window.document.formu.codantibiot.style.backgroundColor='yellow';
     swal('','Ya existe Antibi\u00f3tico relacionado a este Antibiograma!','error');
     </script>"; 
    }

...
function ValidarFormulario($form) {
	...
	if ($mensaje == "") 
	{
		...
		$respuesta->redirect("notificacion.php");
		...
		// Bitacora
			...
			$accion = "Notificacion: Modifica-Reg.: Nro. Notificacion: " . $nronotif;
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='notificacion.php'"> VOLVER </a>&nbsp;]</span>

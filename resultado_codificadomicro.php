...
$(function() {
    ...
    jQuery("#listaresultadocodificadobio").jqGrid({
        url:'datosresultadocodificadomicro.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Descripci&oacute;n'],
        colModel:[
                ...
                {name:'codresultado',index:'codresultado', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomresultado',index: "nomresultado", width: 727, editable: true, searchoptions: {attr: {maxlength: 250,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
                                  
                caption: "RESULTADOS MICROBIOLOGIA POSIBLES CODIFICADOS",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],

                sortname: 'nomresultado',
                sortorder: 'asc',
                viewrecords: true,
				editable: true,    
	...
	grid = $("#listaresultadocodificadobio");							
//	jQuery("#listaresultadocodificadobio").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaresultadocodificadobio").jqGrid('setFrozenColumns');

    jQuery("#listaresultadocodificadobio").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_resultado_codificadomicro.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listaresultadocodificadobio"></table>
        <div id="perpage"></div>
      </div>        
        <br />
    	...
    	<?php
         if ($v_4317==2 || $v_4317==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_resultado_codificadomicro.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_resultado_codificadomicro.php\';" name="agregar" value="Agregar">';

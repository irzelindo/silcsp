...
{
  $unro = pg_query( $link, "select max(cast(codempresa as int)) as ultimo from empresas" );
...
<form name="formu" method="post" action="insertar_empresas_caja.php">
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $codempresa; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="razonsocial" name="razonsocial" size="100" maxlength="200" value="<?php echo $razonsocial;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" autofocus spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<button type="button" id="Buttonc" class="btn btn-primary btn-lg" onclick="verificaempresas()">Guardar Datos</button>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='empresa_caja.php';"> VOLVER </a>&nbsp;]</span>

...
{ 
// Conexión para el tipo de moneda.

$tipo_mon=strtoupper('guaranies');
...
$xaux_int = $xcifra;
$xdecimales = "00";
//$tipo_mon = strtoupper('$_GET["tipo_mon"]');
//$tipo_mon = strtoupper('Dólares Americanos');
...
for($xz = 0; $xz < 3; $xz++)
    ...
    while ($xexit)
        ...
        if (substr($xcadena, -6, 6) == "MILLÓN") // si la cadena obtenida termina en MILLÓN, entonces le agrega al fina la palabra DE
            $xcadena.= " DE";
        ...
        $xcadena = str_replace("UNO UNO", "UN", $xcadena); // quito la duplicidad
        $xcadena = str_replace("UNO MIL", "UN MIL", $xcadena); // corrijo la leyenda
        $xcadena = str_replace("  ", " ", $xcadena); // quito espacios dobles 
        $xcadena = str_replace("BILLÓN MILLONES", "BILLÓN", $xcadena); // corrijo la leyenda

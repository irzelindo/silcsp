...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $coddiagnostico    = $_SESSION['coddiagnostico'];
  $nomdiagnostico    = $_SESSION['nomdiagnostico'];  
  }
else
  {
  $coddiagnostico     = "";
...
{ 
     	if (window.document.formu.coddiagnostico.value == "" || window.document.formu.nomdiagnostico.value == "") 
		    {
            if(window.document.formu.coddiagnostico.value == "")
              {
    		    window.document.formu.coddiagnostico.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.coddiagnostico.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_diagnostico.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="coddiagnostico" id="coddiagnostico" size="10" maxlength="10" value="<?php echo $coddiagnostico; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificadiagnostico()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

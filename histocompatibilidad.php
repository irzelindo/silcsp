...
<head>
	...
	<style>
		...
		#nordentra, #estudio, #observacion, #observacion_adicional {
			border: 1px #CCCCCC solid;
			border-radius: 4px;
		...
		#nordentra:focus, #estudio:focus, #observacion:focus, #observacion_adicional:focus {
			border-color: #66AFE9;
			-webkit-box-shadow: inset 0px 1px 1px rgba(0, 0, 0, 0.075), 0px 0px 8px rgba(102, 175, 233, 0.60);
			-moz-box-shadow: inset 0px 1px 1px rgba(0, 0, 0, 0.075), 0px 0px 8px rgba(102, 175, 233, 0.60);
			box-shadow: inset 0px 1px 1px rgba(0, 0, 0, 0.075), 0px 0px 8px rgba(102, 175, 233, 0.60);
...
<body onload="gridReload()">
	...
	<form name="formu" id="formu" method="get" target="_blank" autocomplete="off">
		<input type="hidden" id="tipo" name="tipo" value="TIPI">
			...
			<div id="pacientesLayoutGrid1">
				...
				<div class="row">
					<div class="col-1">
						<hr id="Line2">
						<div id="wb_Text2">
							<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nro. Orden/Sample Id:  </strong></span>
						</div>
						<hr id="Line3">
					</div>
					...
					<div class="col-2">
						<hr id="Line4">
						<input type="text" id="nordentra" name="nordentra" value="<?php echo $nordentra; ?>" spellcheck="false">
						<hr id="Line5">
					</div>
				...
				<div class="row">
					<div id="page1Layer1_Container">
						...
						if ( $v_211 == 2 || $v_211 == 3 ) {
							...
							echo '<button type="button" id="imprimir" class="btn btn-primary btn-lg">Imprimir Resultado</button>';
	...
	<script>
		$(document).ready(function(){
			...
			$("#imprimir").click(function(){
				window.open("/impresion_resultados_"+$("#estudio").val()+".php?tipo=TIPI&nordentra="+$("#nordentra").val(),"_blank");
			});
		});
	</script>

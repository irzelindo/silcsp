...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_antibioticos.php?id=" + cod ;
			  } 
			  else 
			  {
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_4316==2 || $v_4316==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_antibioticos.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_antibioticos.php\';" name="agregar" value="Agregar">';

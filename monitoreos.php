...
$(function() {
    ...
    jQuery("#listamonitoreos").jqGrid({
        url: 'datosmonitoreo.php',
        datatype: 'json',
        mtype: 'GET',
        loadonce: true,
        height: 320,
        ...
        pagerpos: 'right',
        gridview: true,
        colNames: ['Consultar', 'Borrar', 'C&oacute;digo','Laboratorio', 'Regi&oacute;n Sanitaria', 'Fecha'],
        colModel: [
            { name: 'consultar', width: 80, resizable: false, align: "center", sorttype: "int", editable: false, editoptions: { maxlength: "50" }, search: false },
            { name: 'borrar', width: 80, resizable: false, align: "center", sorttype: "int", editable: false, editoptions: { maxlength: "50" }, search: false },
            { name: 'codmonitoreo', index: "codmonitoreo", width: 80, editable: true, searchoptions: { attr: { maxlength: 10, size: 50, style: "width:auto;padding:1;max-width:100%;height:3em;float:left" } } },
            { name: 'laboratorio', index: 'laboratorio', width: 250, align: "left", editable: true, searchoptions: { attr: { maxlength: 200, size: 100, style: "width:auto;padding:1;max-width:100%;height:3em;float:left" } } },
            { name: 'nomreg', index: "nomreg", width: 250, editable: true, searchoptions: { attr: { maxlength: 50, size: 50, style: "width:auto;padding:1;max-width:100%;height:3em;float:left" } } },
            { name: 'fecha', index: "fecha", width: 250, editable: true, searchoptions: { attr: { maxlength: 60, size: 60, style: "width:auto;padding:1;max-width:100%;height:3em;float:left" } } }
        ],
        caption: "Monitoreos",
        ignoreCase: true,
        pager: '#perpage',
    ...
    grid = $("#listamonitoreos");
    jQuery("#listamonitoreos").jqGrid('setFrozenColumns');

    // Barra de búsqueda
    jQuery("#listamonitoreos").jqGrid('filterToolbar', { stringResult: true, searchOnEnter: false, defaultSearch: "cn" });
});
         ...
         if ($v_455==2 || $v_455==3) 
            {
             ...
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_monitoreo.php\';" name="agregar" value="Agregar">';

            }
         ?> 
      <div class="jqGrid">
        <br/>
        <table id="listamonitoreos"></table>
        <div id="perpage"></div>
      </div>        
        <br />

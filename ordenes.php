...
$(function() {
    ...
    jQuery("#listapacientes").jqGrid({
        ...
        colNames:['Revisar','Borrar','Nro. Orden',  'Fecha', 'Hora', 'Nombres y Apellidos', 'Establecimiento Actual', 'Origen Paciente'],
        colModel:[
				 ...
				 if ($v_13==2 || $v_13==3)
					{
					 ...
					 echo '<button type="button" class="btn btn-primary btn-lg" id="Button10" onclick="window.location.href=\'vista_fichas.php\';">Agregar Codigo</button>';
...
{
	echo "<script type=''>
     swal('Error al borrar este registro !!!','','error');
     </script>";
}
if ($_GET["mensage"]==1)
{

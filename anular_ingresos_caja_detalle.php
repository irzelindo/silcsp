...
$reciboide   = $row["reciboide"];
$formapago   = $row["formapago"];
$otrafp      = $row["otrafp"];
$estado      = $row["estado"];
$arqueado    = $row["arqueado"];
$codanula    = $row["codanula"];
...
function ValidarFormulario($form) {
	...
	if ( $codanula == "") {
		$mensaje .= '- Rellene el campo Motivo de Anulacion!';

		$respuesta->Assign( "codanula", "style.backgroundColor", "yellow" );

	} else {
		$respuesta->Assign( "codanula", "style.backgroundColor", "white" );
	}

	if ( $mensaje == "" ) 
	{
		pg_query($con,"UPDATE ingresocaja
						SET estado='2', codanula='$codanula'
						WHERE nrorecibo='$nrorecibo2' and nroreciboser='$nroserie2' and nroingreso = '$nroingreso'");

		$respuesta->script('swal("Datos Anulado Exitosamente!", "", "success")');
		...
		// Bitacora
			...
			$accion = "Anulacion por Caja: Inserta-Reg.: Nro. Ingreso: " . $nroingreso;
...
<head>
	...
	<script>
		$( function () {
			...
			jQuery( "#listaconceptos" ).jqGrid( {
				url: 'datosarancelescaja1.php?nroingreso=<?php echo $nroingreso; ?>&nrorecibo=<?php echo $nrorecibo; ?>&nroreciboser=<?php echo $nroreciboser; ?>',
				datatype: 'json',
				mtype: 'GET',
				loadonce: true,
				height: 200,
				...
				colNames: ['Nro.', 'C&oacute;digo Arancel', 'Concepto', 'Monto'],
				colModel: [ {
					name: 'norden',
					index: 'norden',
					width: 120,
	...
	<script language="JavaScript">
		...
		function AgregarAranacel() 
		{
    		var nroingreso   = window.document.formu.nroingreso.value;
			var nrorecibo    = window.document.formu.nrorecibo.value;
			var nroreciboser = window.document.formu.nroreciboser.value;
			
			window.open("nuevo_arancel_caja.php?nroingreso="+nroingreso+"&nrorecibo="+nrorecibo+"&nroreciboser="+nroreciboser,'_self');
		}
		...
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
				  ...
				  <input type="text" id="nroingreso" name="nroingreso" value="<?php echo $nroingreso; ?>" readonly style="font-size: 30px">
...
<div id="wb_turnos_detallesLayoutGrid5">
	<div id="turnos_detallesLayoutGrid5">
		<div class="row">
			...
			<div class="col-2">
				<hr id="turnos_detallesLine14">
			  <input type="text" id="nrorecibo2" name="nrorecibo2" value="<?php echo $nrorecibo; ?>" style="background-color: #DCDCDC; font-size: 20px;" readonly>
				<hr id="turnos_detallesLine15">
			</div>
		</div>
	</div>
	...
	<div id="wb_turnos_detallesLayoutGrid5">
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="text" id="nroserie2" name="nroserie2" value="<?php echo $nroreciboser; ?>" style="background-color: #DCDCDC; font-size: 20px;" readonly>
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
	...
	<div id="wb_turnos_detallesLayoutGrid1">
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine3">
				  <select name="formapago" size="1" id="formapago" onChange="OtroPago()" <?php if($formapago != ''){echo "disabled";}?> style="<?php if($formapago != ''){echo "background-color: #DCDCDC";}?>">
                        <option value=""></option>
					...
					<input type="hidden" name="formapago1" id="formapago1" value="<?php echo $formapago; ?>">
				  <hr id="turnos_detallesLine2">
				</div>
			</div>
		</div>
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Arqueado: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
				  <select name="arqueado" size="1" id="arqueado" disabled style="background-color: #DCDCDC">
                        <option value=""></option>
                        <option value="1" <?php if($arqueado == 1){ echo "selected";} ?>>SI</option>
						<option value="2" <?php if($arqueado == 2){ echo "selected";} ?>>NO</option>
    				</select>
				  <hr id="turnos_detallesLine2">
				</div>
			</div>
		...
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-1">
					<hr id="turnos_detallesLine13">
					<div id="wb_turnos_detallesText4">
					  <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Motivo de Anulaci&oacute;n: <br></strong></span>
				  </div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  	<select name="codanula" size="1" id="codanula" autofocus>
						<option value=""></option>
                        <?php
							$tabla_dpto = pg_query($link, "select * from motivoanulacion");
							while($depto = pg_fetch_array($tabla_dpto)) 
							{
							   if(trim($codanula) == trim($depto["codanula"]))
								{
									echo '<option value="'.$depto["codanula"].'" selected>'.$depto["nomanula"].'</option>';
								}
								else
								{
									echo '<option value="'.$depto["codanula"].'">'.$depto["nomanula"].'</option>';
								}
							}
            			?>		
					</select>

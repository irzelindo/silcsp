...
{ 
     	if (window.document.formu.codsector.value == "" || window.document.formu.nomsector.value == "") 
		    {
            if(window.document.formu.codsector.value == "")
              {
    		    window.document.formu.codsector.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codsector.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_sectores.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codsector" id="codsector" size="10" maxlength="10" value="<?php echo $codsector; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
	...
	<div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="posicion" id="posicion" size="5" maxlength="5" value="<?php echo $posicion; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificasector()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

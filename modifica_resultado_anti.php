...
$query4 = "select * from resultadoantibiotico where nordentra = '$nordentra' and codservicio = '$codservicio' and codestudio = '$codestudio' and nroresul = '$nroresul'";
$result4 = pg_query($link,$query4);

$row4 = pg_fetch_assoc($result4);

$codantibiot 	= $row4["codantibiot"];
$resultado      = $row4["resultado"];
$diametro   	= $row4["diametro"];
$cmi		   	= $row4["cmi"];
$obs     		= $row4["obs"];
...
function ValidarFormulario($form) {
	...
	if ( $mensaje == "" ) {
		...
		pg_query( $con, "UPDATE public.resultadoantibiotico
	SET codmetodo='$codmetodo1', codumedida='$codumedida1', codsector='$codsector1', codantibiot='$codantibiot', resultado='$resultado', diametro='$diametro', obs='$obs', cmi='$cmi'

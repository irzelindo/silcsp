...
$codempresa  = $_GET["id"]; //Identificador del registro

$query = "SELECT 
m.codmonitoreo, r.nomreg, m.laboratorio, m.horario, se.numero_semana, se.desde, se.hasta,
m.cantidad_pacientes , m.cantidad_paciente_bio, m.pruebas_total, m.numero_muestras_bio,
m.pcr, m.elisa_igc, m.elisa_igm, m.elisa_ns1, m.muestras_lcsp_enviadas,
m.paciente_hospitalizado, m.paciente_obito, m.paciente_ambulatoria, m.personal_activo, 
m.bioquimico, m.tecnico, m.apoyo_administrativo, m.bioquimico_activo,
m.stock_epidemiologico, m.rcpcr_epi, m.elisa_ns1_epi, m.elisa_igc_epi, m.elisa_igm_epi,
m.hemograma, m.hepatograma, m.observacion, m.responsable_nombre, m.responsable_contacto, m.responsable_email 
FROM monitoreo m
inner join regiones r on m.codreg = r.codreg and m.subreg = r.subcreg
inner join semana_epidemiologica se on m.codsemana = se.codsemana WHERE codmonitoreo = '$codempresa' ";
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>MONITOREO DE LABORATORIO</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_empresas.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $codempresa; ?>" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Regi&oacute;n: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['nomreg']; ?>" spellcheck="false"/>
       				<hr id="Line15"/>
    			</div>
    		</div>
    	</div>
    		...
    		<div class="row">
    			<div class="col-1">
    				...
    				<div id="wb_empresas_detallesText1">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Semana Epidemiologica: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine2"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine3"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['numero_semana'].' - '.date("d/m/Y", strtotime($row['desde'])).' - '.date("d/m/Y", strtotime($row['hasta'])); ?>" spellcheck="false"/>
    		...
    		<div class="row">
    			<div class="col-1">
    				...
    				<div id="wb_courier_detallesText1">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Horario de cobertura: </strong></span>
    				</div>
    				<hr id="courier_detallesLine2"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine3"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['horario']; ?>" spellcheck="false"/>
    		...
    		<div class="row">
    			<div class="col-1">
    				...
    				<div id="wb_empresas_detallesText2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Cantidad de Pacientes atendidos: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine6"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine7"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['cantidad_pacientes']; ?>" spellcheck="false"/>
    	...
    	<div id="empresas_detallesLayoutGrid2">
    		<div class="row">
    			<div class="col-1">
    				<hr id="empresas_detallesLine5"/>
    				<div id="wb_empresas_detallesText2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Cantidad de Pacientes atendidos para Biologia Molecular: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine6"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine7"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['cantidad_paciente_bio']; ?>" spellcheck="false"/>
    	...
    	<div id="empresas_detallesLayoutGrid2">
    		<div class="row">
    			<div class="col-1">
    				<hr id="empresas_detallesLine5"/>
    				<div id="wb_empresas_detallesText2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Número total de pruebas realizados en la semana epidemiologica: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine6"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine7"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['pruebas_total']; ?>" spellcheck="false"/>
    		...
    		<div class="row">
    			<div class="col-1">
    				...
    				<div id="wb_courier_detallesText2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Número total de pruebas realizadas en el Laboratorio de Biologia Molecular: </strong></span>
    				</div>
    				<hr id="courier_detallesLine6"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine7"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['numero_muestras_bio']; ?>" spellcheck="false"/>                    
    		...
    		<div class="row">
    			<div class="col-1">
    				...
    				<div id="wb_empresas_detallesText5">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>PCR: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine18"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine19"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['pcr']; ?>" spellcheck="false"/>
    	...
    	<div id="empresas_detallesLayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="empresas_detallesLine17"/>
    				<div id="wb_empresas_detallesText5">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Elisa IgC: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine18"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine19"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['elisa_igc']; ?>" spellcheck="false"/>
    	...
    	<div id="empresas_detallesLayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="empresas_detallesLine17"/>
    				<div id="wb_empresas_detallesText5">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Elisa IgM: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine18"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine19"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['elisa_igm']; ?>" spellcheck="false"/>
    	...
    	<div id="empresas_detallesLayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="empresas_detallesLine17"/>
    				<div id="wb_empresas_detallesText5">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Elisa NS1: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine18"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine19"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['elisa_ns1']; ?>" spellcheck="false"/>
    	...
    	<div id="empresas_detallesLayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="empresas_detallesLine17"/>
    				<div id="wb_empresas_detallesText5">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Número de muestras enviadas al LCSP: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine18"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine19"/>
                <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $row['muestras_lcsp_enviadas']; ?>" spellcheck="false"/>
    		...
    		<div class="row">
    			<div class="col-1">
    				...
    				<div id="wb_courier_detallesText3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Pacientes Hospitalizados: </strong></span>
    				</div>
    				<hr id="courier_detallesLine10"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine11"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" style="background-color: #CCCCCC;" id="telefono" readonly name="telefono" size="30" maxlength="30" readonly value="<?php echo $row['paciente_hospitalizado'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    		...
    		<div class="row">
    			<div class="col-1">
    				...
    				<div id="wb_empresas_detallesText9">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Pacientes Obito: </strong></span>
    				</div>
    				<hr id="empresas_detallesLine25"/>
    			</div>
    			<div class="col-2">
    				<hr id="empresas_detallesLine26"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="celular" name="celular" size="30" maxlength="30" readonly value="<?php echo $row['paciente_obito'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    		...
    		<div class="row">
    			<div class="col-1">
    				...
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Paciente Ambulatoria: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['paciente_ambulatoria'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Número de personal de laboratorio activo: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['personal_activo'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Bioquímicos: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['bioquimico'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Técnico de Laboratorio: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['tecnico'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Apoyo Administrativo: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['apoyo_administrativo'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Número de Bioquímicos activos con manejo de técnicas moleculares: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['bioquimico_activo'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Stock de pruebas disponibles en la semana actual: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['stock_epidemiologico'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>RTP-PCR: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['rcpcr_epi'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    ...
    <div id="wb_courier_detallesLayoutGrid4">
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['elisa_ns1_epi'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Elisa IgG: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['elisa_igc_epi'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    ...
    <div id="wb_courier_detallesLayoutGrid4">
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['elisa_igm_epi'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Hemograma: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['hemograma'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Hepatograma: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['hepatograma'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="empresas_detallesLayoutGrid8">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="obs" name="obs" size="100" maxlength="250" readonly value="<?php echo $row['observacion'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Responsable Nombre: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['responsable_nombre'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Responsable Contacto: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  value="<?php echo $row['responsable_contacto'];?>" onkeypress="return validarcar(event)" spellcheck="false" />
    	...
    	<div id="courier_detallesLayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="courier_detallesLine13"/>
    				<div id="wb_courier_detallesText4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Responsable Email: </strong></span>
    				</div>
    				<hr id="courier_detallesLine14"/>
    			</div>
    			<div class="col-2">
    				<hr id="courier_detallesLine15"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="email" name="email" size="100" maxlength="100" readonly  readonly value="<?php echo $row['responsable_email'];?>" onkeypress="return validarcar(event)" spellcheck="false" />

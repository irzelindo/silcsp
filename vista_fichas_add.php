...
$query = "select * from resultados 
		  WHERE cod_dgvs   = '".$datos[0]["cod_dgvs"]."' 
...
$sqlAddOrden = "INSERT INTO public.ordtrabajo(codservicio,
				...
				VALUES (
											  ...
											  '{$datos[0]['orden_dgvs']}',
											  '{$datos[0]['LaboratorioProc']}' ) RETURNING nordentra;";
// echo $sqlAddOrden."\n";
...
$sqlAddResultado ="INSERT INTO public.resultados(nordentra, codservicio, nroestudio, idmuestra, nroorden, fechares, codmetodo, codumedida, codsector, codestudio, coddetermina, resultado, codresultado, codequipo, codestado, codusu1, fechaval, horaval, codusu2, fechareval, horareval, anulado, fechaanul, horaanul, codusu3, codusu4, fechaent, horaentre, obs, vecesimp, codusu5, fechaenvio, horaenvio, cod_dgvs, nro_toma,ffiebre,ftoma,orden_dgvs)
VALUES ('".$codigoOrden."', '{$rowUsu["codservicio"]}', '$nroestudio', 'XXX1', '1', null, '', '', '08', '$mu', '$de', null, null, null, '001', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '".$datos[0]["cod_dgvs"]."', '".$datos[0]["NroMuestra"]."', '".$datos[0]["ffiebre"]."', '".$datos[0]["ftoma"]."', '".$orden_dgvs."');";

...
$(function() {
    ...
    jQuery("#listametodos").jqGrid({
        url:'datosmetodos.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Nombre del M&eacute;todo'],
        colModel:[
                ...
                {name:'codmetodo',index:'codmetodo', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nommetodo',index: "nommetodo", width: 677, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}                
                 ],
	...
	grid = $("#listametodos");							
//	jQuery("#listametodos").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listametodos").jqGrid('setFrozenColumns');

    jQuery("#listametodos").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_metodos.php?id=" + cod ;
			  } 
			  else 
			  {
	...
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_436==2 || $v_436==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_metodos.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_metodos.php\';" name="agregar" value="Agregar">';

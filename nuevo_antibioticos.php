...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  ...
  $nomantibiot    = $_SESSION['nomantibiot'];  
  $abreviatura    = $_SESSION['abreviatura'];  
  $diamresmen    = $_SESSION['diamresmen'];  
  $diammedmin    = $_SESSION['diammedmin']; 
  $diammedmax    = $_SESSION['diammedmax']; 
  $diamsensmen    = $_SESSION['diamsensmen']; 
...
#abreviatura:focus,#diamresmen:focus,#diammedmin:focus ,#diammedmax:focus  ,#diamsensmen:focus ,#codexterno:focus 
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
<form name="formu" method="post" action="insertar_antibioticos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codantibiot" id="codantibiot" size="10" maxlength="10" value="<?php echo $codantibiot; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Abreviatura: 
 </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaantibioticos()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

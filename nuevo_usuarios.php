...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1 || $_GET["mensage"]==2)
  {
  $codusux    = $_SESSION['codusux'];
  ...
  $fechareg    = $_SESSION['fechareg'];
  $fechauact    = $_SESSION['fechauact'];
  $region    = $_SESSION['region'];
  $codservicio    = $_SESSION['codservicio'];
  $codarea    = $_SESSION['codarea'];
  $recsms    = $_SESSION['recsms'];
  $recemail    = $_SESSION['recemail'];
  $recalerta    = $_SESSION['recalerta'];
  $nroregprof    = $_SESSION['nroregprof'];
...
<form name="formu" method="post" action="insertar_usuarios.php" enctype="multipart/form-data">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codusux" id="codusux" size="20" maxlength="20" value="<?php echo $codusux; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<button type="button" class="btn btn-primary btn-lg" onclick="verificausuarios()">Guardar Datos</button>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $codtexto    = $_SESSION['codtexto'];
  $nomtexto    = $_SESSION['nomtexto'];  
  $eltexto    = $_SESSION['eltexto'];  
  }
else
  {
  $codtexto     = "";
...
{ 
     	if (window.document.formu.nomtexto.value == "" || window.document.formu.eltexto.value == "") 
		    {
...
<form name="formu" method="post" action="insertar_textos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="Asignar&aacute; sistema" style="background-color: #CCCCCC;" name="codtexto" id="codtexto" size="10" maxlength="10" value="<?php echo $codtexto; ?>" onkeypress="return validarnum(event)" readonly="" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>T&iacute;tulo: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificatextos()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

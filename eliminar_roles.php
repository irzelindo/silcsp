...
@Header("Content-type: text/html; charset=utf-8");
   ...
   if($numeroRegistros<=0)
      {
      $resultado1=pg_query($con,"DELETE FROM roles WHERE codrol = '$id' "); 
      $resultado2=pg_query($con,"DELETE FROM opcionroles WHERE codrol = '$id' "); 
      ...
      {		
      header("Location: roles.php?mensage=4"); //no se puede borrar
      }
?>

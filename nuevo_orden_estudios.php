	...
	if ($mensaje == "") 
	{
		if($numeroRegistros1 == 0)
		{
			...
			pg_query( $con, "INSERT INTO estrealizar(
				nroestudio, codservicio, nropaciente, fecha, hora, codestudio, estadoestu, nordentra, codtmuestra, nroturno, fechatmues, horatmues, codusu, codservicior, codservact)
		VALUES ('$nroestudio', '$codservicio1', '$npaciente', '$fecharec', '$horarec', '$codestudio', '1', '$nordentra', '$codtmuestra', '$nroturno', '$fecharec', '$horarec', '$codusu', '$codservicio1', '$codservicio1')" );

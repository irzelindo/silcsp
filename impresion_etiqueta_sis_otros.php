...
<body>
		...
		if($countlc != -1){
			// while ( $row = pg_fetch_array( $result ) ) {
				...
				$query2 = "select * from ordtrabajo where cod_dgvs2 = '$nordentra' and nro_toma = '$codservicio' and orden_dgvs = '$orden_dgvs'";
        		...
        		$coddgvs     = $row2[ "cod_dgvs2" ].'/'.$orden_dgvs.'/'.$row2[ "nro_toma" ];
				...
				// ===================================================================================================
				$query5 = "select * from sectores where codsector = (SELECT codsector FROM resultados WHERE cod_dgvs2 = '$nordentra' and nro_toma = '$codservicio' and orden_dgvs = '$orden_dgvs' ) ";
				...
				// ===================================================================================================
				// Busca el Esutdio
				$query6 = "select * from estudios where codestudio = (SELECT codestudio FROM resultados WHERE cod_dgvs2 = '$nordentra' and nro_toma = '$codservicio' and orden_dgvs = '$orden_dgvs')";
				// echo $query6;
				...
				$query7 = "SELECT nroestudio FROM resultados WHERE cod_dgvs2 = '$nordentra' and nro_toma = '$codservicio' and orden_dgvs = '$orden_dgvs'";
				// echo $query7;

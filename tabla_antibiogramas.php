...
$mensage=0;
                 ...
                 $sql = 'select * from antibiogramas order by codantibiogr ';
                 ...
                 if ($numeroRegistros<=0)
                 ...
                 else
                    {
                   	if ($tiporeporte==1) // reporte HTML
             	    {
                        ...
                        echo '<p style="margin-left:0px"><strong>&nbsp;REPORTE DE TABLA DE ANTIBIOGRAMAS</strong></p></td>';
    	                echo '</tr></table>';
                        ...
                        print '<br><table class="cuadro">'
    		                  ...
    		                  .'<td class="hr">C&oacute;digo Estudio</td>'
    		                  .'</tr>';
                        ...
                        while ($row = pg_fetch_array($res))
    	                      {
     		                  ...
     		                  print '<tr>'
                                   .'<td class="tr" width="80px">'.$row['codantibiogr'] .'</td>'
    		                       .'<td class="tr" width="300px">'.$row['nomantibiogr'] .'</td>'
                         ...
                         $accion="Reporte Tabla Antibiograma ";
					 ...
					 else // EXCEL O PDF
                     {
                          ...
                          print  '<table border=1>'
    	                        .'<tr><td style="font-weight:bold;font-size:1em;background-color:#F1F1F1;color:black;" colspan="3">REPORTE DE TABLA DE ANTIBIOGRAMAS</td></tr>';
                          print '</table>';		
                          ...
                          print  '<tr style="background-color:#F1F1F1;color:black;">'	
                                ...
                                .'<td style="font-size:1em; width:70px;font-weight: bold;">C&oacute;digo Estuidio</td>'
                                .'</tr>';
                        while ($row = pg_fetch_array($res))
    	                      {
     		                  ...
     		                  print '<tr>'
                                   .'<td>'.$row['codantibiogr'].'</td>'
    		                       .'<td>'.acentos($row['nomantibiogr']).'</td>'
                         ...
                         $fechaxx=date("Y-n-j", time());
                         $hora=date("G:i:s",time());
                         $accion="Reporte Tabla Antibiograma XLS ";
                         $terminal = $_SERVER['REMOTE_ADDR'];
                         $a=archdlog($codusu,$codopcx,$fechaxx,$hora,$accion,$terminal);
                         // Fin grabacion de registro de auditoria	
                     }	// FIN EXCCEL

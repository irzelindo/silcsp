...
<body>
  ...
  <div style="border: 1px #000000 solid;padding-top: 10px;padding-left: 20px;height: 170px;">
      <div style="font-size: 25px; text-align:center; text-decoration: underline;font-weight: bold; height: 35px;padding-bottom: 50px;">LISTADO DE MUESTRAS RECIBIDO</div>
      <div style="font-size: 16px; text-align:left"><b>Fecha Recibido:</b> <?php echo $fechaenvio; ?>
      <br>
      <br>

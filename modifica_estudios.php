...
$codestudio  = $_GET["id"]; //Identificador del registro
$_SESSION['codestudio']=$codestudio;

$query = "select * from estudios where codestudio = '$codestudio'";
...
$codestudiobio = $row['codestudiobio'];  
$estado        = $row['estado'];  
$enviarec      = $row['enviarec'];  
...
$accion="Accede a Estudios: ".$codestudio."-".$nomestudio;
...
#codestudio, #codexterno, #abreviatura, #dias, #posicion, #codsector, #codtmuestra, #cantetiq, #factor, #microbiologia, #codestudiobio, #estado, #enviarec, #obs, #codmetodo
{
...
#codestudio:focus, #codexterno:focus, #abreviatura:focus, #dias:focus, #codsector:focus, #codtmuestra:focus, #cantetiq:focus, #factor:focus, #microbiologia:focus, #codestudiobio:focus, #estado:focus, #enviarec:focus, #obs:focus, #codmetodo:focus
{
   border-color: #66AFE9;
...
#nomyapex, #estado, #clave, #cedula, #email, #telefono, #celular, #dccion, #fechareg, #fechauact, #codservicio, #codarea, #recsms, #recemail, #recalerta, #nroregprof, #codrol, #region, #archivo
{
   border: 1px #CCCCCC solid;
   border-radius: 4px;
   background-color: #FFFFFF;
...
#nomyapex:focus, #estado:focus, #clave:focus, #cedula:focus, #email:focus, #telefono:focus, #celular:focus, #dccion:focus, #fechareg:focus, #fechauact:focus, #codservicio:focus, #codarea:focus, #recsms:focus, #recemail:focus, #recalerta:focus, #nroregprof:focus, #codrol:focus, #region:focus, #archivo:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
$(function() {
    ...
    jQuery("#listadeterminaciones").jqGrid({
        url:'datosdeterminacionrel.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Determinaci&oacute;n asociada al Estudio'],
        colModel:[
                ...
                {name:'coddetermina',index:'coddetermina', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomdetermina',index: "nomdetermina", width: 737, editable: true, searchoptions: {attr: {maxlength: 100,size: 100,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}               
                 ],                                 
                caption: "DETERMINACIONES RALACIONADAS",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],

                sortname: 'nomdetermina',
                sortorder: 'asc',
                viewrecords: true,
				editable: true,    
	...
	grid = $("#listadeterminaciones");							
//	jQuery("#listadeterminaciones").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listadeterminaciones").jqGrid('setFrozenColumns');

    jQuery("#listadeterminaciones").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_determinacionrel.php?codestudio=" + cod1 + "&coddetermina=" + cod2 ;
			  } 
			  else 
			  {
...
function verificaestudios()
{ 
    
     	if (window.document.formu.codestudio.value == "" || window.document.formu.nomestudio.value == "" || (window.document.formu.microbiologia[0].checked==true && window.document.formu.codestudiobio.value=='')) 
		    {
            if(window.document.formu.codestudio.value == "")
              {
    		    window.document.formu.codestudio.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codestudio.style.backgroundColor='white';    
              }  
            if(window.document.formu.nomestudio.value == "")
              {
    		    window.document.formu.nomestudio.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomestudio.style.backgroundColor='white';    
              }  
            if(window.document.formu.microbiologia[0].checked==true && window.document.formu.codestudiobio.value=='')
              {
    		    window.document.formu.codestudiobio.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codestudiobio.style.backgroundColor='white';    
              } 
           	 //entonces (no algo esta en blanco) devuelvo el valor cadena vacia 
           	 swal("","Los datos obligatorios no deben estar en blanco:\n - C\u00f3digo, \n - Denominaci\u00f3n, \n - Especificar Estudio Microbiol\u00f3gico (si define que es)","warning"); 
			return false;
     	    }
         else
            {
...
function poneralcomienzo()
{
   var anterior=window.document.formu.obs.value;
   window.document.formu.obs.value=''+anterior.trim();	
   window.document.formu.obs.focus();  
}

function limpiarcombo()
{
 window.document.formu.codestudiobio.value='';
}

function limpiarradio()
{
 codestudiobio=window.document.formu.codestudiobio.value;
 if(codestudiobio!='')
   {
    window.document.formu.microbiologia[0].checked=true;
    window.document.formu.microbiologia[1].checked=false; 
   }
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR ESTUDIOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_estudios.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codestudio" id="codestudio" size="10" maxlength="10" readonly="" value="<?php echo $codestudio; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomestudio" name="nomestudio" size="100" maxlength="100" value="<?php echo $nomestudio;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomestudiox" name="nomestudiox" value="<?php echo $nomestudio;?>"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="codexterno" name="codexterno" size="10" maxlength="10" value="<?php echo $codexterno;?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Cantidad d&iacute;as respuesta: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="dias" name="dias" size="2" maxlength="2" value="<?php echo $dias;?>" onkeypress="return validarnum(event)" spellcheck="false"/>
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                     ...
                     <select name="codsector" size="1" id="codsector">
    					<option value=""></option>
                        <?php
            			$tabla_dpto = pg_query($link, "select * from sectores order by nomsector");
            			while($depto = pg_fetch_array($tabla_dpto)) 
            			{
            		       if($depto["codsector"]==$codsector)
                             {//Para que ponga predeterminado el que hay guardado
                             ?>
            		          <option value = "<?php echo $depto['codsector']; ?>" selected="" > 
            	              <?php echo $depto['nomsector']; ?></option>
                              <?php 
            			  	  }
                              else
            				  {?>
            		          <option value = "<?php echo $depto['codsector']; ?>" > 
            		          <?php echo $depto['nomsector']; ?></option>
                              <?php
            				  }?> 
                        <?php
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Tipo de Muestra: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                     ...
                     <select name="codtmuestra" size="1" id="codtmuestra">
    					<option value=""></option>
                        <?php
            			$tabla_dpto = pg_query($link, "select * from tipomuestra order by nomtmuestra");
            			while($depto = pg_fetch_array($tabla_dpto)) 
            			{
            		       if($depto["codtmuestra"]==$codtmuestra)
                             {//Para que ponga predeterminado el que hay guardado
                             ?>
            		          <option value = "<?php echo $depto['codtmuestra']; ?>" selected="" > 
            	              <?php echo $depto['nomtmuestra']; ?></option>
                              <?php 
            			  	  }
                              else
            				  {?>
            		          <option value = "<?php echo $depto['codtmuestra']; ?>" > 
            		          <?php echo $depto['nomtmuestra']; ?></option>
                              <?php
            				  }?> 
                        <?php
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Cantidad de Etiquetas: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="cantetiq" name="cantetiq" size="2" maxlength="2" value="<?php echo $cantetiq;?>" onkeypress="return validarnum(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Factor: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="factor" name="factor" size="3" maxlength="3" value="<?php echo $factor;?>" onkeypress="return validarnum(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Es Microbiol&oacute;gico: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
                    ...
                    <table id="Table1">
        	            ...
        	            if ($microbiologia==1)
        	               {
        	               	$chequemi1='checked="checked"';
        	               }
        	            if ($microbiologia==2)
        	               {
        	               	$chequemi2='checked="checked"';
        	               }
        	            ?>
    				...
    				<tr>
    					<td class="cell0">
    						<div id="wb_RadioButton1">
    							<input type="radio" id="RadioButton1" name="microbiologia" value="1" <?php echo $chequemi1;?> /><label for="RadioButton1"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text5">
    					...
    					<td class="cell0">
    						<div id="wb_RadioButton2">
    							<input type="radio" id="RadioButton2" name="microbiologia" value="2" <?php echo $chequemi2;?> onclick="limpiarcombo()"/><label for="RadioButton2"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text6">
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>C&oacute;digo de estudio Microbiol&oacute;gico: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                     ...
                     <select name="codestudiobio" size="1" id="codestudiobio" onchange="limpiarradio()">
    					<option value=""></option>
                        <?php
            			$tabla_dpto = pg_query($link, "select * from emicrobiologia order by nomestudiobio");
            			while($depto = pg_fetch_array($tabla_dpto)) 
            			{
            		       if($depto["codestudiobio"]==$codestudiobio)
                             {//Para que ponga predeterminado el que hay guardado
                             ?>
            		          <option value = "<?php echo $depto['codestudiobio']; ?>" selected="" > 
            	              <?php echo $depto['nomestudiobio']; ?></option>
                              <?php 
            			  	  }
                              else
            				  {?>
            		          <option value = "<?php echo $depto['codestudiobio']; ?>" > 
            		          <?php echo $depto['nomestudiobio']; ?></option>
                              <?php
            				  }?> 
                        <?php
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Enviar/Recibir sistema externo: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                      ...
                      <table id="Table1">
        	            ...
        	            if ($enviarec==1)
        	               {
        	               	$chequeer1='checked="checked"';
        	               }
        	            if ($enviarec==2)
        	               {
        	               	$chequeer2='checked="checked"';
        	               }
        	            ?>
    				...
    				<tr>
    					<td class="cell0">
    						<div id="wb_RadioButton1">
    							<input type="radio" id="RadioButton1" name="enviarec" value="1" <?php echo $chequeer1;?>/><label for="RadioButton1"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text5">
    					...
    					<td class="cell0">
    						<div id="wb_RadioButton2">
    							<input type="radio" id="RadioButton2" name="enviarec" value="2" <?php echo $chequeer2;?>/><label for="RadioButton2"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text6">
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>M&eacute;todo: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                     ...
                     <select name="codmetodo" size="1" id="codmetodo">
    					<option value=""></option>
                        <?php
            			$tabla_dpto = pg_query($link, "select * from metodos order by nommetodo");
            			while($depto = pg_fetch_array($tabla_dpto)) 
            			{
            		       if($depto["codmetodo"]==$codmetodo)
                             {//Para que ponga predeterminado el que hay guardado
                             ?>
            		          <option value = "<?php echo $depto['codmetodo']; ?>" selected="" > 
            	              <?php echo $depto['nommetodo']; ?></option>
                              <?php 
            			  	  }
                              else
            				  {?>
            		          <option value = "<?php echo $depto['codmetodo']; ?>" > 
            		          <?php echo $depto['nommetodo']; ?></option>
                              <?php
            				  }?> 
                        <?php
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Posici&oacute;n: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="posicion" name="posicion" size="2" maxlength="5" value="<?php echo $posicion;?>" onkeypress="return validarnum(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <textarea class="form-control" id="obs" name="obs" rows="3" cols="71" spellcheck="false" onfocus="poneralcomienzo();" ><?php echo $obs; ?></textarea>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_431==2 || $v_431==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaestudios()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='estudios.php';"> VOLVER </a>&nbsp;]</span>
...
<div id="wb_sintomas_detallesLayoutGrid1">
	<div id="sintomas_detallesLayoutGrid1">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listadeterminaciones"></table>
        <div id="perpage"></div>
      </div>        
        <br />
    	...
    	<?php
         if ($v_431==2 || $v_431==3) 
            {
             echo '<input type="submit" id="Button1b" onclick="window.location.href=\'nuevo_determinacionrel.php?codestudio='.$codestudio.'\';" name="agregar" value="Agregar">';
            }
         ?> 
         <br />&nbsp;       
	</div>        

...
// Se crea la conexi�n a la base de datos
  ...
  if($codsector != '')
    ...
    $sql1 = "select distinct p.nropaciente,
		...
		and   e.nordentra   = t.nordentra
		and   e.codestudio  = es.codestudio
		and   e.estadoestu  = '1' ".$w." order by t.nordentra";
	...
	while ($row = pg_fetch_array($res1))
	{
        ...
        $nomservicio=$registro3['nomservicio'];
		    ...
		    $respuesta->rows[$i]['cell'] = array($row['nordentra'],$row['nomestudio'],$row['nomyape'],$nomtmuestra,$nomservicio,$nropaciente, $codservicio, $nromuestra1,$row['codestudio'],$row['microbiologia']);

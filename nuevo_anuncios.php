...
if ($_GET["mensage"]==1 || $_GET["mensage"]==2)
  {
  $norden    = $_SESSION['norden'];
  $fecha     = $_SESSION['fecha'];  
  $archivo    = $_SESSION['archivo'];  
  $texto    = $_SESSION['texto'];  
  $parafl     = $_SESSION['parafl'];
  $paracli    = $_SESSION['paracli'];   
  }
else
  {
  $norden     = "";
  $fecha     = " ".date("j/n/Y", time());
  $archivo     = "";  
  $texto     = "";  
  $parafl     =  "";
  $paracli    =  "";   
...
<form name="formu" method="post" action="insertar_anuncios.php" enctype="multipart/form-data">
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
               <!--     <input type="text" class="form-control" placeholder="" id="archivo" name="archivo" size="30" maxlength="30" value="<?php echo $archivo;?>" onkeypress="return validarcar(event)" spellcheck="false"/> -->
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.norden.style.backgroundColor='yellow';

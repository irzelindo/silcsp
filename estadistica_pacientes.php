		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>REPORTE DE ESTADISTICAS DE PACIENTES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<form name="formu" method="post" action="estadisticas_pacientes2.php" target="_blank">
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_estadistica_pacientesText1">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Seleccione Cuadro: </strong></span>
				</div>
				<hr id="estadistica_pacientesLine2"/>
			</div>
			<div class="col-2">
				<hr id="estadistica_pacientesLine3"/>
				<select name="cuadro" size="1" id="cuadro">
					<option></option>
					<option value="001">PACIENTES POR REGION SANITARIA</option>
					<option value="002">PACIENTES POR GRUPO ETAREOS</option>
					<option>PACIENTES CON TB</option>
					<option>PACIENTES RELACIONADOS A MALARIA</option>
					<option value="003">PACIENTES POR ORIGEN</option>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_reporte_bitacoraImage1">
					<img src="images/navegador.png" id="reporte_bitacoraImage1" alt="" onclick="listar(1)"/></a>
				</div>
				<hr id="Line17"/>
				<hr id="Line18"/>
			</div>

			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_asignar_turnos_pacientes.php?nroturno=<?php echo $nroturno;?>&codservicio=<?php echo $codservicio;?>'"> VOLVER </a>&nbsp;]</span>

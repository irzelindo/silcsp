...
<script>
	$(document).ready(function(){
			...
			$("#reporte1").click(function(){
				...
				window.open('reporte_resumen_evaluacion.php?nroeval='+nroeval, '_blank');
			...
			$("#reporte2").click(function(){
				...
				window.open('reporte_resumen_evaluacion_excel.php?nroeval='+nroeval, '_blank');
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>RESUMEN DE EVALUACION</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
	...
	<div id="LayoutGrid4">
		<div class="row">
			<div class="col-1">
				<hr id="Line2"/>
				<div id="wb_Text2">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nro. Evaluacion: </strong></span>
				</div>
				<hr id="Line3"/>
			</div>
			<div class="col-2" style="text-align: left;">
				<hr id="Line14"/>
				<input type="text" id="nroeval" name="nroeval" value="" spellcheck="false"/>
				<hr id="Line15"/>
			</div>
		</div>
	</div>

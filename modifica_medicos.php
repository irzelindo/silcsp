...
$codmedico  = $_GET["id"]; //Identificador del registro
$query = "select * from medicos where codmedico = '$codmedico'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomyapex = $row["nomyape"];
$tipoprof = $row["tipoprof"];
...
$accion="Accede a Medicos: ".$codmedico."-".$nomyapex;
...
#nomyapex:focus, #tipoprof:focus, #nroregistro:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
#tipoprof:focus,#nroregistro:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
{
     	if (window.document.formu.codmedico.value == "" || window.document.formu.nomyapex.value == "")
		    {
            if(window.document.formu.codmedico.value == "")
              {
    		    window.document.formu.codmedico.style.backgroundColor='yellow';
              }
            else
              {
    		    window.document.formu.codmedico.style.backgroundColor='white';
              }
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
        </strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>LUGAR EXTRACCI&Oacute;N</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_medicos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codmedico" id="codmedico" size="10" maxlength="10" readonly="" value="<?php echo $codmedico; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nombres: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Ciudad: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="tipoprof" name="tipoprof" size="100" maxlength="100" value="<?php echo $tipoprof;?>" onkeypress="return validarcar(event)"  spellcheck="false"/>
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Albergues: <br/>
    					</strong></span>
    				</div>
    			</div>
    			<div class="col-2">
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_424==2 || $v_424==3)
	                {
				     echo '<button type="button" class="btn btn-primary" onclick="verificamedicos()">Guardar Datos</button>';
	                }
	             ?>
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='medicos.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==2)
	...
	echo "<script type=''>
    window.document.formu.nomyapex.style.backgroundColor='yellow';
     swal('','Ya existe otro registro con ese Nombre!','error');
     </script>";
    }
if ($_GET["mensage2"]==1)
    {

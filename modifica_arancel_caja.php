...
function ValidarFormulario($form) {
	...
	if ( $mensaje == "" ) 
	{
		...
		$respuesta->redirect("modifica_ingresos_caja_detalle.php?nroingreso=$nroingreso");
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_ingresos_caja_detalle.php?nroingreso=<?php echo $nroingreso; ?>'"> VOLVER </a>&nbsp;]</span>

...
<script>
	$(document).ready(function(){
			...
			$("#reporte1").click(function(){
				...
				var grupo = jQuery( "#ci" ).val();

				window.open('reporte_lista_orden.php?grupo='+grupo, '_blank');
			...
			$("#reporte2").click(function(){
				...
				window.open('reporte_lista_orden_excel.php?grupo='+grupo, '_blank');
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>MOVIMIENTO ORDEN TRABAJO</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
	...
	<div id="LayoutGrid4">
		<div class="row">
			<div class="col-1">
				<hr id="Line2"/>
				<div id="wb_Text2">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nro. Lista: </strong></span>
				</div>
				<hr id="Line3"/>
			</div>
			<d<div class="col-2">

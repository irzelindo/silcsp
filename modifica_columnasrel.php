...
$codplatilla  = $_GET["codplatilla"]; //Identificador del registro
...
$query2 = "select * from plantillaplandet where codplatilla = '$codplatilla' and posicion = '$posicion'";
...
function verificacolumna()
{ 
     	if (window.document.formu.columna.value == "") 
		    {
            if(window.document.formu.columna.value == "")
              {
    		    window.document.formu.columna.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.columna.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR COLUMNAS DE LA PLANTILLA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_columnasrel.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codplatilla" id="codplatilla" style="background-color: #CCCCCC;" size="10" maxlength="10" value="<?php echo $codplatilla; ?>" onkeypress="return validarcar(event)" readonly="" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomplatilla" name="nomplatilla" style="background-color: #CCCCCC;" size="100" maxlength="200" value="<?php echo $nomplatilla;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" readonly="" spellcheck="false"/>
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nombre de la columna: </strong></span>
    				</div>
    			</div>
    			<div class="col-2">
    				<hr id="Line1"/>
    				<input type="text" class="form-control" placeholder="" id="columna" name="columna" size="20" maxlength="20" value="<?php echo $columna;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                                       
                    <input type="hidden" name="columnax" id="columnax" value="<?php echo $columna; ?>"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificacolumna()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_plantillas_plan_trabajo.php?id=<?php echo $codplatilla; ?>';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
	...
	echo "<script type=''>
    window.document.formu.columna.style.backgroundColor='yellow';
     swal('','Ya existe Columna con el mismo nombre!','error');
     </script>"; 
    }

              ...
              <div class="x_panel">
                ...
                <!------------  ANUNCIOS  -------->
                  <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="x_title">
                      <span style="font-size: 10px;"><strong>Anuncios</strong><small></small></span>

                      <div class="clearfix"></div>
                    </div>

                <div class="demo-container" style="height: auto;width: auto;">
                      <!-- CARROUSEL -->
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            <!-- Carousel indicators AQUI VA UN WHILE-->
                            <ol class="carousel-indicators">
                                <?php
                                 $sql = 'select * from anuncios where veempresa=1';
                                 ...
                                 while ($row = pg_fetch_array($res))
    	                             {
                                      ...
                                      if($k==1)
                                         ...
                                         $pe=$k-1;
                                     echo '<li data-target="#myCarousel" data-slide-to="'.$pe.'" '.$acti.'></li>';
    	                             }
                                ?>
                            ...
                            <div class="carousel-inner">
                             ...
                             while ($row = pg_fetch_array($res))
                                 ...
                                 $elarchivo=$row['archivo'];

                                 if($elarchivo!='')
                                    {
                                     echo '<div class="item '.$acti.'">
                                <img src="fotos/'.$row['archivo'].'" class="img-responsive" alt="Anuncio" width="380px" height="330px" />
                                <div class="carousel-caption" style="font-size: 12px;">
                                  <p>'.$fecha.'<br/>
                                  '.utf8_decode($row['texto']).'</p>
                                </div>
                              </div>';
                                    }
                                 else
                                    {
                                     echo '<div class="item '.$acti.'">
                                <img src="images/sinimagen.jpg" class="img-responsive" alt="Anuncio" width="380px" height="330px" />
                                <div class="carousel-caption" style="font-size: 12px;">
                                  <p>'.$fecha.'<br/>
                                  '.utf8_decode($row['texto']).'</p>
                                </div>
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div>
                      <div class="x_title">
                        <span style="font-size: 10px;"><strong>Alertas del Sistema</strong></span>
                        <div class="clearfix"></div>
                      </div>
                      ...
                      <ul class="list-unstyled top_profiles scroll-view">
                        <!-- AQUI VA UN WHILE-->
                        <?php
                        $sql2 = 'select * from alertas where estado=1';
                             $res2=pg_query($link,$sql2);
                             while ($row2 = pg_fetch_array($res2))
	                             {
	                               $proceso=$row2['codproceso'];
                                   $texto=$row2['texto'];
                                   $fechaproc=$row2['fechaproc'];

                                   $sql3 = "select * from procesos where codproceso='$proceso'";
                                   $res3=pg_query($link,$sql3);
                                   $row3 = pg_fetch_array($res3);
                                   $nomproceso=$row3['nomproceso'];
	                               ...
	                               ?>
                                    <li class="media event">
                                      ...
                                      <div class="media-body">
                                        <a class="title" style="font-size: 10px;" href="#"><?php echo $nomproceso; ?></a>
                                        <p style="font-size: 10px;"><?php echo $texto; ?></p>
                                        <p style="font-size: 10px;"> <small><?php echo $fechaproc; ?></small>
                                        </p>
                                      </div>
                                    </li>
                                 <?php

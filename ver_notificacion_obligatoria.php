...
$sqlnoti = "select * from nobligatorias where nordentra = '$nordentra' and   codservicio   = '$codservicio'";

$resnoti = pg_query($link,$sqlnoti);
$connoti = pg_num_rows($resnoti);

$rownoti = pg_fetch_assoc($resnoti);

if($connoti == 0)
{
	$unro = pg_query( $link, "select max(nronotif) as ultimo from nobligatorias" );

	while ( $rowcod = pg_fetch_array( $unro ) ) {
		$nronotif = $rowcod[ 'ultimo' ] + 1;
	}
}
else
{
	$nronotif= $rownoti["nronotif"];
	
	$query = "select * from nobligatorias where nronotif = '$nronotif'";
...
function ValidarFormulario($form) {
	...
	$sql1 = "select * from nobligatorias where nronotif = '$nronotif'";
	...
	if ($codenferm == "") {
		$mensaje .= '- Rellene el campo Enfermedad!';

		$respuesta->Assign( "codenferm", "style.backgroundColor", "yellow" );

	} else {
		$respuesta->Assign( "codenferm", "style.backgroundColor", "" );
	}
	...
	if ($mensaje == "") 
	{
		...
		{		
			pg_query( $con, "INSERT INTO nobligatorias(
            nronotif, nordentra, nropaciente, codenferm, codservicio, codusu)
    VALUES ('$nronotif', '$nordentra', '$npaciente', '$codenferm', '$codservicio1', '$codusu')" );

			$respuesta->script('swal("Datos", "Datos Registrado Exitosamente!", "success")');
			...
			$accion = "Orden-Notificacion: Insertar-Reg.: Nro. Notificacion: " . $nronotif;
			$terminal = $_SERVER[ 'REMOTE_ADDR' ];
			$a = archdlog( $codusu, $codopc, $fecha1, $hora, $accion, $terminal );
			// Fin grabacion de registro de auditoria
		}
		else
		{
			pg_query( $con, "UPDATE nobligatorias
							   SET codenferm='$codenferm'
							 WHERE nronotif = '$nronotif'" );
...
<head>
	...
	vertical-align: middle;
		...
		#wb_notificacion_obligatoriaLayoutGrid1
		{
		   clear: both;
		   position: relative;
		   table-layout: fixed;
		...
		#notificacion_obligatoriaLayoutGrid1
		{
		   -webkit-box-sizing: border-box;
		   -moz-box-sizing: border-box;
		   box-sizing: border-box;
		...
		#notificacion_obligatoriaLayoutGrid1 .row
		{
		   margin-right: -15px;
		   margin-left: -15px;
		}
		#notificacion_obligatoriaLayoutGrid1 .col-1, #notificacion_obligatoriaLayoutGrid1 .col-2
		{
		   -webkit-box-sizing: border-box;
		   -moz-box-sizing: border-box;
		   box-sizing: border-box;
		...
		#notificacion_obligatoriaLayoutGrid1 .col-1
		{
		   background-color: transparent;
		   background-image: none;
		   width: 33.33333333%;
		...
		#notificacion_obligatoriaLayoutGrid1 .col-2
		{
		   background-color: transparent;
		   background-image: none;
		   width: 66.66666667%;
		...
		#notificacion_obligatoriaLayoutGrid1:before,
		#notificacion_obligatoriaLayoutGrid1:after,
		#notificacion_obligatoriaLayoutGrid1 .row:before,
		#notificacion_obligatoriaLayoutGrid1 .row:after
		{
		   display: table;
		   content: " ";
		}
...
<div id="wb_notificacion_obligatoriaLayoutGrid1">
	<div id="notificacion_obligatoriaLayoutGrid1">
		<div class="row">
			<div class="col-1">
			  <div id="wb_notificacion_obligatoriaText1">
			    <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>N&uacute;mero de Notificaci&oacute;n: <br></strong></span>
				</div>
			</div>
			<div class="col-2">
		  	  <hr id="turnos_detallesLine14">
			  <input type="text" id="nronotif" name="nronotif" value="<?php echo $nronotif; ?>" readonly spellcheck="false">
...
<div id="wb_turnos_detallesLayoutGrid5">
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine14">
					<input type="date" id="fecharec" name="fecharec" value="<?php echo $fecharec; ?>" readonly spellcheck="false">
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				...
				<div class="col-2">
					...
					<select name="codorigen" size="1" id="codorigen" disabled>
                        <?php
		...
		<div id="courier_detallesLayoutGrid2">
			<div class="row">
				...
				<div class="col-2">
					...
					<select name="codservder" size="1" id="codservder" disabled>
                        <?php
		...
		<div id="courier_detallesLayoutGrid2">
			<div class="row">
				<div class="col-1">
					<hr id="courier_detallesLine5">
					<div id="wb_turnos_detallesText3">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Enfermedad: </strong></span>
					</div>
					<hr id="courier_detallesLine6">
				</div>
				<div class="col-2">
					<hr id="courier_detallesLine7">
					<select name="codenferm" id="codenferm" >
							<option value=""></option>
							<?php
								$tabla_dpto = pg_query($link, "select * from enfermedades order by codenferm");
								while($depto = pg_fetch_array($tabla_dpto)) 
								{
								   if(trim($depto['codenferm']) == trim($codenferm))
								   {
									  echo "<option value = ".$depto['codenferm']." selected>".$depto['nomenferm']."</option>"; 


								   }
								   else
								   {
									   echo "<option value = ".$depto['codenferm'].">".$depto['nomenferm']."</option>";
								   }
								}
		...
		<div id="turnos_detallesLayoutGrid4">
			<div class="row">
				...
				<div class="col-1">
					...
					<input type="button" id="pacientes_detallesButton1" onclick="window.open('ficha_notificacion.html');return false;" name="reasignar" value="Cargar Ficha" disabled>
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.close()"> VOLVER </a>&nbsp;]</span>

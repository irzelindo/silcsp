...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $nropregunta    = $_SESSION['nropregunta'];
  $respuesta    = $_SESSION['respuesta'];  
  $textopregunta    = $_SESSION['textopregunta'];  
  }
else
  {
  $nropregunta     = "";
...
{ 
     	if (window.document.formu.respuesta.value == "" || window.document.formu.textopregunta.value == "") 
		    {
...
<form name="formu" method="post" action="insertar_educacion_continua.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="Asignar&aacute; sistema" style="background-color: #CCCCCC;" name="nropregunta" id="nropregunta" size="2" maxlength="2" value="<?php echo $nropregunta; ?>" onkeypress="return validarnum(event)" readonly="" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificapregunta()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

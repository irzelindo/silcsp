...
// Se crea la conexión a la base de datos
   ...
   $v_12  = $_SESSION['V_12'];
    ...
    $sql="select	r.nordentra,
		...
		r.anulado,
		es.microbiologia
from resultadosmicro r, estrealizar e, estudios es
...
and   r.nordentra  = e.nordentra
and   r.codservicio= e.codservicio
and   es.codestudio= e.codestudio ".$w." order by r.norden";
	...
	while ($row = pg_fetch_array($res1))
	{
		...
		$link = "window.location.href='resultados_detallem.php?nordentra=".$row['nordentra']."&codservicio=".$row['codservicio']."&codestudio=".$row['codestudio']."&nroorden=".$row['norden']."'";

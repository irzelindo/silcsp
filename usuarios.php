...
$(function() {
    ...
    jQuery("#listausuarios").jqGrid({
        ...
        colNames:['Revisar','Borrar','Usuario','Nombre y Apellido','Estado'],
        colModel:[
                ...
                {name:'codusux',index:'codusux', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                
                {name:'nomyapex',index: "nomyapex", width: 577, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
	...
	grid = $("#listausuarios");							
//	jQuery("#listausuarios").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listausuarios").jqGrid('setFrozenColumns');

    jQuery("#listausuarios").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_usuarios.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
         ...
         if ($v_411==2 || $v_411==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_usuarios.php\';">Agregar</span></button>';
             
             echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_usuarios.php\';">Agregar</button>';

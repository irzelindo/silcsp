...
<form name="formu" method="post" action="insertar_roles.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codrol" id="codrol" size="10" maxlength="10" value="<?php echo $codrol; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
            						...
            						while ($row = pg_fetch_assoc($res))
            							{
            						 		  ...
            						 		  $che3="";
            						 		  $che4="";
            						          if ($_GET["mensage"]==1 || $_GET["mensage2"]==2 || $_GET["mensage2"]==1)
            						          {
            						 		  if ($permi[$i]==0)
            						 		     {
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaroles()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

...
$norden  = $_GET["id"]; //Identificador del registro
$query = "select * from anuncios where norden = '$norden'";
$result = pg_query($link,$query);

$row = pg_fetch_array($result);

$archivo     = 'fotos/'.$row['archivo'];
$archivox    = $row['archivo'];
$texto    = $row["texto"];
$fecha    = $row['fecha'];
$parafl   = $row['veempresa'];
$paracli  = $row['vecliente']; 
...
$archivo='fotos/anuncio'.$norden.'.jpg';
...
$accion="Accede a Anuncios: ".$norden."-".$archivo;
...
{ 
     	...
     	if ( window.document.formu.texto.value == "" || (window.document.formu.parafl.checked == false && window.document.formu.paracli.checked == false)) 
		    {  
		     if(window.document.formu.texto.value == "") 
                {
                window.document.formu.texto.style.backgroundColor='yellow'; 
                }
             else
                {
                window.document.formu.texto.style.backgroundColor='white'; 
                } 

		     if(window.document.formu.parafl.checked == false && window.document.formu.paracli.checked == false) 
                {
                window.document.getElementById('dirigido').style.backgroundColor='yellow'; 
                }
             else
                {
                window.document.getElementById('dirigido').style.backgroundColor='white'; 
                }
                                
           	 //entonces (no algo esta en blanco) devuelvo el valor cadena vacia 
           	 swal("","Los datos obligatorios no deben estar en blanco (Texto y a Quien est\u00e1 dirigido)","warning");
			return false;
     	    }
...
{
   var anterior=window.document.formu.texto.value;
   window.document.formu.texto.value=''+anterior.trim();	
   window.document.formu.texto.focus();  
}
</script>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR ANUNCIOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_anuncios.php" enctype="multipart/form-data">
    	...
    	<div id="LayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line2"/>
    				<div id="wb_Text2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nro. Orden: </strong></span>
    				</div>
    				<hr id="Line3"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="Asignar&aacute; sistema" style="background-color: #CCCCCC;" name="norden" id="norden" size="10" maxlength="10" value="<?php echo $norden; ?>" onkeypress="return validarnum(event)" readonly="" spellcheck="false"/>
    	...
    	<div id="LayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line2"/>
    				<div id="wb_Text2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Fecha: </strong></span>
    				</div>
    				<hr id="Line3"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="fecha" id="fecha" size="10" maxlength="10" value="<?php echo $fecha; ?>" onkeypress="return validarnum(event)" readonly="" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Texto del Art&iacute;culo: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <textarea class="form-control" id="texto" name="texto" rows="3" cols="71" spellcheck="false" onfocus="poneralcomienzo();" ><?php echo $texto; ?></textarea>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Imagen asociada: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    	...
    	<div id="LayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line2"/>
    				<div id="wb_Text2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><div id="dirigido"><strong>Dirigido a:</div></strong></span>
    				</div>
    				<hr id="Line3"/>
    			</div>
    			<div class="col-2">
    				...
    				<tr>
    					<td class="cell0">
    						<div id="wb_usuarios_areasCheckbox3">
    							<input type="checkbox" id="parafl" name="parafl" value="1" <?php if($parafl==1){echo "checked";}?>/><label for="parafl"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_usuarios_areasText5">
    							<span style="color:#808080;font-family:Arial;font-size:13px;">Laboratorio</span>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_usuarios_areasCheckbox2">
    							<input type="checkbox" id="paracli" name="paracli" value="1" <?php if($paracli==1){echo "checked";}?>/><label for="paracli"></label>
    						</div>
    					</td>
    					<td class="cell0">
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_54==2 || $v_54==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaarti()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='anuncios.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage"]==1)
{
	echo "<script type='text/javascript'>
     window.document.formu.di.style.backgroundColor='yellow'; 
     window.document.formu.me.style.backgroundColor='yellow'; 
     window.document.formu.an.style.backgroundColor='yellow';    
...
{
	echo "<script type='text/javascript'>
    window.document.getElementById('laimagen').style.backgroundColor='yellow';

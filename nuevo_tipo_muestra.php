...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  ...
  $nomtmuestra    = $_SESSION['nomtmuestra'];  
  }
else
  {
  $codtmuestra     = "";
...
{ 
     	if (window.document.formu.codtmuestra.value == "" || window.document.formu.nomtmuestra.value == "") 
		    {
            if(window.document.formu.codtmuestra.value == "")
              {
    		    window.document.formu.codtmuestra.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codtmuestra.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_tipo_muestra.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codtmuestra" id="codtmuestra" size="10" maxlength="10" value="<?php echo $codtmuestra; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificatipomuestra()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

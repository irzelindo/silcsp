...
$codtmuestra  = $_GET["id"]; //Identificador del registro
$query = "select * from tipomuestra where codtmuestra = '$codtmuestra'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomtmuestra = $row["nomtmuestra"];
...
$accion="Accede a Tipo de Muestras ".$codtmuestra."-".$nomtmuestra;
...
function verificatipomuestra()
{ 
     	if (window.document.formu.nomtmuestra.value == "") 
		    {
  
            if(window.document.formu.nomtmuestra.value == "")
              {
    		    window.document.formu.nomtmuestra.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomtmuestra.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR TIPO DE MUESTRAS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_tipo_muestra.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codtmuestra" id="codtmuestra" size="10" maxlength="10" readonly="" value="<?php echo $codtmuestra; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomtmuestra" name="nomtmuestra" size="100" maxlength="100" value="<?php echo $nomtmuestra;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomtmuestrax" name="nomtmuestrax" value="<?php echo $nomtmuestra;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_437==2 || $v_437==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificatipomuestra()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='tipo_muestra.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codtmuestra.style.backgroundColor='yellow';

...
$query = "select * from config_gral where codservicio = '$codservicio'";
$result = pg_query($link,$query);

$row = pg_fetch_array($result);

$director    = $row['director'];  
$cargodir    = $row["cargodir"]; 
$nomyapefir  = $row['nomyapefir'];
$cuentagral  = $row['cuentagral'];   
$nomctagral  = $row['nomctagral'];   
$nomyapedep  = $row['nomyapedep'];   
$concepto    = $row['concepto']; 

$n_recibo_ini   = $row['n_recibo_ini'];if($n_recibo_ini==0){$n_recibo_ini='';}
$n_recibo       = $row['n_recibo'];if($n_recibo==0){$n_recibo='';}
$n_recibo_fin   = $row['n_recibo_fin'];if($n_recibo_fin==0){$n_recibo_fin='';}
$serie          = $row['serie'];
$np_mensaje     = $row['np_mensaje'];if($np_mensaje==0){$np_mensaje='';}
$decreto        = $row['decreto'];
$ruc            = $row['ruc'];
  
$archivo1='firmas/'.$codservicio.'firma1.jpg';
$_SESSION['archivo1']=$archivo1;  
$archivo2='firmas/'.$codservicio.'firma2.jpg';
$_SESSION['archivo2']=$archivo2;  


// Bitacora
include("bitacora.php");
$codopc = "V_4115";
$director2=date("Y-n-j", time());
$hora=date("G:i:s",time());
$accion="Accede a Config. Gral.: ".$codservicio."-".$director;
$terminal = $_SERVER['REMOTE_ADDR'];
$a=archdlog($_SESSION['codusu'],$codopc,$director2,$hora,$accion,$terminal);
...
{
   var anterior=window.document.formu.cargodir.value;
   window.document.formu.cargodir.value=''+anterior.trim();	
   window.document.formu.cargodir.focus();  
}
</script>
...
<form name="formu" method="post" action="actualiza_configuracion_gral.php" enctype="multipart/form-data">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <select name="codservicio" size="1" id="codservicio" style="background-color: #CCCCCC;" disabled="">
    					<option value=""></option>
                        <?php
                    ...
                    <input type="hidden" name="codserviciox" id="codserviciox" size="10" maxlength="10" value="<?php echo $codservicio; ?>" />
						...
						<div id="wb_PhotoGallery1">
							...
							<tr>
			                    ...
			                    <td width="200px" height="135px">
									 ...
									 <div id="fileList1" >
				    					<p><a href="javascript:abrir('<?php echo $archivo1;?>')"><img src='<?php echo $archivo1;?>' width="200px" height="135px"/></p>
				  					 </div>
						...
						<div id="wb_PhotoGallery1">
							...
							<tr>
			                    ...
			                    <td width="200px" height="135px">
									 ...
									 <div id="fileList2" >
				    					<p><a href="javascript:abrir('<?php echo $archivo2;?>')"><img src='<?php echo $archivo2;?>' width="200px" height="135px"/></p>
				  					 </div>

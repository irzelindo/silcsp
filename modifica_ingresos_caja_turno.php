...
function ValidarFormulario($form) {
	...
	if ( $mensaje == "" ) {
			...
			pg_query( $con, "UPDATE ingresocaja
							SET nrorecibo='$nrorecibo', nroreciboser='$nroreciboser', fecha='$fecha', hora='$hora', formapago='$formapago', otrafp='$otrafp', nomyape='$nomyape', nropaciente='$nropaciente', codcaja='$codcaja1', codusu='$codusu', codservicio='$codservicio1'
...
<head>
	...
	<script language="JavaScript">
		...
		{ 
			...
			var nroturno 	= jQuery("#nroturno").val();
			var codarea 	= jQuery("#codarea").val();
			var codturno 	= jQuery("#codturno").val();
			var codservicio = jQuery("#codservicio1").val();
			
			jQuery("#listaconceptos").jqGrid('setGridParam',{url:"datosarancelescajaturno.php?nroingreso="+nroingreso+"&nrorecibo="+nrorecibo+"&nroreciboser="+nroreciboser+"&nroturno="+nroturno+"&codarea="+codarea+"&codturno="+codturno+"&codservicio="+codservicio,datatype:'json'}).trigger("reloadGrid");
		...
		{ 
			$.ajax({
						...
						type:'POST',
						dataType:'json',
						data:{codarancel:jQuery("#codarancel1").val()}
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			<h4 class="modal-title" id="myModalLabel"><center>INGRESOS POR <?php echo $titulo; ?></center></h4>
			  <br>
		  ...
		  <div class="modal-body">
			...
			<input type="hidden" name="formapago" id="formapago" value="<?php echo $formapago; ?>">
			</div>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<div style="text-align: left">
			Aranceles
			<input type="text" name="codarancel" id="codarancel" list="listaarancel" style="width: 80%"  onkeypress="return validarcar(event)" onChange="ListaArancel(); TraeMonto()" >
			</div>
			 <input type="hidden" name="codarancel1" id="codarancel1" value="<?php echo $codarancel; ?>" >
			  <br>
			  <div style="text-align: left">
			  Monto&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" name="monto" id="monto" value="<?php echo $monto; ?>" style="background-color: #DCDCDC; text-align: right" readonly >
			  </div>
...
<datalist id="listaarancel">
  <?php
		...
		while($depto = pg_fetch_array($tabla_dpto)) 
		{
			echo '<option data-value = "'.$depto['codarancel'].'" value = "'.$depto['codarancel']."- ".$depto['nomarancel'].'"></option>';
		}
?>
</datalist>

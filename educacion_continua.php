...
$(function() {
    ...
    jQuery("#listapreguntaedcontinua").jqGrid({
        url:'datoseducacioncontinua.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','Nro. Pregunta','Texto'],
        colModel:[
                ...
                {name:'nropregunta',index:'nropregunta', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'textopregunta',index: "textopregunta", width: 727, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
                                  
                caption: "PREGUNTAS DE EDUCACION CONTINUA",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],

                sortname: 'nropregunta',
                sortorder: 'asc',
                viewrecords: true,
				editable: true,    
	...
	grid = $("#listapreguntaedcontinua");							
//	jQuery("#listapreguntaedcontinua").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listapreguntaedcontinua").jqGrid('setFrozenColumns');

    jQuery("#listapreguntaedcontinua").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_educacion_continua.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listapreguntaedcontinua"></table>
        <div id="perpage"></div>
      </div>        
        <br />
    	...
    	<?php
         if ($v_451==2 || $v_451==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_educacion_continua.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_educacion_continua.php\';" name="agregar" value="Agregar">';

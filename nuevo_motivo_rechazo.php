...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $codrechazo    = $_SESSION['codrechazo'];
  $nomrechazo    = $_SESSION['nomrechazo'];  
  }
else
  {
  $codrechazo     = "";
...
{ 
     	if (window.document.formu.codrechazo.value == "" || window.document.formu.nomrechazo.value == "") 
		    {
            if(window.document.formu.codrechazo.value == "")
              {
    		    window.document.formu.codrechazo.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codrechazo.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_motivo_rechazo.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codrechazo" id="codrechazo" size="10" maxlength="10" value="<?php echo $codrechazo; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificamotivorechazo()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

...
$query = "select * from empresas where codempresa = '$codempresa'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomyape  = $row["razonsocial"];
...
function ValidarFormulario($form) {
	...
	VALUES ('$nroingreso', '$nrotransac', '$codbco', '$fecha', '$hora', '$codempresa', '$monto', '$estadu', '$tipo', '$id', '$nroexpediente', $fechapago)");
			
			pg_query( $con, "UPDATE formapago='$formapago'
							WHERE nroingreso= '$nroingreso'" );
			
			$respuesta->script('window.close();');
...
<div id="wb_turnos_detallesLayoutGrid5">
	  <div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="text" id="id" name="id" value="<?php echo $id; ?>" maxlength="50" autofocus>
				  <hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
...
<div id="wb_turnos_detallesLayoutGrid5">
	  <div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="text" id="nroexpediente" name="nroexpediente" value="<?php echo $nroexpediente; ?>" maxlength="10" onkeypress="return validarnum(event)">
				  <hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.close()"> CERRAR </a>&nbsp;]</span>

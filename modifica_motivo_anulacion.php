...
$codanula  = $_GET["id"]; //Identificador del registro
$query = "select * from motivoanulacion where codanula = '$codanula'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomanula = $row["nomanula"];
...
$accion="Accede a Motivos de Anulacion de ingresos ".$codanula."-".$nomanula;
...
function verificamotivoanulacion()
{ 
     	if (window.document.formu.nomanula.value == "") 
		    {
  
            if(window.document.formu.nomanula.value == "")
              {
    		    window.document.formu.nomanula.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomanula.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR MOTIVOS DE ANULACIONES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_motivo_anulacion.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codanula" id="codanula" size="10" maxlength="10" readonly="" value="<?php echo $codanula; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomanula" name="nomanula" size="100" maxlength="250" value="<?php echo $nomanula;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomanulax" name="nomanulax" value="<?php echo $nomanula;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_443==2 || $v_443==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificamotivoanulacion()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='motivo_anulacion.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codanula.style.backgroundColor='yellow';

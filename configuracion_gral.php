...
$(function() {
    ...
    jQuery("#listaconfiguracion_gral").jqGrid({
        url:'datosconfiguracion_gral.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','Establecimiento','Director','Cargo'],
        colModel:[
                ...
                {name:'codservicio',index:'codservicio', width:300, align:"left", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'director',index:'director', width:300, align:"left", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'cargodir',index: "cargodir", width: 227, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
	...
	grid = $("#listaconfiguracion_gral");							
//	jQuery("#listaconfiguracion_gral").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaconfiguracion_gral").jqGrid('setFrozenColumns');

    jQuery("#listaconfiguracion_gral").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_configuracion_gral.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listaconfiguracion_gral"></table>
        <div id="perpage"></div>
      </div>        
        <br />

    	<?php
         if ($v_4115==2 || $v_4115==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_configuracion_gral.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_configuracion_gral.php\';" name="agregar" value="Agregar">';

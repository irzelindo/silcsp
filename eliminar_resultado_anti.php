...
@Header("Content-type: text/html; charset=utf-8");
   ...
   $resultado1=pg_query($con,"DELETE FROM resultadoantibiotico WHERE nordentra = '$nordentra' and codservicio = '$codservicio' and  codestudio = '$codestudio' and nroresul = '$nroresul'"); 
      ...
      if($resultado1==true)
           {
              ...
              $accion="Carga y Validacion Antibiotico: Elimina-Reg.: Nro. Orden: ".$codservicio.$nordentra;

...
$codorigen  = $_GET["id"]; //Identificador del registro
$query = "select * from origenpaciente where codorigen = '$codorigen'";
...
$accion="Accede a Origen del Paciente: ".$codorigen."-".$nomorigen;
...
function verificaorigenpaciente()
{ 
     	if (window.document.formu.nomorigen.value == "") 
		    {
  
            if(window.document.formu.nomorigen.value == "")
              {
    		    window.document.formu.nomorigen.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomorigen.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR ORIGEN DEL PACIENTE</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_origen_paciente.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codorigen" id="codorigen" size="10" maxlength="10" readonly="" value="<?php echo $codorigen; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomorigen" name="nomorigen" size="100" maxlength="100" value="<?php echo $nomorigen;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomorigenx" name="nomorigenx" value="<?php echo $nomorigen;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_423==2 || $v_423==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaorigenpaciente()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='origen_paciente.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codorigen.style.backgroundColor='yellow';

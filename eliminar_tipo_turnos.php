...
@Header("Content-type: text/html; charset=utf-8");
   ...
   $sql1 = "select * from turnos where codturno = '$id' and codservicio='$codservicio' and codarea='$codarea'";
   ...
   if($numeroRegistros<=0)
      {
      $resultado1=pg_query($con,"DELETE FROM tiposturnos WHERE codturno = '$id' and codservicio='$codservicio' and codarea='$codarea'"); 
      ...
      if($resultado1==true)
           {
              ...
              $accion="Tipos de Turnos: Elimina-Reg.: ".$id.", Servicio: ".$codservicio.", Area: ".$codarea;
              $terminal = $_SERVER['REMOTE_ADDR'];
              $a=archdlog($codusu,$codopc,$fecha,$hora,$accion,$terminal);
              
              // Fin grabacion de registro de auditoria
              header("Location: tipo_turnos.php?mensage=1");	 
           }
    	else
    	  {
      ...
      {		
      header("Location: tipo_turnos.php?mensage=4"); //no se puede borrar
      }
?>

...
$(function() {
    ...
    jQuery("#listacajas").jqGrid({
        ...
        colNames:['Revisar','Borrar','Establecimiento','C&oacute;digo Caja','Denominaci&oacute;n Caja'],
        colModel:[
                ...
                {name:'nomservicio',index: "nomservicio", width: 377, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'codcaja',index:'codcaja', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomcaja',index: "nomcaja", width: 377, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}                
                 ],
	...
	grid = $("#listacajas");							
//	jQuery("#listacajas").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listacajas").jqGrid('setFrozenColumns');

    jQuery("#listacajas").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_cajas.php?id=" + cod + "&codservicio=" + est;
			  } 
			  else 
			  {
	...
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_443==2 || $v_443==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_cajas.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_cajas.php\';" name="agregar" value="Agregar">';

		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>REPORTE DE HISTORIA CLINICA DE PACIENTES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<form name="formu" method="post" action="lista_historia_clinica2.php" target="_blank">
	...
	<div id="LayoutGrid4">
		<div class="row">
			<div class="col-1">
				<hr id="Line2"/>
				<div id="wb_Text2">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Paciente: </strong></span>
				</div>
				<hr id="Line3"/>
			</div>
			<div class="col-2">
				<hr id="Line4"/>
				<select name="nropaciente" size="1" id="nropaciente">
						<option value = ""></option>
                        <?php
        				$tabla_origen = pg_query($link,"select * from paciente order by pnombre");
        				while($row = pg_fetch_array($tabla_origen))
                        $paciente= $row['pnombre'].' '.$row['papellido'];
        				{
                             ?>
          			          <option value = "<?php echo $row['codorigen'];?> "> 
        			          <?php echo $paciente;?></option>
                        <?php
        				}
			         ?>
				</select>

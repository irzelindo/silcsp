...
$(function() {
    ...
    jQuery("#listatextos").jqGrid({
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','T&iacute;tulo Texto'],
        colModel:[
                ...
                {name:'codtexto',index:'codtexto', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomtexto',index: "nomtexto", width: 727, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
	...
	grid = $("#listatextos");							
//	jQuery("#listatextos").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listatextos").jqGrid('setFrozenColumns');

    jQuery("#listatextos").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_textos.php?id=" + cod ;
			  } 
			  else 
			  {
	...
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_438==2 || $v_438==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_textos.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_textos.php\';" name="agregar" value="Agregar">';

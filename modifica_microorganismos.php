...
$codmicroorg  = $_GET["id"]; //Identificador del registro
$query = "select * from microorganismos where codmicroorg = '$codmicroorg'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nommicroorg = $row["nommicroorg"];
...
$accion="Accede a Microorganismos: ".$codmicroorg."-".$nommicroorg;
...
#nommicroorg:focus, #codexterno:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
function verificamicroorganismos()
{ 
     	if (window.document.formu.codmicroorg.value == "" || window.document.formu.nommicroorg.value == "") 
		    {
            if(window.document.formu.codmicroorg.value == "")
              {
    		    window.document.formu.codmicroorg.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codmicroorg.style.backgroundColor='white';    
              } 

            if(window.document.formu.nommicroorg.value == "")
              {
    		    window.document.formu.nommicroorg.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nommicroorg.style.backgroundColor='white';    
              }
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR MICROORGANISMOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_microorganismos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codmicroorg" id="codmicroorg" size="10" maxlength="10" readonly="" value="<?php echo $codmicroorg; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nommicroorg" name="nommicroorg" size="100" maxlength="100" value="<?php echo $nommicroorg;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nommicroorgx" name="nommicroorgx" value="<?php echo $nommicroorg;?>"/>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="codexterno" name="codexterno" size="50" maxlength="50" value="<?php echo $codexterno;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4314==2 || $v_4314==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificamicroorganismos()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='microorganismos.php';"> VOLVER </a>&nbsp;]</span>

...
$query = "select * from areasest where codservicio = '$codservicio' and codarea = '$codarea'";
$result = pg_query($link,$query);
$row2 = pg_fetch_assoc($result);

$nomarea    = $row2['nomarea'];
...
#codarea:focus, #nomarea:focus, #codsector:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
{ 
     	if (window.document.formu.codarea.value == "" || window.document.formu.nomarea.value == "") 
		    {
            ...
            if(window.document.formu.nomarea.value == "")
              {
    		    window.document.formu.nomarea.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomarea.style.backgroundColor='white';    
              }  

           	 //entonces (no algo esta en blanco) devuelvo el valor cadena vacia 
           	 swal("","Los datos obligatorios no deben estar en blanco:\n - C\u00f3digo\n - Nombre del Area","warning"); 
			return false;
     	    }
         else
            {
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR AREAS RELACIONADAS A ESTABLECIMIENTO</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_areasrel.php">
    	...
    	<div id="LayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line2"/>
    				<div id="wb_Text2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>C&oacute;digo Establecimiento: </strong></span>
    				</div>
    				<hr id="Line3"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codservicio" id="codservicio" style="background-color: #CCCCCC;" size="10" maxlength="10" value="<?php echo $codservicio; ?>" onkeypress="return validarcar(event)" readonly="" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nombre Establecimiento: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomservicio" name="nomservicio" style="background-color: #CCCCCC;" size="100" maxlength="100" value="<?php echo $nomservicio;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" readonly="" spellcheck="false"/>
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>C&oacute;digo de Area: </strong></span>
    				</div>
    			</div>
    			<div class="col-2">
    				<hr id="Line1"/>

                    <input type="text" class="form-control" placeholder="" id="codarea" name="codarea" style="background-color: #CCCCCC;"  size="10" maxlength="10" value="<?php echo $codarea;?>" onkeypress="return validarcar(event)" readonly="" spellcheck="false"/>                   
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nombre del Area: </strong></span>
    				</div>
    			</div>
    			<div class="col-2">
    				<hr id="Line1"/>

                    <input type="text" class="form-control" placeholder="" id="nomarea" name="nomarea" size="100" maxlength="150" value="<?php echo $nomarea;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>                   
                    
                    <input type="hidden" id="nomareax" name="nomareax" value="<?php echo $nomarea;?>"/>
    				<hr id="Line8"/>
    			</div>
    		</div>
    	</div>
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Corresponde al Sector Laboratorial: </strong></span>
    				</div>
    			</div>
    			<div class="col-2">
    				<hr id="Line1"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaarea()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_establecimientossa.php?id=<?php echo $codservicio; ?>';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
	...
	echo "<script type=''>
    window.document.formu.codarea.style.backgroundColor='yellow';
     swal('','Ya existe Area relacionada a este Establecimiento!','error');
     </script>"; 
    }
 if ($_GET["mensage2"]==2)
    {
	echo "<script type=''>
    window.document.formu.nomarea.style.backgroundColor='yellow';
     swal('','Ya existe otro registro con esa Denominaci\u00f3n para ese Establecimiento!','error');
     </script>"; 
    }   
?>

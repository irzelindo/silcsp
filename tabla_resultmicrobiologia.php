 ...
 * @copyright 2018
 * TABLA: RESULTADOS MICROBIOLOGIA
 */
                 ...
                 if ($numeroRegistros<=0)
                 ...
                 else
                    {
                   	if ($tiporeporte==1) // reporte HTML
             	    {
                        ...
                        echo '<p style="margin-left:0px"><strong>&nbsp;REPORTE DE TABLA DE MICROBIOLOGIA</strong></p></td>';
    	                echo '</tr></table>';
					 ...
					 else // EXCEL O PDF
                     {
                          ...
                          print  '<table border=1>'
    	                        .'<tr><td style="font-weight:bold;font-size:1em;background-color:#F1F1F1;color:black;" colspan="3">REPORTE DE TABLA DE MICROBIOLOGIA</td></tr>';
                          print '</table>';		

...
$mensage=0;
                 ...
                 $sql = 'select * from rangoedad order by cgrupoedad ';
                 ...
                 if ($numeroRegistros<=0)
                 ...
                 else
                    {
                   	if ($tiporeporte==1) // reporte HTML
             	    {
                        ...
                        echo '<p style="margin-left:0px"><strong>&nbsp;REPORTE DE TABLA DE RANGO EDAD</strong></p></td>';
    	                echo '</tr></table>';
                        ...
                        print '<br><table class="cuadro">'
    		                  .'<tr><td class="hr">Grupo Edad</td>'
    		                  .'<td class="hr">Posici&oacute;n</td>'
    		                  .'<td class="hr">Desde Edad</td>'
                              .'<td class="hr">Hasta Edad</td>'
                              .'<td class="hr">Tipo</td>'
    		                  .'</tr>';
                        ...
                        while ($row = pg_fetch_array($res))
    	                      {
     		                  ...
     		                  print '<tr>'
                                   .'<td class="tr" width="150px">'.$row['cgrupoedad'] .'</td>'
    		                       .'<td class="tr" width="80px">'.$row['posicion'] .'</td>'
    		                       .'<td class="tr" width="80px">'.$row['desdeedad'] .'</td>'
                                   .'<td class="tr" width="80px">'.$row['hastaedad'] .'</td>'
                         ...
                         $accion="Reporte Tabla Rango Edad ";
					 ...
					 else // EXCEL O PDF
                     {
                          ...
                          print  '<table border=1>'
    	                        .'<tr><td style="font-weight:bold;font-size:1em;background-color:#F1F1F1;color:black;" colspan="5">REPORTE DE TABLA DE RANGO EDAD</td></tr>';
                          print '</table>';		
    	
                          print  '<table border=1>';	
                          print  '<tr style="background-color:#F1F1F1;color:black;">'	
                                .'<td style="font-size:1em; width:200px;font-weight: bold;">Grupo Edad</td>'
    	                        .'<td style="font-size:1em; width:80px;font-weight: bold;">Posici&oacute;n</td>'
                                .'<td style="font-size:1em; width:80px;font-weight: bold;">Desde Edad</td>'
                                .'<td style="font-size:1em; width:80px;font-weight: bold;">Hasta Edad</td>'
                                .'<td style="font-size:1em; width:80px;font-weight: bold;">Tipo</td>'
                                .'</tr>';
                        while ($row = pg_fetch_array($res))
    	                      {
                              
     		                  print '<tr>'
                                   .'<td>'.$row['cgrupoedad'].'</td>'
    		                       .'<td>'.$row['posicion'].'</td>'
    		                       .'<td>'.$row['desdeedad'].'</td>'
                                   .'<td>'.$row['hastaedad'].'</td>'
                                   .'<td>'.$row['tipo'].'</td>'
                         ...
                         $fechaxx=date("Y-n-j", time());
                         $hora=date("G:i:s",time());
                         $accion="Reporte Tabla Rango Edad XLS ";
                         $terminal = $_SERVER['REMOTE_ADDR'];
                         $a=archdlog($codusu,$codopcx,$fechaxx,$hora,$accion,$terminal);
                         // Fin grabacion de registro de auditoria	
                     }	// FIN EXCCEL

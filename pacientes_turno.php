...
$(function() {
    ...
    jQuery("#listapacientes").jqGrid({
        ...
        colNames:['Nro. Paciente','Nombres y Apellidos','C&eacute;dula', 'Fecha Registro', 'Direcci&oacute;n', 'Tel&eacute;fono'],
        colModel:[
				...
				{name:'cedula',index:'cedula', width:60, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'fechareg',index: "fechareg", width: 100, align:"center", editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
...
function gridReload()
{
	...
	jQuery("#listapacientes").jqGrid('setGridParam',{url:"datospacientes_turno.php?codservicio="+codservicio,datatype:'json'}).trigger("reloadGrid");
	...
	swal({
			...
			.then((willDelete) => {
			  if (willDelete)
			  {
				...
				window.location = "eliminar_pacientes.php?nropaciente=" + cod;
			  }
			  else
			  {
...
<div id="page1Layer1">
	...
	<div id="page1Layer1_Container">
	  <?php
         if ($v_11==2 || $v_11==3)
            {
    	     echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_pacientes.php?indica='.$indica.'\';">Agregar</span></button>';

             //echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_pacientes.php?indica='.$indica.'\';" name="agregar" value="Agregar">';

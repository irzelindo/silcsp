...
$codequipo  = $_GET["id"]; //Identificador del registro
...
$crc          = $row['crc']; 
$confirmares  = $row['confirmares']; 

$comport      = $row['comport']; 
$hasdshking   = $row['hasdshking']; 
$baudrate     = $row['baudrate']; 
$stopbit      = $row['stopbit']; 
$parity       = $row['parity']; 
$bits         = $row['bits']; 
$recsenial    = $row['recsenial']; 
$visualres    = $row['visualres']; 
$envioautom   = $row['envioautom']; 
$posidcol     = $row['posidcol']; 
$separadec    = $row['separadec']; 
$escrres      = $row['escrres']; 
$rutalog      = $row['rutalog'];
...
$accion="Accede a Equipos Analizadores: ".$codequipo."-".$descripcion;
...
<form name="formu" method="post" action="actualiza_equipos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codequipo" id="codequipo" size="10" maxlength="10" readonly="" value="<?php echo $codequipo; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <input  type="hidden" name="descripcionx" id="descripcionx" value="<?php echo $descripcion;?>"/>
    				<hr id="Line15"/>
    			</div>
    		</div>
    	</div>
			...
			<div class="col-1">
				...
				<?php
	             if ($v_4312==2 || $v_4312==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaequipos()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
...
if ($_GET["mensage2"]==2)
	...
	echo "<script type=''>
    window.document.formu.descripcion.style.backgroundColor='yellow';
     swal('','Ya existe otro registro con esa Descripci\u00f3n!','error');
     </script>"; 
    }
if ($_GET["mensage2"]==1)
    {

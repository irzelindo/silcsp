...
$codrol  = $_GET["id"]; //Identificador del registro

$query = "select * from roles where codrol = '$codrol' "; 
...
$accion="Accede a Roles: ".$codrol."-".$nomrol;
...
{ 
     	if (window.document.formu.codrol.value == "" || window.document.formu.nomrol.value == "" || (window.document.formu.estado[0].checked == false && window.document.formu.estado[1].checked == false)) 
		    {
		      
             
            if(window.document.formu.codrol.value == "")
              {
    		    window.document.formu.codrol.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codrol.style.backgroundColor='white';    
              } 

            if(window.document.formu.nomrol.value == "")
              {
    		    window.document.formu.nomrol.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomrol.style.backgroundColor='white';    
              }
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR ROLES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
//  @Header("Content-type: text/html; charset=utf-8");
    ...
    $sql="select * from opcionroles WHERE codrol='$codrol' ORDER BY codopc";
...
<form name="formu" method="post" action="actualiza_roles.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codrol" id="codrol" size="10" maxlength="10" readonly="" value="<?php echo $codrol; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nombre del  Rol: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomrol" name="nomrol" size="100" maxlength="100" value="<?php echo $nomrol;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomrolx" name="nomrolx" value="<?php echo $nomrol;?>"/>
            						...
            						while ($row = pg_fetch_assoc($res))
            							{
                                              ...
                                              if($tipo==4)
                                                ...
                                                if ($par==0)
                    								  {
                    						          print '<tr>'
                    								  .'<td class="tr"  style="text-align: left;width:50%;">'.$row['codopc'].'<br/>'.$row['nomopc'].'</td>'
                    								  .'<td class="tr"  style="text-align: left;width:50%;"><input type="radio" name="permi['.$i.']" value="0" '.$che1.' /><sup>&nbsp;Sin permiso</sup><br/>'
                                                ...
                                                if ($par==0)
                    						          ...
                    						          print '<tr>'
                    								  .'<td class="tr"  style="text-align: left;width:50%;">'.$row['codopc'].'<br/>'.$row['nomopc'].'</td>'
                    								  .'<td class="tr"  style="text-align: left;width:50%;"><input type="radio" name="permi['.$i.']" value="0" '.$che1.' /><sup>&nbsp;No</sup><br/>'
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_413==2 || $v_413==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaroles()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
...
<div id="wb_roles_detallesLayoutGrid1">
	<div id="roles_detallesLayoutGrid1">
		<div class="row">
			<div class="col-1">
				<hr id="roles_detallesLine1"/>
				<div id="wb_roles_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='roles.php';"> VOLVER </a>&nbsp;]</span>
                    
				</div>
				<hr id="roles_detallesLine2"/>
			</div>
			<div class="col-2">
			</div>
		</div>

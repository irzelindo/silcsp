...
$coddiagnostico  = $_GET["id"]; //Identificador del registro
$query = "select * from diagnostico where coddiagnostico = '$coddiagnostico'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomdiagnostico = $row["nomdiagnostico"];
...
$accion="Accede a Diagnostico: ".$coddiagnostico."-".$nomdiagnostico;
...
function verificadiagnostico()
{ 
     	if (window.document.formu.nomdiagnostico.value == "") 
		    {
  
            if(window.document.formu.nomdiagnostico.value == "")
              {
    		    window.document.formu.nomdiagnostico.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomdiagnostico.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR DIAGN&Oacute;STICOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_diagnostico.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="coddiagnostico" id="coddiagnostico" size="10" maxlength="10" readonly="" value="<?php echo $coddiagnostico; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomdiagnostico" name="nomdiagnostico" size="100" maxlength="200" value="<?php echo $nomdiagnostico;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomdiagnosticox" name="nomdiagnosticox" value="<?php echo $nomdiagnostico;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_425==2 || $v_425==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificadiagnostico()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='diagnostico.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.coddiagnostico.style.backgroundColor='yellow';

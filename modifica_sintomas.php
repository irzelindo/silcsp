...
$codsintoma  = $_GET["id"]; //Identificador del registro
$tipo  = $_GET["tipo"]; //Identificador del registro

$query = "select * from sintomas where codsintoma = '$codsintoma' and tipo=$tipo"; 
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomsintoma = $row["nomsintoma"];
$tipo = $row["tipo"];
...
$accion="Accede a Sintomas: ".$codsintoma."-".$nomsintoma;
...
function verificasintomas()
{ 
     	if (window.document.formu.codsintoma.value == "" || window.document.formu.nomsintoma.value == "" || (window.document.formu.tipo[0].checked == false && window.document.formu.tipo[1].checked == false)) 
		    {
		      
             
            if(window.document.formu.codsintoma.value == "")
              {
    		    window.document.formu.codsintoma.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codsintoma.style.backgroundColor='white';    
              } 

            if(window.document.formu.nomsintoma.value == "")
              {
    		    window.document.formu.nomsintoma.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomsintoma.style.backgroundColor='white';    
              }
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR SINTOMAS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_sintomas.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codsintoma" id="codsintoma" size="10" maxlength="10" readonly="" value="<?php echo $codsintoma; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    				...
    				<tr>
    					<td class="cell0">
    						<div id="wb_RadioButton1">
    							<input type="radio" id="RadioButton1" name="tipo" value="1" <?php echo $chequeot1;?> disabled=""/><label for="RadioButton1"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text5">
    							<span style="color:#808080;font-family:Arial;font-size:13px;"> S&iacute;ntoma</span>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_RadioButton2">
    							<input type="radio" id="RadioButton2" name="tipo" value="2" <?php echo $chequeot2;?> disabled=""/><label for="RadioButton2"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text6">
    							<span style="color:#808080;font-family:Arial;font-size:13px;"> Factor de Riesgo</span>
    						</div>
    					</td>
    				</tr>
                    <input type="hidden" name="tipox" value="<?php echo $tipo;?>" />
    				</table>
                    </div>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomsintoma" name="nomsintoma" size="100" maxlength="150" value="<?php echo $nomsintoma;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomsintomax" name="nomsintomax" value="<?php echo $nomsintoma;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_422==2 || $v_422==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificasintomas()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='sintomas.php';"> VOLVER </a>&nbsp;]</span>

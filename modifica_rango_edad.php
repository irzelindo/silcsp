...
$cgrupoedad  = $_GET["id"]; //Identificador del registro
...
$accion="Accede a Rango de Edades: ".$cgrupoedad."-".$ngrupoedad;
...
$(function() {
    ...
    jQuery("#listarangoedad").jqGrid({
        url:'datosrangoedadrel.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','Posici&oacute;n','Desde','Hasta','Periodo'],
        colModel:[
                ...
                {name:'posicion',index:'posicion', width:150, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'desdeedad',index: "desdeedad", width: 220, editable: true, searchoptions: {attr: {maxlength: 100,size: 90,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'hastaedad',index: "hastaedad", width: 220, editable: true, searchoptions: {attr: {maxlength: 100,size: 90,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'tipo',index: "tipo", width: 237, editable: true, searchoptions: {attr: {maxlength: 100,size: 90,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}               
                 ],                                 
                caption: "RANGOS",
                ignoreCase:true,                
                pager: '#perpage',
	...
	grid = $("#listarangoedad");							
//	jQuery("#listarangoedad").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listarangoedad").jqGrid('setFrozenColumns');

    jQuery("#listarangoedad").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_rango_edadrel.php?cgrupoedad=" + cod1 + "&posicion=" + cod2 ;
			  } 
			  else 
			  {
...
function verificatiporangoedad()
{ 
     	if (window.document.formu.ngrupoedad.value == "") 
		    {
  
            if(window.document.formu.ngrupoedad.value == "")
              {
    		    window.document.formu.ngrupoedad.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.ngrupoedad.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR GRUPOS DE EDADES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_rango_edad.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="cgrupoedad" id="cgrupoedad" size="10" maxlength="10" readonly="" value="<?php echo $cgrupoedad; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="ngrupoedad" name="ngrupoedad" size="100" maxlength="100" value="<?php echo $ngrupoedad;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="ngrupoedadx" name="ngrupoedadx" value="<?php echo $ngrupoedad;?>"/>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4114==2 || $v_4114==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificatiporangoedad()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='rango_edad.php';"> VOLVER </a>&nbsp;]</span>
	...
	<div id="sintomas_detallesLayoutGrid1">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_4114==2 || $v_4114==3) 
            {
             echo '<input type="submit" id="Button1b" onclick="window.location.href=\'nuevo_rango_edadrel.php?cgrupoedad='.$cgrupoedad.'\';" name="agregar" value="Agregar">';
            }
         ?> 
         <br />&nbsp;       
	</div>        
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.cgrupoedad.style.backgroundColor='yellow';

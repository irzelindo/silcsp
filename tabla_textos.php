...
$mensage=0;
                 ...
                 $sql = 'select * from  textos order by codtexto ';
                 ...
                 if ($numeroRegistros<=0)
                 ...
                 else
                    {
                   	if ($tiporeporte==1) // reporte HTML
             	    {
                        ...
                        echo '<p style="margin-left:0px"><strong>&nbsp;REPORTE DE TABLA DE TEXTOS</strong></p></td>';
    	                echo '</tr></table>';
                        ...
                        while ($row = pg_fetch_array($res))
    	                      {
     		                  ...
     		                  print '<tr>'
                                   .'<td class="tr" width="80px">'.$row['codtexto'] .'</td>'
    		                       .'<td class="tr" width="300px">'.$row['nomtexto'] .'</td>'
                                   .'</tr>';
    	                       }
    	                 print '</table><br />';
					 ...
					 else // EXCEL O PDF
                     {
                          ...
                          print  '<table border=1>'
    	                        .'<tr><td style="font-weight:bold;font-size:1em;background-color:#F1F1F1;color:black;" colspan="2">REPORTE DE TABLA DE TEXTO</td></tr>';
                          print '</table>';		
                        ...
                        while ($row = pg_fetch_array($res))
                         ...
                         $fechaxx=date("Y-n-j", time());
                         $hora=date("G:i:s",time());
                         $accion="Reporte Tabla Texto XLS ";
                         $terminal = $_SERVER['REMOTE_ADDR'];
                         $a=archdlog($codusu,$codopcx,$fechaxx,$hora,$accion,$terminal);
                         // Fin grabacion de registro de auditoria	
                     }	// FIN EXCCEL

...
$nropregunta  = $_GET["id"]; //Identificador del registro
$query = "select * from preguntaedcontinua where nropregunta = '$nropregunta'";
...
$accion="Accede a Preguntas de educacion continua: ".$nropregunta."-".$respuesta;
...
{ 
     	if (window.document.formu.nropregunta.value == "" || window.document.formu.respuesta.value == "" || window.document.formu.textopregunta.value == "") 
		    {
            if(window.document.formu.nropregunta.value == "")
              {
    		    window.document.formu.nropregunta.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nropregunta.style.backgroundColor='white';    
              }  
            if(window.document.formu.respuesta.value == "")
              {
    		    window.document.formu.respuesta.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.respuesta.style.backgroundColor='white';    
              }  
            if(window.document.formu.textopregunta.value == "")
              {
    		    window.document.formu.textopregunta.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.textopregunta.style.backgroundColor='white';    
              }  

           	 //entonces (no algo esta en blanco) devuelvo el valor cadena vacia 
           	 swal("","Los datos obligatorios no deben estar en blanco:\n - Nro. Pregunta,\n - Respuesta Correcta y \n - Detalle del Texto","warning"); 
			return false;
     	    }
         else
            {
...
{
   var anterior=window.document.formu.textopregunta.value;
   window.document.formu.textopregunta.value=''+anterior.trim();	
   window.document.formu.textopregunta.focus();  
}
</script>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR PREGUNTAS DE EDUCACION CONTINUA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_educacion_continua.php">
    	...
    	<div id="LayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line2"/>
    				<div id="wb_Text2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nro. Pregunta: </strong></span>
    				</div>
    				<hr id="Line3"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="nropregunta" id="nropregunta" size="2" maxlength="2" readonly="" value="<?php echo $nropregunta; ?>" onkeypress="return validarnum(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Descripci&oacute;n del texto: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <textarea class="form-control" id="textopregunta" name="textopregunta" rows="3" cols="71" spellcheck="false" onfocus="poneralcomienzo();" ><?php echo $textopregunta; ?></textarea>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Respuesta Correcta: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="respuesta" name="respuesta" size="30" maxlength="30" value="<?php echo $respuesta;?>" onkeypress="return validarcar(event)"  spellcheck="false"/>
                    
                    <input type="hidden" id="respuestax" name="respuestax" value="<?php echo $respuesta;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_451==2 || $v_451==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificapregunta()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='educacion_continua.php';"> VOLVER </a>&nbsp;]</span>

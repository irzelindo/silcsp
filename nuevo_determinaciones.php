...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  ...
  $nomdetermina    = $_SESSION['nomdetermina'];  

  $codumedida    = $_SESSION['codumedida'];  
  $codresultado    = $_SESSION['codresultado'];  
  $tipo           = $_SESSION['tipo'];  
  $abreviatura    = $_SESSION['abreviatura'];  
  $tiempohab    = $_SESSION['tiempohab'];  
  $tiempourg    = $_SESSION['tiempourg'];  
  }
else
  {
  $unro = pg_query( $link, "select max(coddetermina) as ultimo from determinacionesmaster" );

  while ( $rowcod = pg_fetch_array( $unro ) ) 
  {
	$coddetermina = $rowcod[ 'ultimo' ] + 1;
  }
...
{ 
     	if (window.document.formu.coddetermina.value == "" || window.document.formu.nomdetermina.value == "") 
		    {
...
<form name="formu" method="post" action="insertar_determinaciones.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="coddetermina" id="coddetermina" size="10" maxlength="10" value="<?php echo $coddetermina; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<button type="button" class="btn btn-primary btn-lg" onclick="verificadeterminacionesmaster()">Guardar Datos</button>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

...
@Header("Content-type: text/html; charset=utf-8");
   ...
   $sql1 = "select * from plantrabajo where codplantilla = '$id'";
   ...
   if($numeroRegistros<=0)
      {
      $resultado1=pg_query($con,"DELETE FROM plantillaplan WHERE codplatilla = '$id'"); 

      $resultado2=pg_query($con,"DELETE FROM plantillaplandet WHERE codplatilla = '$id'"); 
      ...
      if($resultado1==true && $resultado2==true)
           {
              ...
              $accion="Plantillas de Planes de Trabajo: Elimina-Reg.: ".$id;
              $terminal = $_SERVER['REMOTE_ADDR'];
              $a=archdlog($codusu,$codopc,$fecha,$hora,$accion,$terminal);
              
              // Fin grabacion de registro de auditoria
              header("Location: plantillas_plan_trabajo.php?mensage=1");	
           }
    	else
    	  {
      ...
      {		
      header("Location: plantillas_plan_trabajo.php?mensage=4"); //no se puede borrar
      }
?>

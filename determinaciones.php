...
$(function() {
    ...
    jQuery("#listadeterminacionesmaster").jqGrid({
        url:'datosdeterminaciones.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Determinaci&oacute;n'],
        colModel:[
                ...
                {name:'nomdetermina',index: "nomdetermina", width: 727, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
	...
	grid = $("#listadeterminacionesmaster");							
//	jQuery("#listadeterminacionesmaster").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listadeterminacionesmaster").jqGrid('setFrozenColumns');

    jQuery("#listadeterminacionesmaster").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_determinaciones.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
	  <?php
         if ($v_433==2 || $v_433==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_determinaciones.php\';">Agregar</span></button>';
      ...
      <div class="jqGrid">
        <br/>
        <table id="listadeterminacionesmaster"></table>
        <div id="perpage"></div>
      </div>        
	</div>
</div>

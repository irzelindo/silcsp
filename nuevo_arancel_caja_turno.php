...
function ValidarFormulario($form) {
	...
	nroingreso, nrorecibo, nroreciboser, norden, codarancel, monto, fecha, exonerado)
	VALUES ('$nroingreso', '$nrorecibo', '$nroreciboser', '$norden', '$codarancel', '$monto', '$fecha', '$exonerado')");

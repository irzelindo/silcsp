...
$nroorden  = $_GET["id"]; //Identificador del registro
$query = "select * from feriados where nroorden = '$nroorden'";
...
$accion="Accede a Feriados y Asuetos: ".$nroorden."-".$dia;
...
#nomFeriados y Asuetos:focus, #mes:focus, #anio:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
#mes:focus,#anio:focus,#motivo:focus,#email:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
function verificaferiados()
{ 
    dia=window.document.formu.dia.value;
    mes=window.document.formu.mes.value;
    anio=1*window.document.formu.anio.value;
    anualsi=window.document.formu.esanual[0].checked;
    anualno=window.document.formu.esanual[1].checked;    
    
     	if (window.document.formu.motivo.value == "" || dia=='' || mes=='' || (anio==0 && anualno)) 
		    {
             if(window.document.formu.motivo.value == "")
               {
                window.document.formu.motivo.style.backgroundColor='yellow';  
               }
             else
               {
                window.document.formu.motivo.style.backgroundColor='white';  
               }  		      

             if(dia=='')
               {
                window.document.formu.dia.style.backgroundColor='yellow';  
               }
             else
               {
                window.document.formu.dia.style.backgroundColor='white';  
               }  		      

             if(mes=='')
               {
                window.document.formu.mes.style.backgroundColor='yellow';  
               }
             else
               {
                window.document.formu.mes.style.backgroundColor='white';  
               }               

             if(anio==0 && anualno)
               {
                window.document.formu.anio.style.backgroundColor='yellow';  
               }
             else
               {
                window.document.formu.anio.style.backgroundColor='white';  
               }               

              
           	 //entonces (no algo esta en blanco) devuelvo el valor cadena vacia 
           	 swal("","Los datos obligatorios no deben: \nestar en blanco (Dia, Mes, Motivo),\n ni el a\u00f1o si no es anual.","warning"); 
			return false;
     	    }
         else
            {
    ...
    if(mes!='')
      {
        dia=window.document.formu.dia.value;
        tope=0;
        if(mes==1 || mes==3 || mes==5 || mes==7 || mes==8 || mes==10 || mes==12){tope=31;}
        if(mes==4 || mes==6 || mes==9 || mes==11){tope=30;}
        if(mes==2){tope=29;}
    
        if((mes!='' && dia>tope) || (mes=='' && dia>31))
          {
            swal('','Dia incorrecto','warning');
            window.document.formu.dia.value='';
          }
       if(mes>12)
          {
            swal('','Mes incorrecto','warning');
            window.document.formu.mes.value='';
          }   
...
function anios(cual) //0, 1
{
    anio=window.document.formu.anio.value;
    anualsi=window.document.formu.esanual[0].checked;
    anualno=window.document.formu.esanual[1].checked;
    
    if(cual==0) // viene por cambio de año
      {
        if(anio!='')
           {

           window.document.formu.esanual[0].checked=false;
           window.document.formu.esanual[1].checked=true; 
           }
        else
           {

           window.document.formu.esanual[0].checked=true;
           window.document.formu.esanual[1].checked=false; 
           }   
      }

    if(cual==1)  // viene por el click anual SI
      {
        if(anualsi)
          {
            window.document.formu.anio.value='';
          }
      }
}
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR FERIADOS Y ASUETOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_feriados.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="nroorden" id="nroorden" size="10" maxlength="10" readonly="" value="<?php echo $nroorden; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>D&iacute;a: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="dia" id="dia" name="dia" size="2" maxlength="2" value="<?php echo $dia;?>" onkeypress="return validarnum(event)" spellcheck="false" onchange="diasx();"/>                   
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Mes: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="mes" id="mes" name="mes" size="2" maxlength="2" value="<?php echo $mes;?>" onkeypress="return validarnum(event)"  spellcheck="false" onchange="meses();"/>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>A&ntilde;o: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="a&ntilde;o" id="anio" name="anio" size="4" maxlength="4" value="<?php echo $anio;?>" onkeypress="return validarnum(event)" spellcheck="false" onchange="anios(0);"/>
    	...
    	<div id="LayoutGrid6c">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7c"/>
    				<div id="wb_Text4c">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Motivo / Celebraci&oacute;n: </strong></span>
    				</div>
    				<hr id="Line13c"/>
    			</div>
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="motivo" name="motivo" size="100" maxlength="200" value="<?php echo $motivo;?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Anual / Ocasional: <br/>
    					</strong></span>
    				</div>
    			</div>
    			<div class="col-2">
    				...
    				<tr>
    					<td class="cell0">
    						<div id="wb_RadioButton1">
    							<input type="radio" id="RadioButton1" name="esanual" value="1" <?php echo $chequeoe1;?> onclick="anios(1);"/><label for="RadioButton1"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text5">
    							<span style="color:#808080;font-family:Arial;font-size:13px;"> Anual</span>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_RadioButton2">
    							<input type="radio" id="RadioButton2" name="esanual" value="2" <?php echo $chequeoe2;?>/><label for="RadioButton2"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text6">
    							<span style="color:#808080;font-family:Arial;font-size:13px;"> Ocasional</span>
    						</div>
    					</td>
    				</tr>
    				</table>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4113==2 || $v_4113==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaferiados()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='feriados.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.nroorden.style.backgroundColor='yellow';

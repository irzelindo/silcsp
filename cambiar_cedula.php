		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>CAMBIAR CEDULA DE IDENTIFICACION</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_corregir_cedula.php">
    	...
    	<div id="LayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line2"/>
    				<div id="wb_Text2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Identificaci&oacute;n Actual: </strong></span>
    				</div>
    				<hr id="Line3"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="passactual" id="passactual" size="15" maxlength="15" value="<?php echo $passactual; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    				<hr id="Line5"/>
    			</div>
    		</div>
    	</div>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nueva Identificaci&oacute;n:  </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="passnew1" name="passnew1" size="15" maxlength="15" value="<?php echo $passnew1;?>" onkeypress="return validarcar(event)"/>
    				<hr id="Line15"/>
    			</div>
    		</div>
    	</div>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Re-confirmar Identificaci&oacute;n: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="passnew2" name="passnew2" size="15" maxlength="15" value="<?php echo $passnew2;?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    				<hr id="Line15b"/>
    			</div>
    		</div>
    	</div>
...
<?php
  ...
  if ($_GET["mensage"]==1)
     {
    	echo "<script type=''>
          swal('','C\u00e9dula Actual No debe ser blanco.!','error');
  ...
  if ($_GET["mensage2"]==2)
     {
    	echo "<script type=''>
          swal('','C\u00e9dula nueva no corresponde - Ingrese correctamente !','error');
  ...
  if ($_GET["mensage"]==99)
     {
    	echo "<script type=''>
          swal('','C\u00e9dula ha sido cambiada correctamente en todos los casos que se encontraron!','success');

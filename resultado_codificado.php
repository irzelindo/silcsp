...
$(function() {
    ...
    jQuery("#listaresultadocodificado").jqGrid({
        url:'datosresultadocodificado.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colModel:[
                ...
                caption: "RESULTADOS POSIBLES CODIFICADOS",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],
	...
	grid = $("#listaresultadocodificado");							
//	jQuery("#listaresultadocodificado").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaresultadocodificado").jqGrid('setFrozenColumns');

    jQuery("#listaresultadocodificado").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_resultado_codificado.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listaresultadocodificado"></table>
        <div id="perpage"></div>
      </div>        
        <br />
    	...
    	<?php
         if ($v_4317==2 || $v_4317==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_resultado_codificado.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_resultado_codificado.php\';" name="agregar" value="Agregar">';

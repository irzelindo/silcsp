...
$query2 = "select * from resultadosmicro where nordentra = '$nordentra' and codservicio = '$codservicio' and codestudio = '$codestudio'";
...
$query3 = "select * from estudios where codestudio = '$codestudio'";
$result3 = pg_query($link,$query3);

$row3 = pg_fetch_assoc($result3);

$codestudiobio 	= $row3["codestudiobio"];

$query4 = "select * from resultadomicroorganismo where nordentra = '$nordentra' and codservicio = '$codservicio' and codestudio = '$codestudio' and nroresul = '$nroresul'";
$result4 = pg_query($link,$query4);

$row4 = pg_fetch_assoc($result4);

$codmicroorg 	= $row4["codmicroorg"];
$resultado      = $row4["resultado"];
$codantibiogr   = $row4["codantibiogr"];
$obs     		= $row4["obs"];
...
function ValidarFormulario($form) {
	...
	if ( $codmetodo == "" ) {
		$mensaje = '- Rellene el campo Metodo!\n';

		$respuesta->Assign( "codmetodo", "style.backgroundColor", "yellow" );

	} else {
		$respuesta->Assign( "codmetodo", "style.backgroundColor", "white" );
	}
	...
	if ( $codmicroorg == "") {
		$mensaje .= '- Rellene el campo Microorganismo!\n';

		$respuesta->Assign( "codmicroorg", "style.backgroundColor", "yellow" );

	} else {
		$respuesta->Assign( "codmicroorg", "style.backgroundColor", "white" );
	}

	if ($resultado == "") {
		$mensaje .= '- Rellene el campo Resultado!\n';

		$respuesta->Assign( "resultado", "style.backgroundColor", "yellow" );

	} else {
		$respuesta->Assign( "resultado", "style.backgroundColor", "white" );
	}

	if ( $mensaje == "" ) {
		
		pg_query( $con, "UPDATE public.resultadomicroorganismo
	SET codmetodo='$codmetodo1', codumedida='$codumedida1', codsector='$codsector1', codmicroorg='$codmicroorg', resultado='$resultado', codantibiogr='$codantibiogr', obs='$obs', codestudiobio='$codestudiobio1'
	WHERE nordentra='$nrordentra' and codservicio='$codservicio1' and codestudio='$codestudio1' and nroresul='$nroresul'");


		$respuesta->redirect("resultados_detallem.php?nordentra=$nrordentra&codservicio=$codservicio1&codestudio=$codestudio1&nroorden=$nroorden");
		...
		$accion = "Carga y Validacion Microorganismos: Nro. Orden: " . $codservicio1.$nrordentra;
	...
	<div id="usuarios_detallesLayoutGrid7">
			<div class="row">
				...
				<div class="col-2">
					...
					<input type="hidden" name="nroresul" id="nroresul" value="<?php echo $nroresul; ?>">
				...
				<div class="col-2">
				  ...
				  <select name="codestudio" size="1" id="codestudio" <?php if($codestudio != ''){echo "disabled";}?> style="<?php if($codestudio != ''){echo "background-color: #DCDCDC";}?>">
					...
					<input type="hidden" name="codestudio1" id="codestudio1" value="<?php echo $codestudio; ?>">
					  <input type="hidden" name="nroestudio" id="nroestudio" value="<?php echo $nroestudio; ?>">
					</div>
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Estudio Microbiologico: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
					<select name="codestudiobio" size="1" id="codestudiobio" <?php if($codestudiobio != ''){echo "disabled";}?> style="<?php if($codestudiobio != ''){echo "background-color: #DCDCDC";}?>">
                      <option value=""></option>
                        <?php
							$tabla_dpto = pg_query($link, "select * from emicrobiologia");
							while($depto = pg_fetch_array($tabla_dpto)) 
							{
							   if(trim($depto['codestudiobio']) == trim($codestudiobio))
							   { 
								   echo "<option value = ".$depto['codestudiobio']." selected>".$depto['nomestudiobio']."</option>";
							   }
							   else
							   {
								   echo "<option value = ".$depto['codestudiobio'].">".$depto['nomestudiobio']."</option>";
							   }
    				...
    				<input type="hidden" name="codestudiobio1" id="codestudiobio1" value="<?php echo $codestudiobio; ?>">
					<hr id="turnos_detallesLine2">
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-2">
					...
					<select name="codmetodo" size="1" id="codmetodo">
                      <option value=""></option>
                        <?php
							$tabla_dpto = pg_query($link, "select * from metodos where codestudio = '$codestudio'");
							while($depto = pg_fetch_array($tabla_dpto)) 
							{
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Microorganismo: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
					<select name="codmicroorg" size="1" id="codmicroorg" >
                      <option value=""></option>
                        <?php
							$tabla_dpto = pg_query($link, "select * from microorganismos");
							while($depto = pg_fetch_array($tabla_dpto)) 
							{
							   if(trim($depto['codmicroorg']) == trim($codmicroorg))
							   { 
								   echo "<option value = ".$depto['codmicroorg']." selected>".$depto['nommicroorg']."</option>";
							   }
							   else
							   {
								   echo "<option value = ".$depto['codmicroorg'].">".$depto['nommicroorg']."</option>";
							   }
    				...
    				<input type="hidden" name="codmicroorg1" id="codmicroorg1" value="<?php echo $codmicroorg; ?>">
					<hr id="turnos_detallesLine2">
				</div>
			</div>
		</div>
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Resultado: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
					...
					<input type="text" name="resultado" id="resultado" value="<?php echo $resultado; ?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)">
					<hr id="turnos_detallesLine2">
				</div>
			</div>
		</div>
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Antibiograma: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
					<select name="codantibiogr" size="1" id="codantibiogr">
                      <option value=""></option>
                        <?php
							$tabla_dpto = pg_query($link, "select * from antibiogramas where codestudiobio = '$codestudiobio'");
							while($depto = pg_fetch_array($tabla_dpto)) 
							{
							   if(trim($depto['codantibiogr']) == trim($codantibiogr))
							   { 
								   echo "<option value = ".$depto['codantibiogr']." selected>".$depto['nomantibiogr']."</option>";
							   }
							   else
							   {
								   echo "<option value = ".$depto['codantibiogr'].">".$depto['nomantibiogr']."</option>";
							   }
    				...
    				<input type="hidden" name="codantibiogr1" id="codantibiogr1" value="<?php echo $codantibiogr; ?>">
					<hr id="turnos_detallesLine2">
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='navegador_resultadosm.php?nordentra=<?php echo $nordentra;?>&codservicio=<?php echo $codservicio;?>&codestudio=<?php echo $codestudio;?>&nroorden=<?php echo $nroorden;?>';"> VOLVER </a>&nbsp;]</span>

		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>CAMBIAR CONTRASE&Ntilde;A</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_clave.php">
    	...
    	<div id="LayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line2"/>
    				<div id="wb_Text2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Contrase&ntilde;a Actual: </strong></span>
    				</div>
    				<hr id="Line3"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="password" class="form-control" placeholder="" name="passactual" id="passactual" size="20" maxlength="20" value="<?php echo $passactual; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nueva Contrase&ntilde;a:  </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="password" class="form-control" placeholder="" id="passnew1" name="passnew1" size="20" maxlength="20" value="<?php echo $passnew1;?>" onkeypress="return validarcar(event)"/>
    				<hr id="Line15"/>
    			</div>
    		</div>
    	</div>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Re-confirmar Contrase&ntilde;a: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <input type="password" class="form-control" placeholder="" id="passnew2" name="passnew2" size="20" maxlength="20" value="<?php echo $passnew2;?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    				<hr id="Line15b"/>
    			</div>
    		</div>
    	</div>
...
<?php
  ...
  if ($_GET["mensage"]==1)
     {
    	echo "<script type=''>
          swal('','No debe ser blanco y debe concordar con la constrase\u00f1a actual !','error');
  ...
  if ($_GET["mensage2"]==2)
     {
    	echo "<script type=''>
          swal('','Contrase\u00f1a nueva no corresponde. Ingrese correctamente !','error');
  ...
  if ($_GET["mensage"]==99)
     {
    	echo "<script type=''>
          swal('','Contrase\u00f1a Cambiada correctamente. Tendr\u00e1 vigencia a partir de la pr\u00f3xima sesi\u00f3n','success');

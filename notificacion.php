...
$(function() {
    ...
    jQuery("#listapacientes").jqGrid({
        url:'datosnotificacion.php?codservicio=<?php echo $codservicio; ?>',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 200,
        ...
        colNames:['Revisar','Borrar','Nro. Notificacion', 'Nro. Orden','Nombres y Apellidos', 'Fecha', 'Hora', 'Enfermedad'],
        colModel:[
                ...
                {name:'nronotif',index:'nronotif', width:120, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
				...
				{name:'enfermedad',index: "enfermedad", width: 300, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
...
{ 
	...
	jQuery("#listapacientes").jqGrid('setGridParam',{url:"datosnotificacion.php?codservicio="+codservicio+"&desde="+desde+"&hasta="+hasta,datatype:'json'}).trigger("reloadGrid");
...
function confirmacion(cod, est, noti) 
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  {
				...
				window.location = "eliminar_notificacion.php?nordentra=" + cod + "&codservicio=" + est + "&nronotif=" + noti;
			  } 
			  else 
			  {
...
NOTIFICACION OBLIGATORIA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br></strong><br />
					</strong></span>
				</div>
			</div>
		</div>

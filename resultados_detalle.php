...
$query2 = "select * from resultados where nordentra = '$nordentra' and codservicio = '$codservicio' and codestudio = '$codestudio' and nroorden = '$nroorden'";
...
function ValidarFormulario($form) {
	...
	if ( $mensaje == "" ) {
		...
		pg_query( $con, "UPDATE public.resultados
								SET fechares='$fecharec', codmetodo='$codmetodo1', codumedida='$codumedida', resultado='$resultado', codresultado='$codresultado', codequipo='$codequipo', codestado='002'
								WHERE nordentra = '$nrordentra' and codservicio = '$codservicio1' and nroorden = '$nroorden' and codestudio = '$codestudio1' and coddetermina = '$coddetermina1'" );


		$respuesta->redirect("navegador_resultados.php?nordentra=$nrordentra&codservicio=$codservicio1&codestudio=$codestudio1");
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='navegador_resultados.php?nordentra=<?php echo $nordentra;?>&codservicio=<?php echo $codservicio;?>&codestudio=<?php echo $codestudio;?>';"> VOLVER </a>&nbsp;]</span>

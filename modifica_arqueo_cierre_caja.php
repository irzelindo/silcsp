...
$query = "select * from arqueo where fecha = '$fecha' and hora = '$hora'";
...
$sql = "select * from apertura_cierre_caja where fechaapertura = '$fecha' and tipo = '1'";

$res = pg_query( $link, $sql );
$countlc = pg_num_rows( $res );

$sql1 = "select * from apertura_cierre_caja where fechaapertura = '$fecha' and tipo = '2'";

$res1 = pg_query( $link, $sql1 );
$countlc1 = pg_num_rows( $res1 );
...
function ValidarFormulario($form) {
	...
	if ( $mensaje == "" ) 
	{
		...
		pg_query($con,"UPDATE public.arqueo
	SET codusu='$codusu', codcaja='$codcaja', monto='$montotal', b1='$b1', b5='$b5', b10='$b10', b50='$b50', b100='$b100', b500='$b500', b1000='$b1000', b2000='$b2000', b5000='$b5000',b10000='$b10000', b20000='$b20000', b50000='$b50000', b100000='$b100000', cheques='$cheques', totcheques='$totcheques1', obs='$obs', codservicio='$codservicio'
	WHERE fecha = '$fecha' and hora = '$hora'");

			$respuesta->redirect("arqueo.php");
			...
			$accion = "Arqueo: Modifica-Reg.: Fecha: " . $fecha;
...
<body onLoad="xajax_mostrar_monto_calculado(xajax.getFormValues(formu));">
	<div id="container">
	</div>
	...
	<div id="wb_turnos_detallesLayoutGrid5">
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="text" id="cantbille" name="cantbille" value="<?php echo number_format($cantbille,0,',','.'); ?>" onkeypress="return validarnum(event)" maxlength="10" readonly style="background-color: #DCDCDC">
					<input type="hidden" id="montotal" name="montotal" value="<?php echo $cantbille; ?>">
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
	  ...
	  <div id="ordenes_detallesLayoutGrid3">
		<div class="row">
		  ...
		  <div class="col-2">
			...
			<input type="text" id="cheques" name="cheques" value="<?php echo $cheques; ?>" spellcheck="false" maxlength="150" onkeypress="return validarcar(event)" onchange="conMayusculas(this)">
	...
	<div id="wb_turnos_detallesLayoutGrid5">
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="text" id="totcheques" name="totcheques" value="<?php echo $totcheques; ?>" onkeypress="return validarnum(event)" maxlength="10">
					<input type="hidden" id="totcheques1" name="totcheques1" value="<?php echo $totcheques; ?>">
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
			...
			<div class="row">
			  <div class="col-3">
				  <hr id="turnos_detallesLine7">
				    <button type="button" id="Buttonc" class="btn btn-primary btn-lg" onclick="openImprimir()">Imprimir Arqueo</span></button>
			  </div>
		  </div>
		</div>
	</div>
		...
		<div id="turnos_detallesLayoutGrid4">
			<div class="row">
				<div class="col-1">
					...
					<?php
						 if($countlc != 0 && $countlc1 == 0)
						 {
							echo '<button type="button" id="Buttonc" class="btn btn-primary btn-lg" onclick="xajax_ValidarFormulario(xajax.getFormValues(formu));">Guardar Datos</span></button>';
						 }
					?>

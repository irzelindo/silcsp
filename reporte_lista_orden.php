...
?>
  <div class="container">
    ...
    <div style="border-bottom: 1px #000000 solid;margin-top: 6px; border-top: 1px #000000 solid; border-left: 1px #000000 solid; border-right: 1px #000000 solid; padding-bottom: 10px; padding-left: 10px;">
          ...
          <?php
          echo '<div style="font-size: 18px; text-align:center"><b>Nro. Lista Trabajo:</b> '.$grupo.  '</div>';
             ?>
          <div style="font-size: 14px; text-align:left; margin-top: 6px;"><b>Ingresado por:___________________ Extraccion:____________________ PCR:____________________ Validacion:___________________</b></div>
            <?php
          echo '<div style="font-size: 14px; text-align:left"><b>Fecha y Hora:</b> '.$fecha.' '.$hora.'</div>';
          echo '<div style="font-size: 14px; text-align:left"><b>Usuario:</b> '.$codusu.'</div>';
          echo '<div style="font-size: 14x; text-align:left"><b>Sector:</b> '.$nomsector.'</div>';
          echo '<div style="font-size: 14px; text-align:left"><b>Estudio:</b> '.$nomestudio.'</div>';

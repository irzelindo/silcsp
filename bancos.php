...
$(function() {
    ...
    jQuery("#listabancos").jqGrid({
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Nombre del Banco'],
        colModel:[
                ...
                {name:'codbco',index:'codbco', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nombco',index: "nombco", width: 727, editable: true, searchoptions: {attr: {maxlength: 250,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
	...
	grid = $("#listabancos");							
//	jQuery("#listabancos").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listabancos").jqGrid('setFrozenColumns');

    jQuery("#listabancos").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_bancos.php?id=" + cod ;
			  } 
			  else 
			  {
	...
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_443==2 || $v_443==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_bancos.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_bancos.php\';" name="agregar" value="Agregar">';

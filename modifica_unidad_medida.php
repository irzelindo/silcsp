...
$codumedida  = $_GET["id"]; //Identificador del registro
$query = "select * from unidadmedida where codumedida = '$codumedida'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomumedida = $row["nomumedida"];
...
$accion="Accede a Unidades de Medida ".$codumedida."-".$nomumedida;
...
function verificaunidadmedida()
{ 
     	if (window.document.formu.nomumedida.value == "") 
		    {
  
            if(window.document.formu.nomumedida.value == "")
              {
    		    window.document.formu.nomumedida.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomumedida.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR UNIDADES DE MEDIDA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_unidad_medida.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codumedida" id="codumedida" size="10" maxlength="10" readonly="" value="<?php echo $codumedida; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomumedida" name="nomumedida" size="50" maxlength="50" value="<?php echo $nomumedida;?>" onkeypress="return validarcar(event)"  spellcheck="false"/>
                    
                    <input type="hidden" id="nomumedidax" name="nomumedidax" value="<?php echo $nomumedida;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_439==2 || $v_439==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaunidadmedida()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='unidad_medida.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codumedida.style.backgroundColor='yellow';

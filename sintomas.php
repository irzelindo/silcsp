...
$(function() {
    ...
    jQuery("#listasintomas").jqGrid({
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','tipo','Descripci&oacute;n'],
        colModel:[
                ...
                {name:'tipo',index: "tipo", width: 177, editable: true, searchoptions: {attr: {maxlength: 20,size: 20,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomsintoma',index: "nomsintoma", width: 577, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
...
function confirmacion(cod,tipo)
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_sintomas.php?id=" + cod + "&tipo=" + tipo;
			  } 
			  else 
			  {
         ...
         if ($v_422==2 || $v_422==3) 
            {
             ...
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_sintomas.php\';" name="agregar" value="Agregar">';

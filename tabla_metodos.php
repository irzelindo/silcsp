...
$mensage=0;
                 ...
                 $sql = 'select * from metodos order by codestudio ';
                 ...
                 else
                    {
                   	if ($tiporeporte==1) // reporte HTML
             	    {
                        ...
                        print '<br><table class="cuadro">'
                              ...
                              .'<td class="hr">C&oacute;digo Metodo</td>'
                        ...
                        while ($row = pg_fetch_array($res))
    	                      {
     		                  ...
     		                  print '<tr>'
    		                       ...
    		                       .'<td class="tr" width="80px">'.$row['codmetodo'] .'</td>'
    		                       .'<td class="tr" width="300px">'.$row['nommetodo'] .'</td>'
                                   .'</tr>';
    	                       }
    	                 print '</table><br />';
					 ...
					 else // EXCEL O PDF
                     {
                          ...
                          print  '<table border=1>'
    	                        .'<tr><td style="font-weight:bold;font-size:1em;background-color:#F1F1F1;color:black;" colspan="3">REPORTE DE TABLA DE METODOS</td></tr>';
                          print '</table>';		
                          ...
                          print  '<tr style="background-color:#F1F1F1;color:black;">'	
                                ...
                                .'<td style="font-size:1em; width:80px;font-weight: bold;">C&oacute;digo Metodo</td>'
                        ...
                        while ($row = pg_fetch_array($res))
                         ...
                         $fechaxx=date("Y-n-j", time());
                         $hora=date("G:i:s",time());
                         $accion="Reporte Tabla Metodos XLS ";
                         $terminal = $_SERVER['REMOTE_ADDR'];
                         $a=archdlog($codusu,$codopcx,$fechaxx,$hora,$accion,$terminal);
                         // Fin grabacion de registro de auditoria	
                     }	// FIN EXCCEL

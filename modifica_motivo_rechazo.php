...
$codrechazo  = $_GET["id"]; //Identificador del registro
$query = "select * from motivorechazo where codrechazo = '$codrechazo'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomrechazo = $row["nomrechazo"];
...
$accion="Accede a Motivos de Rechazo ".$codrechazo."-".$nomrechazo;
...
function verificamotivorechazo()
{ 
     	if (window.document.formu.nomrechazo.value == "") 
		    {
  
            if(window.document.formu.nomrechazo.value == "")
              {
    		    window.document.formu.nomrechazo.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomrechazo.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR MOTIVOS DE RECHAZO</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_motivo_rechazo.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codrechazo" id="codrechazo" size="10" maxlength="10" readonly="" value="<?php echo $codrechazo; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomrechazo" name="nomrechazo" size="100" maxlength="250" value="<?php echo $nomrechazo;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomrechazox" name="nomrechazox" value="<?php echo $nomrechazo;?>"/>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4310==2 || $v_4310==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificamotivorechazo()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='motivo_rechazo.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codrechazo.style.backgroundColor='yellow';

...
$query = "select * from homebanking where nroingreso = '$nroingreso'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nrotransac  = $row["nrotransac"];
$codbco  	 = $row["codbco"];
$fecha       = $row["fecha"];
$hora        = $row["hora"];
...
$nomyape  = $row1["razonsocial"];

$query2 = "select * from ingresocaja where nroingreso = '$nroingreso'";
...
function ValidarFormulario($form) {
	...
	if ( $nrotransac == "" && $formapago != 6) {
		$mensaje .= '- Rellene el campo Nro. Transaccion!\n';

		$respuesta->Assign( "nrotransac", "style.backgroundColor", "yellow" );

	} else {
		$respuesta->Assign( "nrotransac", "style.backgroundColor", "white" );
	}
	...
	if ( $mensaje == "" ) {
		...
		pg_query( $con, "UPDATE public.homebanking
							SET nrotransac='$nrotransac', codbco='$codbco', monto='$monto', estadu='$estadu', fechapago=$fechapago
							WHERE nroingreso = '$nroingreso'");

		$respuesta->redirect("homebanking.php");
		...
		$accion = "Ingreso por Homebanking o Cheque: Mocifica-Reg.: Nro. Ingreso: " . $nroingreso;
...
<div id="wb_pacientes_detallesLayoutGrid1">
	  <div id="pacientes_detallesLayoutGrid1">
			<div class="row">
				...
				<div class="col-2">
				  <input type="text" name="codempresa" id="codempresa" value="<?php echo $codempresa; ?>" style="background-color: #DCDCDC" readonly>
	  ...
	  <div id="turnos_detallesLayoutGrid5">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine13">
					<div id="wb_turnos_detallesText4">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Id: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine14">
		  ...
		  <div id="turnos_detallesLayoutGrid5">
				<div class="row">
					<div class="col-1">
						<hr id="turnos_detallesLine13">
						<div id="wb_turnos_detallesText4">
							<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nro. de Expediente: <br></strong></span>
						</div>
					</div>
					<div class="col-2">
						<hr id="turnos_detallesLine14">
					  <input type="text" id="nroexpediente" name="nroexpediente" value="<?php echo $nroexpediente; ?>">
					  <hr id="turnos_detallesLine15">
					</div>
				</div>
			</div>
		...
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine13">
					<div id="wb_turnos_detallesText4">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong><?php echo $nrocuenta; ?> <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <?php
				    if($formapago == 6)
					{
						echo '<input type="date" id="fechapago" name="fechapago" value="'.$fechapago.'">';
					}
					else
					{
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Entidad Bancaria: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
  ...
  <div id="wb_turnos_detallesLayoutGrid5">
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="number" id="monto" name="monto" value="<?php echo $monto; ?>" onkeypress="return validarnum(event)" maxlength="10">
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='homebanking.php'"> VOLVER </a>&nbsp;]</span>

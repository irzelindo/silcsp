...
@Header("Content-type: text/html; charset=utf-8");
   ...
   $sql1 = "select * from respeducacioncontinua where nropregunta = '$id'";
   ...
   if($numeroRegistros<=0)
      {
      $resultado1=pg_query($con,"DELETE FROM preguntaedcontinua WHERE nropregunta = '$id'"); 
      ...
      if($resultado1==true)
           {
              ...
              $accion="Preguntas de educacion continua: Elimina-Reg.: ".$id;
              $terminal = $_SERVER['REMOTE_ADDR'];
              $a=archdlog($codusu,$codopc,$fecha,$hora,$accion,$terminal);
              
              // Fin grabacion de registro de auditoria
              header("Location: educacion_continua.php?mensage=1");	
           }
    	else
    	  {
      ...
      {		
      header("Location: educacion_continua.php?mensage=4"); //no se puede borrar
      }
?>

...
function ValidarFormulario($form) {
	...
	if ( $codantibiot == "") {
		$mensaje .= '- Rellene el campo Antibiotico!\n';

		$respuesta->Assign( "codantibiot", "style.backgroundColor", "yellow" );

	} else {
		$respuesta->Assign( "codantibiot", "style.backgroundColor", "white" );
	}
	...
	if ( $mensaje == "" ) {
		...
		$unro = pg_query( $con, "select max(CAST(coalesce(nroresul, '0') AS integer)) as ultimo from resultadoantibiotico where nordentra = '$nrordentra' and codservicio = '$codservicio1' and codestudio = '$codestudio1'" );

		while ( $rowcod = pg_fetch_array( $unro ) ) {
			$nroresul = $rowcod[ 'ultimo' ] + 1;
		}
		
		pg_query( $con, "INSERT INTO public.resultadoantibiotico(
	nordentra, codservicio, nroestudio, idmuestra, nroresul, fechares, codmetodo, codumedida, codsector, codestudio, codantibiot, diametro, cmi, resultado, obs)
	VALUES ('$nrordentra', '$codservicio1', '$nroestudio', 'XXX$nroresul', '$nroresul', '$fechares', '$codmetodo1', '$codumedida1', '$codsector1', '$codestudio1', '$codantibiot', '$diametro', '$cmi', '$resultado', '$obs')");
		...
		$accion = "Carga y Validacion Antibiotico: Nro. Orden: " . $codservicio1.$nrordentra;
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Antibiotico: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
					<select name="codantibiot" size="1" id="codantibiot" >
                      <option value=""></option>
                        <?php
							$tabla_dpto = pg_query($link, "select * from antibioticos");
							while($depto = pg_fetch_array($tabla_dpto)) 
							{
							   if(trim($depto['codantibiot']) == trim($codantibiot))
							   { 
								   echo "<option value = ".$depto['codantibiot']." selected>".$depto['nomantibiot']."</option>";
							   }
							   else
							   {
								   echo "<option value = ".$depto['codantibiot'].">".$depto['nomantibiot']."</option>";
							   }
    				...
    				<input type="hidden" name="codantibiot1" id="codantibiot1" value="<?php echo $codantibiot; ?>">
					<hr id="turnos_detallesLine2">
				</div>
			</div>
		</div>
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Diametro: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
					...
					<input type="text" name="diametro" id="diametro" value="<?php echo $diametro; ?>" maxlength="20" onkeypress="return validarcar(event)" onchange="conMayusculas(this)">
					<hr id="turnos_detallesLine2">
				</div>
			</div>
		</div>
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>CMI: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
					...
					<input type="text" name="cmi" id="cmi" value="<?php echo $cmi; ?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" maxlength="100">
					<hr id="turnos_detallesLine2">
				</div>
			</div>
		</div>
	...
	<div id="wb_turnos_detallesLayoutGrid1">
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine3">
					<input type="text" name="obs" id="obs" value="<?php echo $obs; ?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" maxlength="250">
					<hr id="turnos_detallesLine2">
				</div>
			</div>
		</div>

...
<form name="formu" method="post" action="insertar_areasrel.php">
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="codarea" name="codarea"  size="10" maxlength="10" value="<?php echo $codarea;?>" onkeypress="return validarcar(event)" spellcheck="false"/>                   

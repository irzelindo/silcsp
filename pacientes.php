...
$(function() {
    ...
    jQuery("#listapacientes").jqGrid({
        ...
        colNames:['Revisar','Borrar','Nro. Paciente','Nombres y Apellidos','C&eacute;dula', 'Fecha Registro', 'Direcci&oacute;n', 'Tel&eacute;fono'],
        colModel:[
...
function gridReload()
{
	...
	jQuery("#listapacientes").jqGrid('setGridParam',{url:"datospacientes.php?codservicio="+codservicio,datatype:'json'}).trigger("reloadGrid");
...
<div id="page1Layer1">
	...
	<div id="page1Layer1_Container">
	   <?php
         if ($v_11==2 || $v_11==3)
            {
    	     echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_pacientes.php\';">Agregar</span></button>';

             //echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_pacientes.php\';" name="agregar" value="Agregar">';

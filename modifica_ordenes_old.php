...
function GenerarTurno($form)
{
    ...
    VALUES ('$nroturno', '$codservicio1', '$npaciente', '$fecharec', '$horarec', '$urgente', '$obs', '2', '2', '2')" );
				...
				if($condeter != 0)
				{
					...
					VALUES ('$nrordentra', '$codservicio', '$nroestudio', '001$nroorden', '$nroorden', '$codumedida', '$codsector', '$codestudio', '$coddetermina', '$codmetodo')" );
					}
				}
...
function GenerarMuestra($form)
{
	...
	while ( $rowmuestra = pg_fetch_array( $resultmuestra ) )
	{
		...
		if($count == 0)
		{
			...
			$unro = pg_query( $con, "select COALESCE(max(nromuestra), '0') as ultimo from estrealizar " );
		...
		VALUES ('$nroestudio', '$codservicio1', '$npaciente', '$fecharec', '$horarec', '$codestudio1', '1', '$nrordentra', '$codtmuestra', '$fecharec', '$horarec', '$codusu', '$codservicio1', '$codservicio1', '$codorigen1')" );
            ...
            if($conresul == 0)
            {
				...
				if($condeter != 0)
				{
					...
					VALUES ('$nrordentra', '$codservicio1', '$nroestudio', '001$nroorden', '$nroorden', '$codumedida', '$codsector', '$codestudio', '$coddetermina', '001', '$codmetodo', 0)" );
					}
				}

...
<body>
	...
	if($countlc != 0)
	{
		...
		<div style="font-size: 18px; margin-top: 5px; text-align:left"><b>Apellido y Nombre:</b> '.$papellido.' '.$sapellido.' '.$pnombre.' '.$snombre.'</div>
...
<br><br><br><br>
 <div style="font-size: 20px; text-align: left; margin-bottom: 10px; margin-top: 10px; ; float: left; width: 1200px">OBSERVACION: "La muestra se tomó en fecha, Martes 31 de Marzo de 2022,  a las 10:00 a.m."</div>
 

<br><br><br><br>
   <br><br><br><br><br><br><br><br><br>
 <div style="font-size: 16px; text-align: center; margin-bottom: 10px; margin-top: 10px; ; float: rigth;font-weight: bold; width: 1200px">Validado por: Dra. María José Ortega Soler </div>
 <div style="font-size: 16px; text-align: center; margin-bottom: 10px; margin-top: 10px; ; float: rigth;font-weight: bold; width: 1200px">Registro Profesional Nro. 1.136 </div>

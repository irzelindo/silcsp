...
$accion="Accede a Empresas/Laboratorios: ".$codempresa."-".$razonsocial;
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codempresa" id="codempresa" size="10" maxlength="10" readonly value="<?php echo $codempresa; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <input type="hidden" id="razonsocialx" name="razonsocialx" value="<?php echo $razonsocial;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_441==2 || $v_441==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaempresas()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>

...
function ValidarFormulario($form) {
	...
	$sql1 = "select * from estrealizar where nropaciente = '$npaciente' and nordentra = '$nordentra' and codestudio = '$codestudio' and codservicio = '$codservicio1'";
	...
	if ($mensaje == "") 
	{
	   ...
	   SET codservicio='$codservicio1', nropaciente='$npaciente', fecha='$fecharec', hora='$horarec', codestudio='$codestudio', nordentra='$nordentra', codtmuestra='$codtmuestra', nroturno='$nroturno', fechatmues='$fecharec', horatmues='$horarec'
	 WHERE nroestudio = '$nroestudio'" );
            ...
            if($conresul == 0)
            {
				...
				if($condeter != 0)
				{
					...
					VALUES ('$nordentra', '$codservicio', '$nroestudio', '001$nroorden', '$nroorden', '$codumedida', '$codsector', '$codestudio', '$coddetermina', '$codmetodo')" );
					}
				}
		...
		$respuesta->redirect("modifica_ordenes.php?nordentra=$nordentra&codservicio=$codservicio1");
		...
		$accion = "Orden-Estudios: Modifica-Reg.: Estudio: " . $codestudio;
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_ordenes.php?nordentra=<?php echo $nordentra;?>&codservicio=<?php echo $codservicio;?>'"> VOLVER </a>&nbsp;]</span>

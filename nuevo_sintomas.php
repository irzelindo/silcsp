...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $codsintoma    = $_SESSION['codsintoma'];
  $nomsintoma    = $_SESSION['nomsintoma'];  
  $tipo    = $_SESSION['tipo'];  
  }
else
  {
...
<form name="formu" method="post" action="insertar_sintomas.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codsintoma" id="codsintoma" size="10" maxlength="10" value="<?php echo $codsintoma; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomsintoma" name="nomsintoma" size="100" maxlength="100" value="<?php echo $nomsintoma;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificasintomas()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

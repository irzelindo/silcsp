...
<form name="formu" method="post" action="insertar_sintomasrel.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codenferm" id="codenferm" style="background-color: #CCCCCC;" size="10" maxlength="10" value="<?php echo $codenferm; ?>" onkeypress="return validarcar(event)" readonly="" spellcheck="false"/>

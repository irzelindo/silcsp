		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>REPORTES FINANCIEROS MSP</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<form name="formu" method="post" action="reporte_financiero2.php" target="_blank">
...
<div id="wb_LayoutGrid4">
	<div id="LayoutGrid4">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line4"/>
				<select name="codigo_usu" size="1" id="codigo_usu"<?php if($codusu1 !='' ){ echo 'disabled';} ?> style="<?php if($codusu1 != ''){echo "background-color: #DCDCDC";}?>">
					<option value = ""></option>
                    <?php
    				$tabla_usuarios = pg_query($link,"select * from usuarios order by nomyape");
    				while($row = pg_fetch_array($tabla_usuarios)) 
    				{
                         if($row['codusu'] == $codusu)
                            {
                                echo "<option value = ".$row['codusu']." selected>".$row['nomyape']."</option>"; 
                            }
                            else
                            {
                                echo "<option value = ".$row['codusu'].">".$row['nomyape']."</option>";
                            }
    				}
			     ?>
				</select>
	...
	<div id="LayoutGrid4">
		<div class="row">
			<div class="col-1">
				<hr id="Line2"/>
				<div id="wb_Text2">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Reporte: </strong></span>
				</div>
				<hr id="Line3"/>
			</div>
			<div class="col-2">
				...
				<select name="reporte"  id="reporte">
					<option></option>
					<option value="repfin1">FORMULARIO N° 1 - RENDICI&Oacute;N DE DUPLICADOS DE RECIBOS POR COBRO DE ARANCELES</option>
					<option value="repfin2">FORMULARIO N° 2 - DEP&Oacute;SITO DE RECAUDACIONES</option>
					<option value="repfin3">FORMULARIO N° 4 - RENDICI&Oacute;N DE RECAUDACIONES CONSOLIDADAS POR SERVICIOS PRESTADOS</option>
				</select>
				<hr id="Line5"/>
			</div>
		</div>
	...
	<div id="LayoutGrid6">
		<div class="row">
			<div class="col-1">
				<hr id="Line7"/>
				<div id="wb_Text4">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Fecha Desde: </strong></span>
				</div>
				<hr id="Line13"/>
			</div>
			<div class="col-2">
	...
	<div id="LayoutGrid6">
		<div class="row">
			<div class="col-1">
				<hr id="Line7"/>
				<div id="wb_Text4">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Fecha Hasta: </strong></span>
				</div>
				<hr id="Line13"/>
			</div>
			<div class="col-2">
	...
	<div id="LayoutGrid4">
		<div class="row">
			<div class="col-1">
				<hr id="Line2"/>
				<div id="wb_Text2">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Forma de Pago: </strong></span>
				</div>
				<hr id="Line3"/>
			</div>
			<div class="col-2">
				<hr id="Line4"/>
				<select name="pagos" size="1" id="pagos">
					<option></option>
                    <option value = "TODAS">TODAS</option>
                    ...
                    <option value="5">HOME BANKING</option>
                    <option value="6">OTROS CASOS</option>
				</select>
				<hr id="Line5"/>
			</div>
		</div>
	...
	<div id="LayoutGrid4">
		<div class="row">
			<div class="col-1">
				<hr id="Line2"/>
				<div id="wb_Text2">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Aranceles: </strong></span>
				</div>
				<hr id="Line3"/>
			</div>
			<div class="col-2">
				<hr id="Line4"/>
				<select name="codarancel" size="1" id="codarancel">
					<option value = ""></option>
                    <option value = "TODAS">TODAS</option>
                    <?php
    				$tabla_servicio = pg_query($link,"select * from aranceles order by nomarancel");
    				while($row = pg_fetch_array($tabla_servicio)) 
    				{
    				    $nombre= $row['codarancel'].' - '.$row['nomarancel'];
                         ?>

...
if ($_GET["mensage2"]==1)
  {
  $codresultado       = $_SESSION['codresultado'];
...
<form name="formu" method="post" action="insertar_respuestasrel.php">
...
if ($_GET["mensage2"]==1)
	...
	echo "<script type=''>
    window.document.formu.codresultado.style.backgroundColor='yellow';
     swal('','Ya existe Resultado relacionado a esta Determinacion!','error');
     </script>"; 
    }

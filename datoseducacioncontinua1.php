...
where r.nropregunta = p.nropregunta ".$w; 
	...
	while ($row = pg_fetch_array($res1))
	{
	    ...
	    $respuesta->rows[$i]['cell'] = array('<div id="wb_FontAwesomeIcon4"><a href="#" onclick="confirmacion('."'".$row['nroeval']."', '".$row['codempresa']."', '".$row['nropregunta']."'".');" style="text-decoration:none"><div id="FontAwesomeIcon4"><i class="fa fa-trash-o">&nbsp;</i></div></a></div>',$row['textopregunta'],$row['respuesta']); 

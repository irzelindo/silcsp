...
@Header("Content-type: text/html; charset=utf-8");
   ...
   $sql1 = "select * from rechazados where codrechazo = '$id'";
   ...
   if($numeroRegistros<=0)
      {
      $resultado1=pg_query($con,"DELETE FROM motivorechazo WHERE codrechazo = '$id'"); 
      ...
      if($resultado1==true)
           {
              ...
              $accion="Motivos de Rechazo: Elimina-Reg.: ".$id;
              $terminal = $_SERVER['REMOTE_ADDR'];
              $a=archdlog($codusu,$codopc,$fecha,$hora,$accion,$terminal);
              
              // Fin grabacion de registro de auditoria
              header("Location: motivo_rechazo.php?mensage=1");	
           }
    	else
    	  {
      ...
      {		
      header("Location: motivo_rechazo.php?mensage=4"); //no se puede borrar
      }
?>

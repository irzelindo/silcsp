...
$mensage=0;
                 ...
                 $sql = 'select * from microorganismos order by codmicroorg ';
                 ...
                 if ($numeroRegistros<=0)
                 ...
                 else
                    {
                   	if ($tiporeporte==1) // reporte HTML
             	    {
                        ...
                        echo '<p style="margin-left:0px"><strong>&nbsp;REPORTE DE TABLA DE MICROORGANISMOS</strong></p></td>';
    	                echo '</tr></table>';
                        ...
                        while ($row = pg_fetch_array($res))
    	                      {
     		                  ...
     		                  print '<tr>'
                                   .'<td class="tr" width="80px">'.$row['codmicroorg'] .'</td>'
    		                       .'<td class="tr" width="300px">'.$row['nommicroorg'] .'</td>'
                         ...
                         $accion="Reporte Tabla Microorganismos ";
					 ...
					 else // EXCEL O PDF
                     {
                          ...
                          print  '<table border=1>'
    	                        .'<tr><td style="font-weight:bold;font-size:1em;background-color:#F1F1F1;color:black;" colspan="3">REPORTE DE TABLA DE MICROORGANISMOS</td></tr>';
                          print '</table>';		
                        ...
                        while ($row = pg_fetch_array($res))
    	                      {
     		                  ...
     		                  print '<tr>'
                                   .'<td>'.$row['codmicroorg'].'</td>'
    		                       .'<td>'.acentos($row['nommicroorg']).'</td>'
                         ...
                         $fechaxx=date("Y-n-j", time());
                         $hora=date("G:i:s",time());
                         $accion="Reporte Tabla Microorganismos XLS ";
                         $terminal = $_SERVER['REMOTE_ADDR'];
                         $a=archdlog($codusu,$codopcx,$fechaxx,$hora,$accion,$terminal);
                         // Fin grabacion de registro de auditoria	
                     }	// FIN EXCCEL

...
$codresultado  = $_GET["id"]; //Identificador del registro
$query = "select * from resultadocodificadobio where codresultado = '$codresultado'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomresultado = $row["nomresultado"];
...
$accion="Accede a Resultados Microbiologia Posibles: ".$codresultado."-".$nomresultado;
...
function verificaresultadocodificadobio()
{ 
     	if (window.document.formu.nomresultado.value == "") 
		    {
  
            if(window.document.formu.nomresultado.value == "")
              {
    		    window.document.formu.nomresultado.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomresultado.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR RESULTADOS MICROBIOLOGIA POSIBLES CODIFICADOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_resultado_codificadomicro.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codresultado" id="codresultado" size="10" maxlength="10" readonly="" value="<?php echo $codresultado; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomresultado" name="nomresultado" size="100" maxlength="250" value="<?php echo $nomresultado;?>" onkeypress="return validarcar(event)"  spellcheck="false"/>
                    
                    <input type="hidden" id="nomresultadox" name="nomresultadox" value="<?php echo $nomresultado;?>"/>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4317==2 || $v_4317==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaresultadocodificadobio()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='resultado_codificadomicro.php';"> VOLVER </a>&nbsp;]</span>

...
{ 
     	if (window.document.formu.codorigen.value == "" || window.document.formu.nomorigen.value == "") 
		    {
            if(window.document.formu.codorigen.value == "")
              {
    		    window.document.formu.codorigen.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codorigen.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_origen_paciente.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codorigen" id="codorigen" size="10" maxlength="10" value="<?php echo $codorigen; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaorigenpaciente()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

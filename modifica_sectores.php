...
$codsector  = $_GET["id"]; //Identificador del registro
$query = "select * from sectores where codsector = '$codsector'";
...
$accion="Accede a Sectores Laboratoriales: ".$codsector."-".$nomsector;
...
function verificasector()
{ 
     	if (window.document.formu.nomsector.value == "") 
		    {
  
            if(window.document.formu.nomsector.value == "")
              {
    		    window.document.formu.nomsector.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomsector.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR SECTORES LABORATORIALES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_sectores.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codsector" id="codsector" size="10" maxlength="10" readonly="" value="<?php echo $codsector; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomsector" name="nomsector" size="100" maxlength="200" value="<?php echo $nomsector;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomsectorx" name="nomsectorx" value="<?php echo $nomsector;?>"/>
    	...
    	<div id="LayoutGrid4">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line2"/>
    				<div id="wb_Text2">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Posicion: </strong></span>
    				</div>
    				<hr id="Line3"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="posicion" id="posicion" size="10" maxlength="5" value="<?php echo $posicion; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4110==2 || $v_4110==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificasector()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='sectores.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codsector.style.backgroundColor='yellow';

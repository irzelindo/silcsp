...
$(function() {
    ...
    jQuery("#listamicroorganismos").jqGrid({
        url:'datosmicroorganismos.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Descripci&oacute;n','C&oacute;digo Externo'],
        colModel:[
                ...
                {name:'codmicroorg',index:'codmicroorg', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nommicroorg',index: "nommicroorg", width: 377, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'codexterno',index: "codexterno", width: 377, editable: true, searchoptions: {attr: {maxlength: 50,size: 50,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}                
                 ],
	...
	grid = $("#listamicroorganismos");							
//	jQuery("#listamicroorganismos").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listamicroorganismos").jqGrid('setFrozenColumns');

    jQuery("#listamicroorganismos").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_microorganismos.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listamicroorganismos"></table>
        <div id="perpage"></div>
      </div>        
        <br />
    	...
    	<?php
         if ($v_4314==2 || $v_4314==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_microorganismos.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_microorganismos.php\';" name="agregar" value="Agregar">';

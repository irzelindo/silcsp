...
$codenferm  = $_GET["codenferm"]; //Identificador del registro
$norden  = $_GET["norden"]; //Identificador del registro

$_SESSION['codenferm']=$codenferm;
$_SESSION['norden']=$norden;

$query = "select * from enfsintomas where codenferm = '$codenferm' and norden='$norden'";
$result = pg_query($link,$query);
$row = pg_fetch_assoc($result);

$codsintoma=$row['codsintoma'];
$tipo=$row['tipo'];

$query2 = "select * from sintomas where codsintoma = '$codsintoma' and tipo='$tipo'";
$result2 = pg_query($link,$query2);
$row2 = pg_fetch_assoc($result2);

$nomsintoma=$row2['nomsintoma'];
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR SINTOMAS RALACIONADOS A ENFERMEDADES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_sintomasrel.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codenferm" id="codenferm" style="background-color: #CCCCCC;" size="50" maxlength="50" value="<?php echo $codenferm; ?>" onkeypress="return validarcar(event)" readonly="" spellcheck="false"/>
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>S&iacute;ntoma: </strong></span>
    				</div>
    			</div>
    			<div class="col-2">
    				<hr id="Line1"/>
    				<select name="nomsintoma" size="1" id="nomsintoma">
    					<option value=""></option>
                        <?php
            			$tabla_dpto = pg_query($link, "select * from sintomas order by nomsintoma");
            			while($depto = pg_fetch_array($tabla_dpto)) 
            			{
            		       if($depto["nomsintoma"]==$nomsintoma)
                             {//Para que ponga predeterminado el que hay guardado
                             ?>
            		          <option value = "<?php echo $depto['nomsintoma']; ?>" selected="" > 
            	              <?php echo $depto['nomsintoma']; ?></option>
                              <?php 
            			  	  }
                              else
            				  {?>
            		          <option value = "<?php echo $depto['nomsintoma']; ?>" > 
            		          <?php echo $depto['nomsintoma']; ?></option>
                              <?php
            				  }?> 
                        <?php
                    ...
                    <input type="hidden" name="nomsintomax" id="nomsintomax" value="<?php echo $nomsintoma; ?>"/>                    
                    <input type="hidden" name="norden" id="norden" value="<?php echo $norden; ?>"/>                    
                    <input type="hidden" name="codsintoma" id="codsintoma" value="<?php echo $codsintoma; ?>"/>                    
    				<hr id="Line8"/>
    			</div>
    		</div>
    	</div>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificasintoma()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_enfermedades.php?id=<?php echo $codenferm; ?>';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
	...
	echo "<script type=''>
    window.document.formu.nomsintoma.style.backgroundColor='yellow';
     swal('','Ya existe S\u00edntoma relacionado a esta Enfermedad!','error');
     </script>"; 
    }

		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ARQUEO DE CAJA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<form name="formu" method="post" action="arqueos2.php" target="_blank">
...
<div id="wb_LayoutGrid6">
	<div id="LayoutGrid6">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line14"/>
				<input type="date" id="fecha" name="fecha" value="<?php echo $fecha = date("Y-m-d");?>" spellcheck="false"/>
				<hr id="Line15"/>
			</div>
		</div>
	</div>

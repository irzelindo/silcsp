...
$codproceso  = $_GET["id"]; //Identificador del registro
$query = "select * from procesos where codproceso = '$codproceso'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomproceso = $row["nomproceso"];
$textobase = $row["textobase"];
$codopc = $row["codopc"];
...
$accion="Accede a Procesos: ".$codproceso."-".$nomproceso;
$terminal = $_SERVER['REMOTE_ADDR'];
$a=archdlog($_SESSION['codusu'],$codopcx,$fecha2,$hora,$accion,$terminal);
...
#nomproceso:focus, #textobase:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
{ 
     	if (window.document.formu.codproceso.value == "" || window.document.formu.nomproceso.value == ""  || window.document.formu.codopc.value == ""  || window.document.formu.textobase.value == "") 
		    {
            if(window.document.formu.codproceso.value == "")
              {
    		    window.document.formu.codproceso.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codproceso.style.backgroundColor='white';    
              } 

            if(window.document.formu.nomproceso.value == "")
              {
    		    window.document.formu.nomproceso.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomproceso.style.backgroundColor='white';    
              }

            if(window.document.formu.codopc.value == "")
              {
    		    window.document.formu.codopc.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codopc.style.backgroundColor='white';    
              }               
            if(window.document.formu.textobase.value == "")
              {
    		    window.document.formu.textobase.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.textobase.style.backgroundColor='white';    
              }
           	 //entonces (no algo esta en blanco) devuelvo el valor cadena vacia 
           	 swal("","Los datos obligatorios no deben estar en blanco:\n - C\u00f3digo,\n - Denominaci\u00f3n,\n - Opci\u00f3n del sistema,\n - Texto del Mensaje","warning"); 
			return false;
     	    }
         else
            {
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR PROCESOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_procesos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codproceso" id="codproceso" size="10" maxlength="10" readonly="" value="<?php echo $codproceso; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomproceso" name="nomproceso" size="100" maxlength="100" value="<?php echo $nomproceso;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomprocesox" name="nomprocesox" value="<?php echo $nomproceso;?>"/>
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Opci&oacute;n del Sistema: <br>
    					</strong></span>
    				</div>
    			</div>
    			<div class="col-2">
    				<hr id="Line1"/>
    				<select name="codopc" size="1" id="codopc">
    					<option value=""></option>
                        <?php
            			$tabla_dpto = pg_query($link, "select * from opciones order by codopc");
            			while($depto = pg_fetch_array($tabla_dpto)) 
            			{
            		       if($depto["codopc"]==$codopc)
                             {//Para que ponga predeterminado el que hay guardado
                             ?>
            		          <option value = "<?php echo $depto['codopc']; ?>" selected="" > 
            	              <?php echo $depto['codopc'].' - '.$depto['nomopc']; ?></option>
                              <?php 
            			  	  }
                              else
            				  {?>
            		          <option value = "<?php echo $depto['codopc']; ?>" > 
            		          <?php echo $depto['codopc'].' - '.$depto['nomopc']; ?></option>
                              <?php
            				  }?> 
                        <?php
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Texto base del mensaje: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="textobase" name="textobase" size="150" maxlength="250" value="<?php echo $textobase;?>" onkeypress="return validarcar(event)" spellcheck="false"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_415==2 || $v_415==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaprocesos()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='procesos.php';"> VOLVER </a>&nbsp;]</span>

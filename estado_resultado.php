...
$(function() {
    ...
    jQuery("#listaestadoresultado").jqGrid({
        url:'datosestadoresultado.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Estados de Resultados'],
        colModel:[
                ...
                {name:'codestado',index:'codestado', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 5,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomestado',index: "nomestado", width: 727, editable: true, searchoptions: {attr: {maxlength: 100,size: 100,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
	...
	grid = $("#listaestadoresultado");							
//	jQuery("#listaestadoresultado").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaestadoresultado").jqGrid('setFrozenColumns');

    jQuery("#listaestadoresultado").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_estado_resultado.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listaestadoresultado"></table>
        <div id="perpage"></div>
      </div>        
        <br />
    	...
    	<?php
         if ($v_4311==2 || $v_4311==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_estado_resultado.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_estado_resultado.php\';" name="agregar" value="Agregar">';

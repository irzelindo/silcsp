...
x(document).ready(function() {
	x("#Button1").click(function(){
		...
		{
			window.location = "nuevo_homebanking.php?codservicio="+jQuery("#Combobox1").val();
		}
		else
		{
...
$(function() {
    ...
    jQuery("#listapacientes").jqGrid({
        url:'datoshomebanking.php?codservicio=<?php echo $codservicio; ?>',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 200,
        ...
        colNames:['Revisar','Borrar','Nro. Ingreso', 'Fecha','Concepto', 'Monto'],
        colModel:[
                ...
                {name:'nomarancel',index: "nomarancel", width: 430, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
...
{ 
	...
	jQuery("#listapacientes").jqGrid('setGridParam',{url:"datoshomebanking.php?codservicio="+codservicio+"&desde="+desde+"&hasta="+hasta,datatype:'json'}).trigger("reloadGrid");
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  {
				window.location = "eliminar_homebanking.php?nroingreso=" + cod;
			  } 
			  else 
			  {
...
INGRESOS POR HOMEBANKING</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br></strong><br />
					</strong></span>
				</div>
			</div>
		</div>

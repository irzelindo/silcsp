...
(function($) {
	...
	$.alerts = {
		...
		confirm: function(message, title, callback) {
			if( title == null ) title = 'Solicitud de Confirmaci\u00f3n';
		...
		prompt: function(message, value, title, callback) {
			if( title == null ) title = 'Especifique';
		...
		message: function(message, title, callback) {
			if( title == null ) title = 'Notificaci\u00f3n de \u00e9xito';
		...
		warning: function(message, title, callback) {
			if( title == null ) title = 'Aviso Importante';
		...
		error: function(message, title, callback) {
			if( title == null ) title = 'Encontramos un Error';

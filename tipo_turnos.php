...
$(function() {
    ...
    jQuery("#listatiposturnos").jqGrid({
        url:'datostipoturnos.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','Establecimiento','&Aacute;rea','Tipo de Turno'],
        colModel:[
                ...
                {name:'nomservicio',index: "nomservicio", width: 350, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomarea',index: "nomarea", width: 350, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomturno',index:'nomturno', width:300, align:"left", editable: true, searchoptions: {attr: {maxlength: 30,size: 30,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}                
                 ],
                                  
                caption: "TIPOS TURNOS",
                ignoreCase:true,                
                pager: '#perpage',
   				width:900,
                rowNum:7,
	...
	grid = $("#listatiposturnos");							
//	jQuery("#listatiposturnos").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listatiposturnos").jqGrid('setFrozenColumns');

    jQuery("#listatiposturnos").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
function confirmacion(codturno,codservicio,codarea) 
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_tipo_turnos.php?id=" + codturno + "&codservicio=" + codservicio + "&codarea=" + codarea;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listatiposturnos"></table>
        <div id="perpage"></div>
      </div>        
        <br />
    	...
    	<?php
         if ($v_4112==2 || $v_4112==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_tipo_turnos.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_tipo_turnos.php\';" name="agregar" value="Agregar">';

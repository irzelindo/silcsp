...
$codplatilla  = $_GET["id"]; //Identificador del registro
$_SESSION['codplatilla']=$codplatilla;

$query = "select * from plantillaplan where codplatilla = '$codplatilla'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomplatilla = $row["nomplatilla"];
...
$accion="Accede a Plantillas de Planes de Trabajo: ".$codplatilla."-".$nomplatilla;
...
$(function() {
    ...
    jQuery("#listacolumnas").jqGrid({
        url:'datoscolumnasrel.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','Posici&oacute;n','Columna de la Plantilla'],
        colModel:[
                ...
                {name:'columna',index: "columna", width: 677, editable: true, searchoptions: {attr: {maxlength: 100,size: 90,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}               
                 ],                                 
                caption: "COLUMNAS DE LA PLANTILLA",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],
	...
	grid = $("#listacolumnas");							
//	jQuery("#listacolumnas").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listacolumnas").jqGrid('setFrozenColumns');

    jQuery("#listacolumnas").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_columnasrel.php?codplatilla=" + cod1 + "&posicion=" + cod2 ;
			  } 
			  else 
			  {
...
function verificaplantillaplan()
{ 
     	if (window.document.formu.nomplatilla.value == "") 
		    {
  
            if(window.document.formu.nomplatilla.value == "")
              {
    		    window.document.formu.nomplatilla.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomplatilla.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR PLANTILLAS DE PLANES DE TRABAJO</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_plantillas_plan_trabajo.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codplatilla" id="codplatilla" size="10" maxlength="10" readonly="" value="<?php echo $codplatilla; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomplatilla" name="nomplatilla" size="100" maxlength="200" value="<?php echo $nomplatilla;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomplatillax" name="nomplatillax" value="<?php echo $nomplatilla;?>"/>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4318==2 || $v_4318==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaplantillaplan()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='plantillas_plan_trabajo.php';"> VOLVER </a>&nbsp;]</span>
	...
	<div id="sintomas_detallesLayoutGrid1">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_4318==2 || $v_4318==3) 
            {
             echo '<input type="submit" id="Button1b" onclick="window.location.href=\'nuevo_columnasrel.php?codplatilla='.$codplatilla.'\';" name="agregar" value="Agregar">';
            }
         ?> 
         <br />&nbsp;       
	</div>        
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codplatilla.style.backgroundColor='yellow';
     swal('','Ya existe otro registro con ese C\u00f3digo!','swal');
     </script>"; 
    }

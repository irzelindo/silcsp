...
$codenferm  = $_GET["id"]; //Identificador del registro
$_SESSION['codenferm']=$codenferm;

$query = "select * from enfermedades where codenferm = '$codenferm'";
...
$accion="Accede a Enfermedades: ".$codenferm;
...
$(function() {
    ...
    jQuery("#listasintomas").jqGrid({
        url:'datossintomasrel.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Descripci&oacute;n','Tipo'],
        colModel:[
                ...
                {name:'codsintoma',index:'codsintoma', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomsintoma',index: "nomsintoma", width: 477, editable: true, searchoptions: {attr: {maxlength: 100,size: 100,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},               
                {name:'tipo',index: "tipo", width: 277, editable: true, searchoptions: {attr: {maxlength: 50,size: 50,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}               
                 ],                                 
                caption: "SINTOMAS RALACIONADOS",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],
	...
	grid = $("#listasintomas");							
//	jQuery("#listasintomas").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listasintomas").jqGrid('setFrozenColumns');

    jQuery("#listasintomas").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_sintomasrel.php?codenferm=" + cod1 + "&norden=" + cod2 ;
			  } 
			  else 
			  {
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR ENFERMEDADES DE NOTIFICACION</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codenferm" id="codenferm" size="50" maxlength="50" readonly="" value="<?php echo $codenferm; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='enfermedades.php';"> VOLVER </a>&nbsp;]</span>
	...
	<div id="sintomas_detallesLayoutGrid1">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_421==2 || $v_421==3) 
            {
             echo '<input type="submit" id="Button1b" onclick="window.location.href=\'nuevo_sintomasrel.php?codenferm='.$codenferm.'\';" name="agregar" value="Agregar">';
            }
         ?> 
         <br />&nbsp;       
	</div>        

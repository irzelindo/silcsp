...
$query2 = "select * from estrealizar where nroestudio = '$nroestudio'";
$result2 = pg_query($link,$query2);

$row2 = pg_fetch_assoc($result2);

$nroturno 	= $row2["nroturno"];
	...
	if ( $mensaje == "" ) {
        ...
        if($nordentra != '')
        {
            pg_query( $con, "UPDATE estrealizar
               SET codservicio='$codservicio1', codarea='$codarea1', nropaciente='$npaciente', fecha='$fechatur', hora='$horatur', codestudio='$codestudio', nroturno='$nrotur', codtmuestra='$codtmuestra', nordentra='$nordentra', fechatmues='$fecharec', horatmues='$horarec'
             WHERE nroestudio = '$nroestudio'" );  
        }
        else
        {
            pg_query( $con, "UPDATE estrealizar
               SET codservicio='$codservicio1', codarea='$codarea1', nropaciente='$npaciente', fecha='$fechatur', hora='$horatur', codestudio='$codestudio', nroturno='$nrotur', codtmuestra='$codtmuestra'
             WHERE nroestudio = '$nroestudio'" ); 
        }
        ...
        if($conresul == 0)
        {
            ...
            if($condeter != 0)
            {
                ...
                while ($rowdeter = pg_fetch_array($resdeter))
                {
					...
					VALUES ('$nordentra', '$codservicio', '$nroestudio', 'XXX$nroorden', '$nroorden', '$codumedida', '$codsector', '$codestudio', '$coddetermina', '$codmetodo')" );
                }
            }
        ...
        $respuesta->redirect("modifica_asignar_turnos_pacientes.php?nroturno=$nrotur&codservicio=$codservicio1");
        ...
        $accion = "Turnos-Estudios: Modificar-Reg.: Estudio: " . $codestudio;
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_turnos.php?nroturno=<?php echo $nroturno;?>&codservicio=<?php echo $codservicio;?>'"> VOLVER </a>&nbsp;]</span>

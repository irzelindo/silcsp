...
where r.nropregunta = p.nropregunta ".$w; 
	...
	while ($row = pg_fetch_array($res1))
	{
	    ...
	    $respuesta->rows[$i]['cell'] = array('<div id="wb_FontAwesomeIcon4"><a href="#" style="text-decoration:none" data-toggle="modal" data-target="#myModal" id="button"><div id="FontAwesomeIcon4"><i class="fa fa-edit">&nbsp;</i></div></a></div>',$row['textopregunta'],$row['respuesta'],$row['nropregunta']); 

...
$query2 = "select * from resultados where nordentra = '$nordentra' and codservicio = '$codservicio' and codestudio = '$codestudio'";
$result2 = pg_query($link,$query2);

$row2 = pg_fetch_assoc($result2);

$codusu5	 	= $row2["codusu5"];
$fechaenvio	 	= $row2["fechaenvio"];
$horaenvio	 	= $row2["horaenvio"];
...
$xajax->register( XAJAX_FUNCTION, 'TraeSector' );
$xajax->register( XAJAX_FUNCTION, 'Validar' );
$xajax->register( XAJAX_FUNCTION, 'ReValidar' );
$xajax->register( XAJAX_FUNCTION, 'Anular' );
$xajax->register( XAJAX_FUNCTION, 'Recitar' );
...
function TraeSector($form) {
	...
	$sql = "select distinct e.codestudio,
							 e.nomestudio,
							 e.codsector
	...
	$nomsector = $row1["nomsector"];
	
	$respuesta->Assign("nomsector","value",$nomsector);
	$respuesta->Assign("codsector1","value",$codsector);
...
function Validar($form) {
	...
	if ( $codestudio == "" ) {
		...
		$respuesta->Assign( "codestudio", "style.backgroundColor", "white" );
	}
	...
	if ( $mensaje == "" ) {
		...
		pg_query( $con, "UPDATE public.resultados
								SET codusu1 = '$codusu', fechaval = '$fechaval', horaval = '$horaval', codestado = '003'
								WHERE nordentra = '$nrordentra' and codservicio = '$codservicio1' and codestudio = '$codestudio'" );
		
		$respuesta->Assign("codusu1","value",$codusu);
		$respuesta->Assign("fechaval","value",$fechaval);
		$respuesta->Assign("horaval","value",$horaval);
		
		$respuesta->script('swal("Validacion realizado con Exito!", "", "success")');
		$respuesta->script("gridReload()");
		...
		$accion = "Validacion Resultado: Nro. Orden: " . $nrordentra;
...
function ReValidar($form) {
	...
	if ( $mensaje == "" ) {
		...
		pg_query( $con, "UPDATE public.resultados
								SET codusu2 = '$codusu', fechareval = '$fechareval', horareval = '$horareval', codestado = '004'
								WHERE nordentra = '$nrordentra' and codservicio = '$codservicio1' and codestudio = '$codestudio'" );
		
		$respuesta->Assign("codusu2","value",$codusu);
		$respuesta->Assign("fechareval","value",$fechareval);
		$respuesta->Assign("horareval","value",$horareval);
		
		$respuesta->script('swal("ReValidacion realizado con Exito!", "", "success")');
		$respuesta->script("gridReload()");
		...
		$fecha1 = date( "Y-n-j", time() );
		$hora = date( "G:i:s", time() );
		$accion = "ReValidacion Resultado: Nro. Orden: " . $nrordentra;
		$terminal = $_SERVER[ 'REMOTE_ADDR' ];
		$a = archdlog( $_SESSION[ 'codusu' ], $codopc, $fecha1, $hora, $accion, $terminal );
		// Fin grabacion de registro de auditoria
...
function Anular($form) {
	...
	if ( $mensaje == "" ) {
		...
		pg_query( $con, "UPDATE public.resultados
								SET codusu3 = '$codusu', fechaanul = '$fechaanul', horaanul = '$horaanul', codestado = '005'
								WHERE nordentra = '$nrordentra' and codservicio = '$codservicio1' and codestudio = '$codestudio'" );
		
		$respuesta->Assign("codusu3","value",$codusu);
		$respuesta->Assign("fechaanul","value",$fechaanul);
		$respuesta->Assign("horaanul","value",$horaanul);
		
		$respuesta->script('swal("Anulacion realizado con Exito!", "", "success")');
		$respuesta->script("gridReload()");
		...
		$fecha1 = date( "Y-n-j", time() );
		$hora = date( "G:i:s", time() );
		$accion = "Anulacion Resultado: Nro. Orden: " . $nrordentra;
		$terminal = $_SERVER[ 'REMOTE_ADDR' ];
		$a = archdlog( $_SESSION[ 'codusu' ], $codopc, $fecha1, $hora, $accion, $terminal );
		// Fin grabacion de registro de auditoria
...
function Recitar($form) {
	...
	if ( $mensaje == "" ) {
		...
		$query2 = "select * from resultados where nordentra = '$nrordentra' and codservicio = '$codservicio1' and codestudio = '$codestudio'";
		...
		pg_query( $con, "UPDATE public.ordtrabajo
								SET recitacion = '1'
		...
		while ( $row = pg_fetch_array( $result2 ) ) 
		{
			...
			$unro = pg_query( $con, "select max(CAST(coalesce(nroorden, '0') AS integer)) as ultimo from resultados where nordentra = '$nrordentra' and codservicio = '$codservicio1' and codestudio = '$codestudio'" );

			while ( $rowcod = pg_fetch_array( $unro ) ) {
				$nroorden1 = $rowcod[ 'ultimo' ] + 1;
			}
			
			pg_query($con, "INSERT INTO resultados(
						nordentra, codservicio, nroestudio, idmuestra, nroorden, codumedida, codsector, codestudio, coddetermina, codestado)
						VALUES ('$nrordentra', '$codservicio1', '$nroestudio', 'XXX$nroorden1', '$nroorden1', '$codumedida', '$codsector', '$codestudio', '$coddetermina', '001')" );
		}
		
		$respuesta->script('swal("Recitacion realizado con Exito!", "", "success")');
		$respuesta->script("gridReload()");
		...
		$fecha1 = date( "Y-n-j", time() );
		$hora = date( "G:i:s", time() );
		$accion = "Recitacion Resultado: Nro. Orden: " . $nrordentra;
		$terminal = $_SERVER[ 'REMOTE_ADDR' ];
		$a = archdlog( $_SESSION[ 'codusu' ], $codopc, $fecha1, $hora, $accion, $terminal );
		// Fin grabacion de registro de auditoria
...
<head>
	...
	z-index: 87;
		...
		#wb_resultados_detallesLayoutGrid9 {
			clear: both;
			position: relative;
			table-layout: fixed;
			display: table;
		...
		#resultados_detallesLayoutGrid9 {
			-webkit-box-sizing: border-box;
			-moz-box-sizing: border-box;
			box-sizing: border-box;
			padding: 0px 15px 0px 15px;
		...
		#resultados_detallesLayoutGrid9 .row {
			margin-right: -15px;
			margin-left: -15px;
		}
		#resultados_detallesLayoutGrid9 .col-1, #resultados_detallesLayoutGrid9 .col-2, #resultados_detallesLayoutGrid9 .col-3, #resultados_detallesLayoutGrid9 .col-4 {
			-webkit-box-sizing: border-box;
			-moz-box-sizing: border-box;
			box-sizing: border-box;
			font-size: 0px;
		...
		#resultados_detallesLayoutGrid9 .col-1 {
			background-color: transparent;
			background-image: none;
			width: 25%;
			text-align: left;
		}
		#resultados_detallesLayoutGrid9 .col-2 {
			background-color: transparent;
			background-image: none;
			width: 25%;
			text-align: left;
		}
		#resultados_detallesLayoutGrid9 .col-3 {
			background-color: transparent;
			background-image: none;
			width: 25%;
			text-align: left;
		}
		#resultados_detallesLayoutGrid9 .col-4 {
			background-color: transparent;
			background-image: none;
			width: 25%;
			text-align: left;
		}
		#resultados_detallesLayoutGrid9:before, #resultados_detallesLayoutGrid9:after, #resultados_detallesLayoutGrid9 .row:before, #resultados_detallesLayoutGrid9 .row:after {
			display: table;
			content: " ";
		}
		#resultados_detallesLayoutGrid9:after, #resultados_detallesLayoutGrid9 .row:after {
			clear: both;
		}
	...
	<script>
		$( function () {
			...
			jQuery( "#listamuestras" ).jqGrid( {
				url: 'datosresultadosdetalle.php?nordentra=999&codservicio=000',
				datatype: 'json',
				mtype: 'GET',
				loadonce: true,
				height: 200,
				...
				colNames: ['Revisar', 'Determinaci&oacute;n', 'Resultado', 'Unidad', 'Nro. Muestra', 'Estado', '', '', '', ''],
				colModel: [ 
					...
					{name:'nordentra', index:'nordentra', hidden: true},
					
					{name:'codservicio', index:'codservicio', hidden: true},
					
					{name:'nroestudio', index:'nroestudio', hidden: true},
					
					{name:'nroorden', index:'nroorden', hidden: true}
	...
	<script language="JavaScript">
		...
		{ 
			...
			jQuery("#listamuestras").jqGrid('setGridParam',{url:"datosresultadosdetalle.php?nordentra="+nordentra+"&codservicio="+codservicio+"&codestudio="+codestudio,datatype:'json'}).trigger("reloadGrid");

		}
		
		function openResultado() 
		{
    		var nordentra   = window.document.formu.nrordentra.value;
			var codservicio = window.document.formu.codservicio1.value;
			var codestudio  = window.document.formu.codestudio.value;
			
			window.open("impresion_resultados.php?nordentra="+nordentra+"&codservicio="+codservicio+"&codestudio="+codestudio);
		}
	</script>
...
<body onLoad="xajax_TraeSector(xajax.getFormValues('formu'));">
	<div id="container">
	</div>
...
<div id="wb_usuarios_detallesLayoutGrid7">
		...
		<div id="courier_detallesLayoutGrid2">
			<div class="row">
				...
				<div class="col-2">
				  ...
				  <select name="codestudio" size="1" id="codestudio" onChange="xajax_TraeSector(xajax.getFormValues('formu'));">
                        <option value=""></option>
                        <?php
	...
	<div id="wb_turnos_detallesLayoutGrid1">
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine3">
					<input type="text" name="nomsector" id="nomsector" value="<?php echo $nomsector; ?>" readonly style="background-color: #DCDCDC">
  ...
  <div id="wb_turnos_detallesLayoutGrid2">
			...
			<div class="row">
				<div class="col-1">
					<div id="wb_turnos_detallesText2">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>RESULTADOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br></strong></span>
					</div>
				</div>
			</div>
		</div>
	...
	<br>
	<div id="wb_resultados_detallesLayoutGrid5">
	  <div id="resultados_detallesLayoutGrid5">
		<div class="row">
		  <div class="col-1">
		    <input type="button" id="resultados_detallesButton1" name="validar" value="Validar" onClick="xajax_Validar(xajax.getFormValues(formu));">
		  </div>
		  <div class="col-2">
			<div id="wb_resultados_detallesText4"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Usuario que valida: </strong></span> </div>
			<input type="text" id="codusu1" name="codusu1" value="<?php echo $codusu1; ?>" readonly spellcheck="false">
		  </div>
		  <div class="col-3">
			<div id="wb_resultados_detallesText7"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Fecha&nbsp; validaci&oacute;n: </strong></span> </div>
			<input type="text" id="fechaval" name="fechaval" value="<?php echo $fechaval; ?>" readonly spellcheck="false">
		  </div>
		  <div class="col-4">
			<div id="wb_resultados_detallesText6"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Hora&nbsp; validaci&oacute;n: </strong></span> </div>
			<input type="text" id="horaval" name="horaval" value="<?php echo $horaval; ?>" readonly spellcheck="false">
		  </div>
		</div>
	  </div>
	</div>
	...
	<div id="wb_resultados_detallesLayoutGrid5">
	  <div id="resultados_detallesLayoutGrid5">
		<div class="row">
		  <div class="col-1">
		    <input type="button" id="resultados_detallesButton1" name="Revalidar" value="Revalidar" onClick="xajax_ReValidar(xajax.getFormValues(formu));">
		  </div>
		  <div class="col-2">
			<div id="wb_resultados_detallesText4"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Usuario que revalida: </strong></span> </div>
			<input type="text" id="codusu2" name="codusu2" value="<?php echo $codusu2; ?>" readonly spellcheck="false">
		  </div>
		  <div class="col-3">
			<div id="wb_resultados_detallesText7"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Fecha&nbsp; revalidaci&oacute;n: </strong></span> </div>
			<input type="text" id="fechareval" name="fechareval" value="<?php echo $fechareval; ?>" readonly spellcheck="false">
		  </div>
		  <div class="col-4">
			<div id="wb_resultados_detallesText6"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Hora&nbsp; revalidaci&oacute;n: </strong></span> </div>
			<input type="text" id="horareval" name="horareval" value="<?php echo $horareval; ?>" readonly spellcheck="false">
		  </div>
		</div>
	  </div>
	</div>
	...
	<div id="wb_resultados_detallesLayoutGrid5">
	  <div id="resultados_detallesLayoutGrid5">
		<div class="row">
		  <div class="col-1">
		    <input type="button" id="resultados_detallesButton1" name="Anular" value="Anular" onClick="xajax_Anular(xajax.getFormValues(formu));">
		  </div>
		  <div class="col-2">
			<div id="wb_resultados_detallesText4"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Usuario que Anula: </strong></span> </div>
			<input type="text" id="codusu3" name="codusu3" value="<?php echo $codusu3; ?>" readonly spellcheck="false">
		  </div>
		  <div class="col-3">
			<div id="wb_resultados_detallesText7"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Fecha&nbsp; anulaci&oacute;n: </strong></span> </div>
			<input type="text" id="fechaanul" name="fechaanul" value="<?php echo $fechaanul; ?>" readonly spellcheck="false">
		  </div>
		  <div class="col-4">
			<div id="wb_resultados_detallesText6"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Hora&nbsp; anulaci&oacute;n: </strong></span> </div>
			<input type="text" id="horaanul" name="horaanul" value="<?php echo $horaanul; ?>" readonly spellcheck="false">
		  </div>
		</div>
	  </div>
	</div>
	<br>
	<div id="wb_resultados_detallesLayoutGrid8">
		<div id="resultados_detallesLayoutGrid8">
			<div class="row">
				<div class="col-1">
				  <input type="button" id="resultados_detallesButton1" name="validar" value="Recitaci&oacute;n" onClick="xajax_Recitar(xajax.getFormValues(formu));">
				</div>
				<div class="col-2"> </div>
				<div class="col-3"> </div>
				<div class="col-4"> </div>
	...
	<br>
	<div id="wb_resultados_detallesLayoutGrid9">
		  <div id="resultados_detallesLayoutGrid9">
			<div class="row">
			  <div class="col-1">
				<hr id="resultados_detallesLine22">
				<input type="button" id="resultados_detallesButton5" onclick="openResultado()" name="validar" value="Imprimir">
			  </div>
			  <div class="col-2">
				<div id="wb_resultados_detallesText14"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Usuario que Entrega: </strong></span> </div>
				<input type="text" id="codusu4" name="codusu4" value="<?php echo $codusu4; ?>" readonly spellcheck="false">
			  </div>
			  <div class="col-3">
				<div id="wb_resultados_detallesText15"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Fecha&nbsp; Entrega: </strong></span> </div>
				<input type="text" id="fechaent" name="fechaent" value="<?php echo $fechaent; ?>" readonly spellcheck="false">
			  </div>
			  <div class="col-4">
				<div id="wb_resultados_detallesText16"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Hora&nbsp; Entrega: </strong></span> </div>
				<input type="text" id="horaentre" name="horaentre" value="<?php echo $horaentre; ?>" readonly spellcheck="false">
			  </div>
			</div>
		  </div>
		</div>
		...
		<div id="wb_resultados_detallesLayoutGrid9">
		  <div id="resultados_detallesLayoutGrid9">
			<div class="row">
			  <div class="col-1">
				<hr id="resultados_detallesLine23">
				<input type="button" id="resultados_detallesButton5" name="validar" value="E-Mail" onClick="alert('Envia Email!')">
			  </div>
			  <div class="col-2">
				<div id="wb_resultados_detallesText17"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Usuario que Env&iacute;a: </strong></span> </div>
				<input type="text" id="codusu5" name="codusu5" value="<?php echo $codusu5; ?>" readonly spellcheck="false">
			  </div>
			  <div class="col-3">
				<div id="wb_resultados_detallesText18"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Fecha&nbsp; Env&iacute;o: </strong></span> </div>
				<input type="text" id="fechaenvio" name="fechaenvio" value="<?php echo $fechaenvio; ?>" readonly spellcheck="false">
			  </div>
			  <div class="col-4">
				<div id="wb_resultados_detallesText19"> <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Hora&nbsp; Env&iacute;o: </strong></span> </div>
				<input type="text" id="horaenvio" name="horaenvio" value="<?php echo $horaenvio; ?>" readonly spellcheck="false">
			  </div>
			</div>
		  </div>
		</div>
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='resultados.php';"> VOLVER </a>&nbsp;]</span>

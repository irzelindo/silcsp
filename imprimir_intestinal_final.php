...
$contenido = "http://silcsp.mspbs.gov.py/imprimir_intestinal_final_comprobante.php?nroeval=$nroeval&usuario=$usuario"; //Texto
	...
	<table align="center">
				<tbody>
					<tr>
							...
							<table width="900" border="0" align="center" cellspacing="0" cellpadding="3">
								  <thead style="display: table-header-group">
									...
									<tr style="font-size: 17px;">
									  <td width="196" style="padding-top: 12px;padding-left: 20px;"><b>Tipo Examen:</b></td>
									  <td colspan="2" style="padding-top: 12px;">CONTROL DE CALIDAD</td>
									  <td width="180" colspan="1"  style="padding-top: 12px;"><b>Sector: </b></td>
									  <td width="40" colspan="3"><?php echo $nomsector; ?></td>
									</tr>
									...
									<tr style="font-size: 17px;">
									  ...
									  <td colspan="2" style="padding-top: 12px;">100</td>
						...
						<tr>
							<td style="text-align: center; font-weight: bold; border-left: 3px solid; border-bottom: 3px solid;border-right: 3px solid; border-top: 3px solid;border-spacing: none;">Item</td>
			
						
							<td colspan="3" style="text-align: center; font-weight: bold; border-bottom: 3px solid; border-top: 3px solid;border-right: 3px solid;" >Respuesta</td>
							<td colspan="4" style="text-align: center; font-weight: bold; border-bottom: 3px solid; border-top: 3px solid;border-right: 3px solid;" >Resultado de Referencia</td>
						</tr>
						...
						{
								$idpregunta = $row1['reporte'];
							
								echo '<tr>
										  <td>'.$row1['reporte'].'</td>
								
										  <td style="text-align: lelf" colspan="3">'.$row1['respuestar'].'</td>

										  <td style="text-align: lelf" colspan="4">'.$row1['referencia'].'</td>
						...
						echo '<tr>
						  <td colspan="7" style="font-size: 16px;"><b>Recomendaciones para las buenas prácticas laboratoriales:</b> Es competencia del jefe del Laboratorio, responder de la garantía y control de calidad, que al recibir un resultado inaceptable tome las providencias necerias para eliminar las no conformidades.</td>
						</tr>';

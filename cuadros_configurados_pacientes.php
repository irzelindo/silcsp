...
#wb_cuadros_configurados_pacientesLayoutGrid1
{
   clear: both;
   position: relative;
   table-layout: fixed;
...
#cuadros_configurados_pacientesLayoutGrid1
{
   -webkit-box-sizing: border-box;
   -moz-box-sizing: border-box;
   box-sizing: border-box;
...
#cuadros_configurados_pacientesLayoutGrid1 .row
{
   margin-right: -15px;
   margin-left: -15px;
}
#cuadros_configurados_pacientesLayoutGrid1 .col-1, #cuadros_configurados_pacientesLayoutGrid1 .col-2
{
   -webkit-box-sizing: border-box;
   -moz-box-sizing: border-box;
   box-sizing: border-box;
...
#cuadros_configurados_pacientesLayoutGrid1 .col-1
{
   background-color: transparent;
   background-image: none;
   width: 33.33333333%;
...
#cuadros_configurados_pacientesLayoutGrid1 .col-2
{
   background-color: transparent;
   background-image: none;
   width: 66.66666667%;
...
#cuadros_configurados_pacientesLayoutGrid1:before,
#cuadros_configurados_pacientesLayoutGrid1:after,
#cuadros_configurados_pacientesLayoutGrid1 .row:before,
#cuadros_configurados_pacientesLayoutGrid1 .row:after
{
   display: table;
   content: " ";
}
...
#wb_cuadros_configurados_pacientesText1 
{
   background-color: transparent;
   background-image: none;
   border: 0px #000000 solid;
...
#wb_cuadros_configurados_pacientesText1 div
{
   text-align: left;
}
#cuadros_configurados_pacientesLine1
{
   color: #FFFFFF;
   background-color: #FFFFFF;
   border-width: 0;
...
#cuadros_configurados_pacientesLine2
{
   color: #FFFFFF;
   background-color: #FFFFFF;
   border-width: 0;
...
#cuadros_configurados_pacientesLine3
{
   color: #FFFFFF;
   background-color: #FFFFFF;
   border-width: 0;
...
#cuadros_configurados_pacientesLine4
{
   color: #FFFFFF;
   background-color: #FFFFFF;
   border-width: 0;
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>CUADROS CONFIGURADOS DE PACIENTES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<form name="formu" method="post" action="cuadros_configurados_pacientes2.php" target="_blank">
<div id="wb_LayoutGrid4">
	<div id="LayoutGrid4">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line4"/>
				<select name="codorigen" size="1" id="codorigen">
					<option value = ""></option>
                    <?php
    				$tabla_origen = pg_query($link,"select * from origenpaciente order by nomorigen");
    				while($row = pg_fetch_array($tabla_origen)) 
    				{
                         ?>
      			          <option value = "<?php echo $row['codorigen'];?> "> 
    			          <?php echo $row['nomorigen'];?></option>
                    <?php
    				}
			         ?>
				</select>
		...
		<div class="row">
			...
			<div class="col-2">
				...
				<select name="codservicio" size="1" id="codservicio">
					<option value = ""></option>
                    <?php
    				$tabla_entidad = pg_query($link,"select * from establecimientos order  by nomservicio");
    				while($row = pg_fetch_array($tabla_entidad)) 
    				{
                         ?>
      			          <option value = "<?php echo $row['codservicio'];?> "> 
    			          <?php echo $row['nomservicio'];?></option>
                    <?php
    				}
			      ?>
				</select>
	...
	<div id="LayoutGrid6">
		<div class="row">
			<div class="col-1">
				<hr id="Line7"/>
				<div id="wb_Text4">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Desde Fecha de registro: </strong></span>
				</div>
				<hr id="Line13"/>
			</div>
			<div class="col-2">
				<hr id="Line14"/>
				<input type="date" id="fecha1" name="desde" value="<?php echo $fecha1;?>" spellcheck="false"/>
				<hr id="Line15"/>
			</div>
		</div>
	</div>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line10"/>
				<div id="wb_Text5">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Hasta Fecha&nbsp; de registro: </strong></span>
				</div>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
				<hr id="Line12"/>
				<input type="date" id="fecha2" name="hasta" value="<?php echo $fecha2;?>" spellcheck="false"/>
				<hr id="Line16"/>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_empresas_detallesText3">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Departamento residencia: </strong></span>
				</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_empresas_detallesText4">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Distrito residencia: </strong></span>
				</div>
			...
			<div class="col-2">
				...
				<select name="coddist" size="1" id="coddist" onfocus="ComponerLista(window.document.formu.coddpto.value)">
            			...
            			while($depto = pg_fetch_array($tabla_dpto)) 
            			{
            		       if($depto["coddist"]==$coddist and $depto["coddpto"]==$coddpto)
                             {//Para que ponga predeterminado el que hay guardado
                             ?>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_estadistica_pacientesText1">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Seleccione Dato Fila: </strong></span>
				</div>
				<hr id="estadistica_pacientesLine2"/>
			</div>
			<div class="col-2">
				<hr id="estadistica_pacientesLine3"/>
				<select name="fila" size="1" id="fila">
					<option></option>
					<option value="001">MESES</option>
					<option value="002">SEMESTRES</option>
					<option value="003">ORIGEN DEL PACIENTE</option>
                    <option value="004">REGIONES SANITARIAS</option>
					<option value="005">DISTRITOS</option>
					<option value="999">SEXO</option>
				</select>
...
<div id="wb_cuadros_configurados_pacientesLayoutGrid1">
	<div id="cuadros_configurados_pacientesLayoutGrid1">
		<div class="row">
			<div class="col-1">
				<hr id="cuadros_configurados_pacientesLine1"/>
				<div id="wb_cuadros_configurados_pacientesText1">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Seleccione Dato Columna: </strong></span>
				</div>
				<hr id="cuadros_configurados_pacientesLine2"/>
			</div>
			<div class="col-2">
				<hr id="cuadros_configurados_pacientesLine3"/>
				<select name="columna" size="1" id="columna">
					<option></option>
					<option value="001">MESES</option>
					<option value="002">SEMESTRES</option>
					<option value="003">ORIGEN DEL PACIENTE</option>
				...
				<hr id="cuadros_configurados_pacientesLine4"/>
			</div>
		</div>
	</div>

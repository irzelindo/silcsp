...
function ValidarFormulario($form)
{
	...
	if ( $codorigen == "" && $codorigen1 == "") {
		...
		$respuesta->Assign( "codorigen", "style.backgroundColor", "white" );
	}
	...
	if ( $mensaje == "" ) {
		...
		$query = "select * from establecimientos where codservicio = '$codservder1'";
		...
		pg_query( $con, "INSERT INTO ordtrabajo(
            nordentra, codservicio, nropaciente, fecharec, horarec,
            fechasal, urgente, codorigen, codservder, codmedico, recitacion, retira, obs, codusu, codservrem, cod_dgvs, nom_servicio, laboratorio)
    VALUES ('$nordentra','$codservicio1', '$npaciente', '$fecharec', '$horarec',
            $fechasal, '$urgente', '$codorigen1', '$codservder1', '$codmedico', '$recitacion', '$retira', '$obs', '$codusu', '$codservicio1', '$coddgvs', '$nomservicio', '$laboratorio')" );

			pg_query($con, "UPDATE estrealizar er
                                    SET codorigen='$codorigen1', codmedico='$codmedico', codusu= '$codusu'
                                    WHERE er.nordentra = '$nordentra'");
		   ...
		   pg_query($con, "UPDATE paciente
			...
			$accion = "Orden: Inserta-Reg.: Nro. Orden: " . $codservicio1.$nordentra;
			$terminal = $_SERVER[ 'REMOTE_ADDR' ];
			$a = archdlog( $_SESSION[ 'codusu' ], $codopc, $fecha1, $hora, $accion, $terminal );
			// Fin grabacion de registro de auditoria

			$respuesta->redirect("modifica_ordenes.php?nordentra=$nordentra&codservicio=$codservicio1&mensage=2");
	...
	if ($mensaje == "")
	{
		if($numeroRegistros1 == 0)
		{
			...
			pg_query( $con, "INSERT INTO estrealizar(
				nroestudio, codservicio, nropaciente, fecha, hora, codestudio, estadoestu, nordentra, codtmuestra, fechatmues, horatmues, codusu, codservicior, codservact)
		VALUES ('$nroestudio', '$codservicio1', '$npaciente', '$fecharec', '$horarec', '$codestudio1', '1', '$nrordentra', '$codtmuestra', '$fecharec', '$horarec', '$codusu', '$codservicio1', '$codservicio1')" );
...
<head>
  ...
  <script src="js/bootstrap.min.js"></script>
	...
	<script>
		$( function () {
			...
			jQuery( "#listapacientes" ).jqGrid( {
				url: 'datospacientesestudios2.php?nordentra=999&codservicio=<?php echo $codservicio; ?>',
				datatype: 'json',
				mtype: 'GET',
				loadonce: true,
				height: 200,
		...
		$( function () {
			...
			jQuery( "#listamuestras" ).jqGrid( {
				url: 'datosmuestras.php?nordentra=999&codservicio=<?php echo $codservicio; ?>',
				datatype: 'json',
				mtype: 'GET',
				loadonce: true,
				height: 200,
	...
	<script language="JavaScript">
		...
		{
    		var nropaciente   = window.document.formu.npaciente.value;
		...
		function AgregarEstudio()
		{
			...
			window.open("nuevo_orden_estudios.php?nordentra="+nordentra+"&codservicio="+codservicio,'_self');
		}
		...
		function Ocultar()
		{
			...
			window.open("modifica_ordenes.php?nordentra="+nordentra+"&codservicio="+codservicio,'_self');
		}
					  ...
					  $.ajax({
						  ...
						  data:{ cedula:$('#cedula').val()}
							...
							else
							{
										...
										$("#coddgvs").val(respuesta.cod_dgvs);
		...
		<div id="pacientes_detallesLayoutGrid1">
			<div class="row">
			  <div class="col-3">
				...
				<div class="col-4">
					<input type="text" id="nrordentra" name="nrordentra" value="" style="font-size: 30px">
		...
		<div id="courier_detallesLayoutGrid2">
			<div class="row">
				...
				<div class="col-2">
					...
					<input type="text" name="codservder" id="codservder" list="listaentidad" onkeypress="return validarcar(event)" onChange="ListaEntidad()" >
			...
			<div class="row">
				<div class="col-1">
					<div id="wb_pacientes_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nro. Documento: </strong></span>
					</div>
				...
				<div class="col-2">
					...
					<input type="text" id="cedula" name="cedula" value="<?php echo $cedula; ?>" spellcheck="false" onchange="buscador()" style="background-color: white;">
			...
			<div class="row">
				...
				<div class="col-3">
					<div id="wb_pacientes_detallesText4">
						<span style="color:#696969;font-family:Verdana;font-size:16px;"><strong>N&uacute;mero de Paciente:</strong></span>
					</div>
		...
		<div class="row"><br>
		  <div class="col-2">
			...
			<table id="usuarios_areasTable1">
			  <tr>
				<td class="cell0"><div id="wb_usuarios_areasCheckbox3">
					<input type="checkbox" id="recitacion" name="recitacion" value="1" <?php if ($recitacion == 1){ echo  "checked";}?>>
				...
				<td class="cell0"><div id="wb_usuarios_areasCheckbox2">
					<input type="checkbox" id="retira" name="retira" value="1" <?php if ($retira == 1){ echo  "checked";}?>>

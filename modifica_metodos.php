...
$codmetodo  = $_GET["id"]; //Identificador del registro
$query = "select * from metodos where codmetodo = '$codmetodo'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nommetodo = $row["nommetodo"];
...
$accion="Accede a Metodos: ".$codmetodo."-".$nommetodo;
...
#nommetodo:focus, #textobase:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
function verificametodos()
{ 
     	if (window.document.formu.codmetodo.value == "" || window.document.formu.nommetodo.value == "") 
		    {
            if(window.document.formu.codmetodo.value == "")
              {
    		    window.document.formu.codmetodo.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codmetodo.style.backgroundColor='white';    
              } 

            if(window.document.formu.nommetodo.value == "")
              {
    		    window.document.formu.nommetodo.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nommetodo.style.backgroundColor='white';    
              }              
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR METODOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_metodos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codmetodo" id="codmetodo" size="10" maxlength="10" readonly="" value="<?php echo $codmetodo; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nommetodo" name="nommetodo" size="100" maxlength="100" value="<?php echo $nommetodo;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nommetodox" name="nommetodox" value="<?php echo $nommetodo;?>"/>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_436==2 || $v_436==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificametodos()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='metodos.php';"> VOLVER </a>&nbsp;]</span>

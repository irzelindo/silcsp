...
$codarancel  = $_GET["id"]; //Identificador del registro
$query = "select * from aranceles where codarancel = '$codarancel'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomarancel = $row["nomarancel"];
$monto = $row["monto"];
$tipo = $row["tipo"];
...
$accion="Accede a Aranceles: ".$codarancel."-".$nomarancel;
...
function verificaaranceles()
{ 
     	if (window.document.formu.codarancel.value == "" || window.document.formu.nomarancel.value == "" || window.document.formu.monto.value == ""  || (window.document.formu.tipo[0].checked == false && window.document.formu.tipo[1].checked == false)) 
		    {
            if(window.document.formu.codarancel.value == "")
              {
    		    window.document.formu.codarancel.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codarancel.style.backgroundColor='white';    
              } 

            if(window.document.formu.nomarancel.value == "")
              {
    		    window.document.formu.nomarancel.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomarancel.style.backgroundColor='white';    
              }
            if(window.document.formu.monto.value == "")
              {
    		    window.document.formu.monto.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.monto.style.backgroundColor='white';    
              }               
            
            if(window.document.formu.tipo[0].checked == false && window.document.formu.tipo[1].checked == false)
              {
                document.getElementById('eltipo').style.backgroundColor='yellow';   
              }
            else
              {
                document.getElementById('eltipo').style.backgroundColor='white';  
              } 
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR ARANCELES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_aranceles.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codarancel" id="codarancel" size="10" maxlength="10" readonly="" value="<?php echo $codarancel; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomarancel" name="nomarancel" size="100" maxlength="150" value="<?php echo $nomarancel;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomarancelx" name="nomarancelx" value="<?php echo $nomarancel;?>"/>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Monto: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="monto" name="monto" size="10" maxlength="10" value="<?php echo $monto;?>" onkeypress="return validarnum(event)"  spellcheck="false"/>
    				...
    				<tr>
    					<td class="cell0">
    						<div id="wb_RadioButton1">
    							<input type="radio" id="RadioButton1" name="tipo" value="1" <?php echo $chequeot1;?>/><label for="RadioButton1"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text5">
    							<span style="color:#808080;font-family:Arial;font-size:13px;"> 1-Control</span>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_RadioButton2">
    							<input type="radio" id="RadioButton2" name="tipo" value="2" <?php echo $chequeot2;?>/><label for="RadioButton2"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text6">
    							<span style="color:#808080;font-family:Arial;font-size:13px;"> 2- Despacho</span>
    						</div>
    					</td>
    				</tr>
    				</table>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_442==2 || $v_442==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaaranceles()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='aranceles.php';"> VOLVER </a>&nbsp;]</span>

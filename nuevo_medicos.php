...
if($indica == 1)
{
	$volver = "window.location.href='medicos_orden.php?indica=$indica';";
}
else
{
	$volver = "window.location.href='medicos.php';";
}

if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $codmedico    = $_SESSION['codmedico'];
  $nomyapex    = $_SESSION['nomyapex'];
  $tipoprof    = $_SESSION['tipoprof'];
...
<form name="formu" method="post" action="insertar_medicos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<input type="hidden" name="indica" value="<?php echo $indica; ?>">
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codmedico" id="codmedico" size="10" maxlength="10" value="<?php echo $codmedico; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nombre: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<button type="button" class="btn btn-primary" onclick="verificamedicos()">Guardar Datos</button>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

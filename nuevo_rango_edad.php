...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $cgrupoedad    = $_SESSION['cgrupoedad'];
  $ngrupoedad    = $_SESSION['ngrupoedad'];  
  }
else
  {
  $cgrupoedad     = "";
...
{ 
     	if (window.document.formu.cgrupoedad.value == "" || window.document.formu.ngrupoedad.value == "") 
		    {
            if(window.document.formu.cgrupoedad.value == "")
              {
    		    window.document.formu.cgrupoedad.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.cgrupoedad.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_rango_edad.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="cgrupoedad" id="cgrupoedad" size="10" maxlength="10" value="<?php echo $cgrupoedad; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="ngrupoedad" name="ngrupoedad" size="100" maxlength="200" value="<?php echo $ngrupoedad;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificatiporangoedad()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

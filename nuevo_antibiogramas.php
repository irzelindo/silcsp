...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $codantibiogr    = $_SESSION['codantibiogr'];
  $nomantibiogr    = $_SESSION['nomantibiogr'];  
  }
else
  {
  $codantibiogr     = "";
...
{ 
     	if (window.document.formu.codantibiogr.value == "" || window.document.formu.nomantibiogr.value == "") 
		    {
            if(window.document.formu.codantibiogr.value == "")
              {
    		    window.document.formu.codantibiogr.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codantibiogr.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_antibiogramas.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codantibiogr" id="codantibiogr" size="10" maxlength="10" value="<?php echo $codantibiogr; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaantibiogramas()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

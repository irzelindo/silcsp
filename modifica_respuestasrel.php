...
$codresultado  = $_GET["codresultado"]; //Identificador del registro

$_SESSION['coddetermina']=$coddetermina;
$_SESSION['codresultado']=$codresultado;
...
$query2 = "select * from resultadoposiblemaster where coddetermina = '$coddetermina' and codresultado='$codresultado'";
...
#nomdetermina, #codresultado, #edadmin, #edadmax, #tipoedad, #inirango, #finrango, #codresultado1, #codresultado2, #codresultado3
{
   border: 1px #CCCCCC solid;
   border-radius: 4px;
   background-color: #FFFFFF;
...
#nomdetermina:focus, #codresultado:focus, #edadmin:focus, #edadmax:focus, #tipoedad:focus, #inirango:focus, #finrango:focus, #codresultado1:focus, #codresultado2:focus, #codresultado3:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
{ 
if (window.document.formu.codresultado.value == "") 
    {
    if(window.document.formu.codresultado.value == "")
      {
	    window.document.formu.codresultado.style.backgroundColor='yellow';    
      }
    else
      {
	    window.document.formu.codresultado.style.backgroundColor='white';    
      }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR RESPUESTAS DE DETERMINACIONES</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_respuestasrel.php">
    	...
    	<div id="LayoutGrid5">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line6"/>
    				<div id="wb_Text3">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Respuesta Posible: </strong></span>
    				</div>
    			</div>
    			<div class="col-2">
    				<hr id="Line1"/>
                    ...
                    <input type="hidden" name="codresultadox" id="codresultadox" value="<?php echo $codresultado?>"/>
    				<hr id="Line8"/>
    			</div>
    		</div>
    	</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_determinaciones.php?id=<?php echo $coddetermina; ?>#grilla2';"> VOLVER </a>&nbsp;]</span>

...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $codplatilla    = $_SESSION['codplatilla'];
  $nomplatilla    = $_SESSION['nomplatilla'];  
  }
else
  {
  $codplatilla     = "";
...
{ 
     	if (window.document.formu.codplatilla.value == "" || window.document.formu.nomplatilla.value == "") 
		    {
            if(window.document.formu.codplatilla.value == "")
              {
    		    window.document.formu.codplatilla.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codplatilla.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_plantillas_plan_trabajo.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codplatilla" id="codplatilla" size="10" maxlength="10" value="<?php echo $codplatilla; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaplantillaplan()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  ...
  $nomestudio    = $_SESSION['nomestudio'];  

  $codexterno    = $_SESSION['codexterno'];  
  $abreviatura   = $_SESSION['abreviatura'];  
  $dias          = $_SESSION['dias'];  
  $codsector     = $_SESSION['codsector'];  
  $codtmuestra   = $_SESSION['codtmuestra'];  
  $cantetiq      = $_SESSION['cantetiq'];  
  $factor        = $_SESSION['factor'];  
  $microbiologia = $_SESSION['microbiologia'];  
  $codestudiobio = $_SESSION['codestudiobio'];  
  $estado        = $_SESSION['estado'];  
  $enviarec      = $_SESSION['enviarec'];  
  $codmetodo     = $_SESSION['codmetodo'];  
  $obs           = $_SESSION['obs'];  
...
<form name="formu" method="post" action="insertar_estudios.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codestudio" id="codestudio" size="10" maxlength="10" value="<?php echo $codestudio; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaestudios()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

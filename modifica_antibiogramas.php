...
$codantibiogr  = $_GET["id"]; //Identificador del registro
$_SESSION['codantibiogr']=$codantibiogr;

$query = "select * from antibiogramas where codantibiogr = '$codantibiogr'";
$result = pg_query($link,$query);

$row = pg_fetch_assoc($result);

$nomantibiogr = $row["nomantibiogr"];
...
$accion="Accede a Antibiogramas: ".$codantibiogr."-".$nomantibiogr;
...
$(function() {
    ...
    jQuery("#listaantibioticos").jqGrid({
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Descripci&oacute;n','Abreviatura'],
        colModel:[
                ...
                {name:'codantibiot',index:'codantibiot', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomantibiot',index: "nomantibiot", width: 477, editable: true, searchoptions: {attr: {maxlength: 100,size: 100,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},               
                {name:'abreviatura',index: "abreviatura", width: 277, editable: true, searchoptions: {attr: {maxlength: 50,size: 50,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}               
                 ],                                 
                caption: "ANTIBIOTICOS RALACIONADOS",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],
...
//	jQuery("#listaantibioticos").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaantibioticos").jqGrid('setFrozenColumns');

    jQuery("#listaantibioticos").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_antibioticosrel.php?codantibiogr=" + cod1 + "&codantibiot=" + cod2 ;
			  } 
			  else 
			  {
...
function verificaantibiogramas()
{ 
     	if (window.document.formu.nomantibiogr.value == "") 
		    {
  
            if(window.document.formu.nomantibiogr.value == "")
              {
    		    window.document.formu.nomantibiogr.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomantibiogr.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR ANTIBIOGRAMAS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_antibiogramas.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codantibiogr" id="codantibiogr" size="10" maxlength="10" readonly="" value="<?php echo $codantibiogr; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomantibiogr" name="nomantibiogr" size="100" maxlength="100" value="<?php echo $nomantibiogr;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomantibiogrx" name="nomantibiogrx" value="<?php echo $nomantibiogr;?>"/>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4315==2 || $v_4315==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaantibiogramas()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='antibiogramas.php';"> VOLVER </a>&nbsp;]</span>
	...
	<div id="sintomas_detallesLayoutGrid1">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_4315==2 || $v_4315==3) 
            {
             echo '<input type="submit" id="Button1b" onclick="window.location.href=\'nuevo_antibioticosrel.php?codantibiogr='.$codantibiogr.'\';" name="agregar" value="Agregar">';
            }
         ?> 
         <br />&nbsp;       
	</div>        
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codantibiogr.style.backgroundColor='yellow';

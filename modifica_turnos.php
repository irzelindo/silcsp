...
$dia  = substr($fechatur,0,2);
$mes  = substr($fechatur,3,2);
$anio = substr($fechatur,6,4);
...
$fechaactual  = mktime(0,0,0,$mesc,$diac,$anioc);

$fechatur1    = mktime(0,0,0,$mes,$dia,$anio);
...
function ValidarFormulario($form) {
	...
	if ($nrotur == "") {
		$mensaje .= '- Rellene el campo Nro. de Turno!\n';

		$respuesta->Assign( "nrotur", "style.backgroundColor", "yellow" );

	} else {
		$respuesta->Assign( "nrotur", "style.backgroundColor", "white" );
	}
	...
	if ( $mensaje == "" ) {
		...
		pg_query($con, "UPDATE estrealizar
										SET codarea='$codarea1', fechatmues='$fecharec', horatmues='$horarec'
										WHERE nroturno = '$nrotur' and codservicio = '$codservicio1'");
		...
		$accion = "Turnos: Modificar-Reg.: Nro. Turno: " . $nrotur;
	...
	<script>
		$( function () {
			...
			jQuery( "#listapacientes" ).jqGrid( {
				url: 'datospacientesestudios.php?nroturno=<?php echo $nroturno; ?>&codservicio=<?php echo $codservicio; ?>',
				datatype: 'json',
				mtype: 'GET',
				loadonce: true,
				height: 200,
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				...
				<div class="col-2">
					...
					<select name="codarea" size="1" id="codarea" <?php if($codarea != ''){echo "disabled";}?> style="<?php if($codarea != ''){echo "background-color: #DCDCDC";}?>">
                        <?php if($codarea != '')
                              {
		...
		<div id="courier_detallesLayoutGrid2">
			<div class="row">
				...
				<div class="col-2">
					...
					<select name="codturno" size="1" id="codturno" <?php if($codturno != ''){echo "disabled";}?> style="<?php if($codturno != ''){echo "background-color: #DCDCDC";}?>">
                        <?php if($codturno != '')
                              {

...
$(function() {
    ...
    jQuery("#listacourier").jqGrid({
        url:'datoscourier.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Nombre de la Empresa'],
        colModel:[
                ...
                {name:'codcourier',index:'codcourier', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomcourier',index: "nomcourier", width: 750, editable: true, searchoptions: {attr: {maxlength: 200,size: 100,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}               
                 ],
                                  
                caption: "EMPRESAS DE COURIER",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],
	...
	grid = $("#listacourier");							
//	jQuery("#listacourier").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listacourier").jqGrid('setFrozenColumns');

    jQuery("#listacourier").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_courier.php?id=" + cod ;
			  } 
			  else 
			  {
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_4111==2 || $v_4111==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_courier.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_courier.php\';" name="agregar" value="Agregar">';

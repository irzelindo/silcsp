...
@Header("Content-type: text/html; charset=utf-8");
   ...
   $sql1 = "select * from homebanking where codbco = '$id'";
   ...
   if($numeroRegistros<=0)
      {
      $resultado1=pg_query($con,"DELETE FROM bancos WHERE codbco = '$id'"); 
      ...
      if($resultado1==true)
           {
              ...
              $accion="Bancos: Elimina-Reg.: ".$id;
              $terminal = $_SERVER['REMOTE_ADDR'];
              $a=archdlog($codusu,$codopc,$fecha,$hora,$accion,$terminal);
              
              // Fin grabacion de registro de auditoria
              header("Location: bancos.php?mensage=1");	
           }
    	else
    	  {
      ...
      {		
      header("Location: bancos.php?mensage=4"); //no se puede borrar
      }
?>

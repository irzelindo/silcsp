				...
				<tbody>
					<tr>
						...
						<tr>
                            ...
                            <td width="164" style="text-align: center; font-weight: bold; border-bottom: 3px solid; border-top: 3px solid;border-spacing: none;">Determinaci&oacute;n del Laboratorio</td>
                            <td width="140" style="text-align: center; font-weight: bold; border-bottom: 3px solid; border-top: 3px solid;" >Determinaci&oacute;n de Referencia</td>
						...
						echo '<tr>
						  <td colspan="5" style="font-size: 12px;"><b>Recomendaciones para las buenas prácticas laboratoriales:</b> Es competencia del jefe del Laboratorio, responder de la garantía y control de calidad, que al recibir un resultado inaceptable tome las providencias necerias para eliminar las no conformidades.</td>
						</tr>';

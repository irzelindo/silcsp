...
function activararancel()
{
    if(window.document.formu.tipo.value==3)
    {
        window.document.formu.codarancel.disabled=true;
        window.document.formu.codarancel.style.backgroundColor = "#CCCCCC";   
    }
    else
    {
        window.document.formu.codarancel.disabled=false;
        window.document.formu.codarancel.style.backgroundColor = "#FFFFFF";
    }
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>REPORTE DE HOMEBANKING</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<form name="formu" method="post" action="reporte_homebanking2.php" target="_blank">
		...
		<div class="row">
			...
			<div class="col-2">
				...
				<select name="codempresa" size="1" id="codempresa">
                    ...
                    <?php
    				$tabla_empresas = pg_query($link,"select * from empresas order by razonsocial");
    				while($row = pg_fetch_array($tabla_empresas)) 
    				{
                         ?>
      			          <option value = "<?php echo $row['codempresa'];?> "> 
	...
	<div id="LayoutGrid4">
		<div class="row">
			<div class="col-1">
				<hr id="Line2"/>
				<div id="wb_Text2">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Caja: </strong></span>
				</div>
				<hr id="Line3"/>
			</div>
			<div class="col-2">
				...
				<select name="codcaja" size="1" id="codcaja"<?php if($codcaja !='' ){ echo 'disabled';} ?> style="<?php if($codcaja != ''){echo "background-color: #DCDCDC";}?>">
					<option value = "TODAS">TODAS</option>
                    <?php
    				$tabla_cajas = pg_query($link,"select * from cajas order by nomcaja");
    				while($rowcajas = pg_fetch_array($tabla_cajas)) 
    				{
                         if($rowcajas['codcaja'] == $codcaja)
                            {
                                echo "<option value = ".$rowcajas['codcaja']." selected>".$rowcajas['nomcaja']."</option>"; 
                            }
                            else
                            {
                                echo "<option value = ".$rowcajas['codcaja'].">".$rowcajas['nomcaja']."</option>";
                            }
    				}
			     ?>
				</select>
	...
	<div id="LayoutGrid6">
		<div class="row">
			<div class="col-1">
				<hr id="Line7"/>
				<div id="wb_Text4">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Desde Fecha: </strong></span>
				</div>
				<hr id="Line13"/>
			</div>
			<div class="col-2">
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line10"/>
				<div id="wb_Text5">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Hasta Fecha: </strong></span>
				</div>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
	...
	<div id="LayoutGrid5">
		<div class="row">
			<div class="col-1">
				<hr id="Line6"/>
				<div id="wb_Text3">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Formato de Reporte: <br/>
					</strong></span>
				</div>
			</div>
			<div class="col-2">
				...
				<tr>
                    <td class="cell0">
						<div id="wb_RadioButton3">
							<input type="radio" id="general" name="tipo" value="3" checked="true" <?php if($tipo == 3){ echo  "checked";}?> onchange="activararancel()"/><label for="general"></label>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_page1Text3">
							<span style="color:#808080;font-family:Arial;font-size:13px;"> General</span>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_RadioButton1">
							<input type="radio" id="detallado" name="tipo" value="1"<?php if($tipo == 1){ echo  "checked";}?> onchange="activararancel()"/><label for="detallado"></label>
						</div>
					</td>
					<td class="cell0">
						<div id="wb_page1Text1">
							<span style="color:#808080;font-family:Arial;font-size:13px;"> Detallado</span>
						</div>
					</td>
	...
	<div id="LayoutGrid4">
		<div class="row">
			<div class="col-1">
				<hr id="Line2"/>
				<div id="wb_Text2">
					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Arancel: </strong></span>
				</div>
				<hr id="Line3"/>
			</div>
			<div class="col-2">
				<hr id="Line4"/>
				<select name="codarancel" size="1" id="codarancel"  disabled="true" style="background-color: #CCCCCC;">
                <option value = "TODAS">TODAS</option>
                    <?php
    				$tabla_arancel = pg_query($link,"select * from aranceles order by nomarancel");
    				while($row = pg_fetch_array($tabla_arancel)) 
    				{
                         ?>
      			          <option value = "<?php echo $row['codarancel'];?> "> 
    			          <?php echo $row['nomarancel'];?></option>
                    <?php
    				}
			     ?>
				</select>

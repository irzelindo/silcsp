...
@Header("Content-type: text/html; charset=utf-8");
   ...
   $sql1 = "select * from recibos where codarancel = '$id'";
   ...
   if($numeroRegistros<=0)
      {
      $resultado1=pg_query($con,"DELETE FROM aranceles WHERE codarancel = '$id'"); 
      ...
      if($resultado1==true)
           {
              ...
              $accion="Aranceles: Elimina-Reg.: ".$id;
              $terminal = $_SERVER['REMOTE_ADDR'];
              $a=archdlog($codusu,$codopc,$fecha,$hora,$accion,$terminal);
              
              // Fin grabacion de registro de auditoria
              header("Location: aranceles.php?mensage=1");	
           }
    	else
    	  {
      ...
      {		
      header("Location: aranceles.php?mensage=4"); //no se puede borrar
      }
?>

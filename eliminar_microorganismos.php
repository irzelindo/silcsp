...
@Header("Content-type: text/html; charset=utf-8");
   ...
   $sql1 = "select * from resultadomicroorganismo where codmicroorg = '$id'";
   ...
   if($numeroRegistros<=0)
      {
      $resultado1=pg_query($con,"DELETE FROM microorganismos WHERE codmicroorg = '$id'"); 
      ...
      if($resultado1==true)
           {
              ...
              $accion="Microorganismos: Elimina-Reg.: ".$id;
              $terminal = $_SERVER['REMOTE_ADDR'];
              $a=archdlog($codusu,$codopc,$fecha,$hora,$accion,$terminal);
              
              // Fin grabacion de registro de auditoria
              header("Location: microorganismos.php?mensage=1");	
           }
    	else
    	  {
      ...
      {		
      header("Location: microorganismos.php?mensage=4"); //no se puede borrar
      }
?>

	...
	<script>
		$(function() {
			...
			jQuery("#listapacientes").jqGrid({
				url:'datosintestinal.php?nroeval=<?php echo $nroeval; ?>&mes=<?php echo $mes; ?>&anio=<?php echo $anio; ?>&usuario=<?php echo $usuario; ?>',
				datatype: 'json',
				mtype: 'GET',
				loadonce:true,
				height: 330,
		...
		function gridReload() {
			...
			jQuery( "#listapacientes" ).jqGrid( 'setGridParam', {
				url: "datosintestinal.php?nroeval=" + nroeval + "&mes=" + mes + "&anio=" + anio + "&usuario=" + usuario,
				datatype: 'json'
			} ).trigger( "reloadGrid" );
		}
		...
		{
			window.location = 'evaluacion_intestinal.php?nroeval='+nroeval+'&usuario='+codusu;
			
		}
		
		function abrirVentana1(nroeval, codusu)
		{
			window.location = 'imprimir_intestinal_final.php?nroeval='+nroeval+'&codusu='+codusu;

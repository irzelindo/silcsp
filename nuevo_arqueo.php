			  ...
			  <div class="col-3">
				  <hr id="turnos_detallesLine7">
					<?php
						if ($v_154==2 || $v_154==3) 
						{
						 echo '<input type="button" id="turnos_detallesButton3" onclick="openImprimnir()" name="hcli" value="Imprimir Recibo">';
						}
					?>
			  </div>
		  </div>
		...
		<div id="turnos_detallesLayoutGrid4">
			<div class="row">
				<div class="col-1">
					...
					<button type="button" class="btn btn-primary btn-lg" onclick="xajax_ValidarFormulario(xajax.getFormValues('formu'));">Guardar Datos</button>

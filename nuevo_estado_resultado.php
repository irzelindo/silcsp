...
{ 
     	if (window.document.formu.codestado.value == "" || window.document.formu.nomestado.value == "") 
		    {
            if(window.document.formu.codestado.value == "")
              {
    		    window.document.formu.codestado.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codestado.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_estado_resultado.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codestado" id="codestado" size="5" maxlength="5" value="<?php echo $codestado; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaestadoresultado()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

...
@Header("Content-type: text/html; charset=utf-8");
   ...
   $sql1 = "select * from estudios where codestudiobio = '$id'";
   ...
   if($numeroRegistros<=0)
      {
      $resultado1=pg_query($con,"DELETE FROM emicrobiologia WHERE codestudiobio = '$id'"); 
      ...
      if($resultado1==true)
           {
              ...
              $accion="Estudios Microbiologia: Elimina-Reg.: ".$id;
              $terminal = $_SERVER['REMOTE_ADDR'];
              $a=archdlog($codusu,$codopc,$fecha,$hora,$accion,$terminal);
              
              // Fin grabacion de registro de auditoria
              header("Location: estudiosmicro.php?mensage=1");	
           }
    	else
    	  {
      ...
      {		
      header("Location: estudiosmicro.php?mensage=4"); //no se puede borrar
      }
?>

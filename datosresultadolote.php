...
// Se crea la conexi�n a la base de datos
  ...
  if($codsector != '')
    ...
    $sql1 = "select distinct d.grupo,
		...
		and   e.codestudio  = es.codestudio
		and   d.nordentra   = e.nordentra
		and   e.estadoestu  = '5' ".$w." order by t.nordentra";
	...
	while ($row = pg_fetch_array($res1))
	{
        ...
        $nomservicio=$registro3['nomservicio'];
		    ...
		    $respuesta->rows[$i]['cell'] = array($row['grupo'],$row['nordentra'],$row['nomestudio'],$row['nomyape'],$nomtmuestra,$nomservicio,$nropaciente, $codservicio, $nromuestra1,$row['codestudio'], $row['grupo'],$row['microbiologia']);

...
$query = "select * from resultadocodificado where codresultado = '$codresultado'";
...
$accion="Accede a Resultados Posibles: ".$codresultado."-".$nomresultado;
...
function verificaresultadocodificado()
{ 
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR RESULTADOS POSIBLES CODIFICADOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_resultado_codificado.php">
			...
			<div class="col-1">
				...
				<?php
	             if ($v_4317==2 || $v_4317==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaresultadocodificado()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='resultado_codificado.php';"> VOLVER </a>&nbsp;]</span>

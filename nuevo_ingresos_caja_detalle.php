...
function ValidarFormulario($form) {
	...
	if ( $npaciente == "" ) {
		...
		$respuesta->Assign( "npaciente", "style.backgroundColor", "" );
	}
	...
	nroingreso, nrorecibo, nroreciboser, fecha, hora, formapago, otrafp, estado, nomyape, nropaciente, codcaja, codusu, codservicio, observacion, idapertura)
	VALUES ('$nroingreso', '$nrorecibo', '$nroreciboser', '$fecha', '$hora', '$formapago', '$otrafp', '1', '$nomyape', '$npaciente', '$codcaja1', '$codusu', '$codservicio1', '$observacion', '$idapertura')");
			...
			$respuesta->redirect("modifica_ingresos_caja_detalle.php?nroingreso=$nroingreso&mensage=2");

			
		} else {
			pg_query( $con, "UPDATE ingresocaja
							SET nrorecibo='$nrorecibo', nroreciboser='$nroreciboser', fecha='$fecha', hora='$hora', formapago='$formapago', otrafp='$otrafp', nomyape='$nomyape', nropaciente='$nropaciente', codcaja='$codcaja1', codusu='$codusu', codservicio='$codservicio1', observacion='$observacion', idapertura='$idapertura'
...
function RecuperarDatos($form) {
	...
	$sql = "select * from empresas where codempresa = '$npaciente'";
	...
	if ( $countlc != 0 ) 
	{
		...
		$respuesta->Assign( "nomyape", "value", $razonsocial);	
			
	} 
	else 
	{
		$respuesta->Assign( "nomyape", "value", "");
		
		$respuesta->script('swal("No existe Codigo de Empresa Introducida !", "", "warning")');
	}
	return $respuesta;
}
...
<head>
	...
	<script>
		$( function () {
			...
			jQuery( "#listaconceptos" ).jqGrid( {
				url: 'datosarancelescaja.php?nroingreso=999999&nrorecibo=<?php echo $nrorecibo; ?>&nroreciboser=<?php echo $nroreciboser; ?>',
				datatype: 'json',
				mtype: 'GET',
				loadonce: true,
				height: 200,
	...
	<script language="JavaScript">
		...
		function openImprimir() 
		{
			...
			window.open("impresion_recibo.php?nroingreso="+nroingreso);
		}

...
$query1 = "select * from recibos where nroingreso = '$nroingreso' and nrorecibo = '$nrorecibo' and nroreciboser = '$nroreciboser' and norden = '$norden'";
$result1 = pg_query($link,$query1);

$row1 = pg_fetch_assoc($result1);

$codarancel  = $row1["codarancel"];
$monto       = $row1["monto"];
$exonerado   = $row1["exonerado"];
...
function ValidarFormulario($form) {
	...
	if ( $exonerado == "") {
		$mensaje .= '- Rellene el campo Exonerado!\n';

		$respuesta->Assign( "exonerado", "style.backgroundColor", "yellow" );

	} else {
		$respuesta->Assign( "exonerado", "style.backgroundColor", "white" );
	}

	if ( $mensaje == "" ) 
	{
		pg_query( $con, "UPDATE public.recibos
						SET codarancel='$codarancel', monto='$monto', exonerado='$exonerado'
						WHERE nroingreso = '$nroingreso' and nrorecibo = '$nrorecibo' and nroreciboser = '$nroreciboser' and norden = '$norden'");
		
		$respuesta->redirect("modifica_ingresos_caja_turno.php?nroingreso=$nroingreso&nroturno=$nroturno&codarea=$codarea&codturno=$codturno");
	...
	$accion = "Ingreso por Caja-Detalle: Modifica-Reg.: Nro. Ingreso: " . $nroingreso;
	...
	<script language="JavaScript">
		...
		{ 
			$.ajax({
						...
						type:'POST',
						dataType:'json',
						data:{codarancel:jQuery("#codarancel").val()}
	...
	<div id="usuarios_detallesLayoutGrid7">
			<div class="row">
				...
				<div class="col-2">
					...
					<input type="hidden" name="norden" id="norden" value="<?php echo $norden; ?>">
					<input type="hidden" name="nroturno" id="nroturno" value="<?php echo $nroturno; ?>">
					<input type="hidden" name="codarea" id="codarea" value="<?php echo $codarea; ?>">
					<input type="hidden" name="codturno" id="codturno" value="<?php echo $codturno; ?>">
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_turnos_detallesText4">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>N&uacute;mero de Ingreso: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="text" id="nroingreso" name="nroingreso" value="<?php echo $nroingreso; ?>" readonly>
...
<div id="wb_turnos_detallesLayoutGrid5">
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine14">
					<input type="date" id="fecha" name="fecha" value="<?php echo $fecha; ?>" style="background-color: #DCDCDC" readonly>
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
...
<div id="wb_turnos_detallesLayoutGrid5">
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				...
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="time" id="hora" name="hora" value="<?php echo $hora; ?>" style="background-color: #DCDCDC" readonly>
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
	  ...
	  <div id="turnos_detallesLayoutGrid5">
			<div class="row">
				<div class="col-1">
				  ...
				  <div id="wb_turnos_detallesText4">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Recibo Nro.: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="text" id="nrorecibo" name="nrorecibo" value="<?php echo $nrorecibo; ?>" onkeypress="return validarnum(event)" style="background-color: #DCDCDC" readonly>
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
		...
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine13">
					<div id="wb_turnos_detallesText4">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Serie Nro.: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="text" id="nroreciboser" name="nroreciboser" value="<?php echo $nroreciboser; ?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" style="background-color: #DCDCDC" readonly>
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Arancel: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
				  <select name="codarancel" size="1" id="codarancel" onChange="TraeMonto()">
                        <option value=""></option>
                        <?php
							$tabla_dpto = pg_query($link, "select * from aranceles order by codarancel");
							while($depto = pg_fetch_array($tabla_dpto)) 
							{
							   if($depto['codarancel'] == $codarancel)
							   {
								  echo "<option value = ".$depto['codarancel']." selected>".$depto['nomarancel']."</option>"; 


							   }
							   else
							   {
								   echo "<option value = ".$depto['codarancel'].">".$depto['nomarancel']."</option>";
							   }
							}
		...
		<div id="turnos_detallesLayoutGrid5">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine13">
					<div id="wb_turnos_detallesText4">
					  <span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Monto: <br></strong></span>
				  </div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine14">
				  <input type="text" id="monto" name="monto" value="<?php echo $monto; ?>" style="background-color: #DCDCDC; text-align: right" readonly>
					<hr id="turnos_detallesLine15">
				</div>
			</div>
		</div>
		...
		<div id="turnos_detallesLayoutGrid1">
			<div class="row">
				<div class="col-1">
					<hr id="turnos_detallesLine1">
					<div id="wb_turnos_detallesText1">
						<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Exonerado: <br></strong></span>
					</div>
				</div>
				<div class="col-2">
					<hr id="turnos_detallesLine3">
				  <select name="exonerado" size="1" id="exonerado">
                        <option value=""></option>
                        <option value="1" <?php if($exonerado == 1){ echo "selected";} ?>>SI</option>
						<option value="2" <?php if($exonerado == 2){ echo "selected";} ?>>NO</option>
    				</select>
				  <hr id="turnos_detallesLine2">
				</div>
			</div>
			...
			<div class="row">
				<div class="col-1">
					...
					<div id="wb_sintomas_detallesText1">
						<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='modifica_ingresos_caja_detalle.php?nroingreso=<?php echo $nroingreso; ?>&nroturno=<?php echo $nroturno;  ?>&codarea=<?php echo $codarea; ?>&codturno=<?php echo $codturno; ?>'"> VOLVER </a>&nbsp;]</span>

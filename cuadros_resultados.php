		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>REPORTE DE ESTADISTICAS DE RESULTADOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
		...
		<div class="row">
			...
			<div class="col-2">
				...
				<select name="empresas_detallesCombobox1" size="1" id="estadistica_pacientesCombobox1">
					<option></option>
					<option value="001">General periódico</option>
					<option value="002">Resultados de TB</option>
					<option>Resultados de Microbiología</option>
					<option>Mensual por estudio</option>
					<option>Estudios por equipo analizador</option>
					<option>Estdios por Establecimientos</option>
					<option>Estudiospor grupos de edades</option>
					<option>Baciloscopías Realizadas</option>
					<option>Cultivos realizados</option>
					<option>Gene Xpert Realizados</option>
					<option>Informes de Vigilancia</option>
					<option value="999">ETC ETC TEC</option>
				</select>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_reporte_bitacoraImage1">
					<a href="./cuadros_resultados2.html" target="_blank"><img src="images/navegador.png" id="reporte_bitacoraImage1" alt=""/></a>
				</div>
				<hr id="Line17"/>
				<hr id="Line18"/>
			</div>

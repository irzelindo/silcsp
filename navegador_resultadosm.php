...
<head>
	...
	<script>
		$( function () {
			...
			jQuery( "#listamuestras" ).jqGrid( {
				url: 'datosresultadosdetallem.php?nordentra=999&codservicio=000',
				datatype: 'json',
				mtype: 'GET',
				loadonce: true,
				height: 200,
	...
	<script language="JavaScript">
		...
		{ 
			...
			jQuery("#listamuestras").jqGrid('setGridParam',{url:"datosresultadosdetallem.php?nordentra="+nordentra+"&codservicio="+codservicio+"&codestudio="+codestudio,datatype:'json'}).trigger("reloadGrid");
		...
		function openResultado() 
		{
			...
			window.open("impresion_resultadosm.php?nordentra="+nordentra+"&codservicio="+codservicio+"&codestudio="+codestudio);
		}
	</script>

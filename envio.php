	...
	<script>
		...
		$(document).ready(function() {
			$("#Button10").click(function(){
				...
				window.location = "nuevo_envio.php?codservicio="+codservicio+"&codservicior="+codservicior;
			});
		});
	</script>
	...
	<script>
		$( function () {
			...
			jQuery( "#listapacientes" ).jqGrid( {
				url: 'datosagrupados.php?codservicioe=<?php echo $codservicioe; ?>&desde=<?php echo $desde; ?>&hasta=<?php echo $hasta; ?>',
				datatype: 'json',
				mtype: 'GET',
				loadonce: true,
				height: 330,
				...
				colNames: [ 'Imprimir', 'Nro. Agrupamiento', 'Estado'],
				colModel: [
					{name:'imprimir', width:60, resizable:false, align:"center", editable: false, editoptions:{maxlength:"50"}, search: false},

					{
						...
						searchoptions: {
							attr: {
								maxlength: 10,
								size: 7,
								style: "width:200px;padding:1;max-width:150%;height:3em;float:left"
							}
						}
					},
		...
		function gridReload() {
			...
			jQuery( "#listapacientes" ).jqGrid( 'setGridParam', {
				url: "datosagrupados.php?grupo=" + grupo + "&codservicioe=" + codservicioe + "&codservicior=" + codservicior + "&codcourier=" + codcourier + "&desde=" + desde + "&hasta=" + hasta,
				datatype: 'json'
			} ).trigger( "reloadGrid" );
		...
		<div id="wb_pacientesLayoutGrid1">
			<div id="pacientesLayoutGrid1">
				<div class="row">
					...
					<div class="col-2">
						<hr id="Line4">
						<input type="text" id="grupo" name="grupo" value="<?php echo $grupo; ?>"  spellcheck="false" autofocus onKeyUp="gridReload()">
						<hr id="Line5">
					</div>
				...
				<div class="row">
					<div id="page1Layer1_Container">
						...
						if ( $v_211 == 2 || $v_211 == 3 ) {
							...
							echo '<button type="button" class="btn btn-primary btn-lg" id="Button10">Agregar</button>';

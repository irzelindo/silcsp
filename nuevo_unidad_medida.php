...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $codumedida    = $_SESSION['codumedida'];
  $nomumedida    = $_SESSION['nomumedida'];  
  }
else
  {
  $codumedida     = "";
...
{ 
     	if (window.document.formu.codumedida.value == "" || window.document.formu.nomumedida.value == "") 
		    {
            if(window.document.formu.codumedida.value == "")
              {
    		    window.document.formu.codumedida.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codumedida.style.backgroundColor='white';    
              }  
...
<form name="formu" method="post" action="insertar_unidad_medida.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codumedida" id="codumedida" size="10" maxlength="10" value="<?php echo $codumedida; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificaunidadmedida()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

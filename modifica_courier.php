...
$codcourier  = $_GET["id"]; //Identificador del registro
$query = "select * from courier where codcourier = '$codcourier'";
...
$accion="Accede a Courier: ".$codcourier."-".$nomcourier;
...
#nomcourier, #director, #dccion, #telefono, #email
{
   border: 1px #CCCCCC solid;
   border-radius: 4px;
   background-color: #FFFFFF;
...
#nomcourier:focus, #director:focus, #dccion:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
#director,#dccion,#telefono ,#email 
{
   border: 1px #CCCCCC solid;
   border-radius: 4px;
   background-color: #FFFFFF;
...
#director:focus,#dccion:focus,#telefono:focus,#email:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
#courier_detallesEditbox3:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
#courier_detallesEditbox2:focus
{
   border-color: #66AFE9;
   -webkit-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
   -moz-box-shadow: inset 0px 1px 1px rgba(0,0,0,0.075), 0px 0px 8px rgba(102,175,233,0.60);
...
function verificacourier()
{ 
     	if (window.document.formu.codcourier.value == "" || window.document.formu.nomcourier.value == "") 
		    {
            if(window.document.formu.codcourier.value == "")
              {
    		    window.document.formu.codcourier.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codcourier.style.backgroundColor='white';    
              } 

            if(window.document.formu.nomcourier.value == "")
              {
    		    window.document.formu.nomcourier.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomcourier.style.backgroundColor='white';    
              }
              

           	 //entonces (no algo esta en blanco) devuelvo el valor cadena vacia 
           	 swal("","Los datos obligatorios no deben estar en blanco:\n - C\u00f3digo,\n - Nombre de la Empresa","warning"); 
			return false;
     	    }
         else
            {
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR EMPRESAS DE COURIER</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_courier.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codcourier" id="codcourier" size="10" maxlength="10" readonly="" value="<?php echo $codcourier; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nombre de la Empresa: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomcourier" name="nomcourier" size="100" maxlength="200" value="<?php echo $nomcourier;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomcourierx" name="nomcourierx" value="<?php echo $nomcourier;?>"/>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="director" name="director" size="100" maxlength="200" value="<?php echo $director;?>" onkeypress="return validarcar(event)"  spellcheck="false"/>
    	...
    	<div id="LayoutGrid6c">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="telefono" name="telefono" size="100" maxlength="100" value="<?php echo $telefono;?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6c">
    		<div class="row">
    			...
    			<div class="col-2">
                    ...
                    <input type="text" class="form-control" placeholder="" id="email" name="email" size="100" maxlength="200" value="<?php echo $email;?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    				...
    				<tr>
    					<td class="cell0">
    						<div id="wb_RadioButton1">
    							<input type="radio" id="RadioButton1" name="estado" value="1" <?php echo $chequeoe1;?>/><label for="RadioButton1"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text5">
    							<span style="color:#808080;font-family:Arial;font-size:13px;"> Habilitado</span>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_RadioButton2">
    							<input type="radio" id="RadioButton2" name="estado" value="2" <?php echo $chequeoe2;?>/><label for="RadioButton2"></label>
    						</div>
    					</td>
    					<td class="cell0">
    						<div id="wb_Text6">
    							<span style="color:#808080;font-family:Arial;font-size:13px;"> Inhabilitado</span>
    						</div>
    					</td>
    				</tr>
    				</table>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4111==2 || $v_4111==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificacourier()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='courier.php';"> VOLVER </a>&nbsp;]</span>

...
$(function() {
    ...
    jQuery("#listaprocesos").jqGrid({
        url:'datosprocesos.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Nombre del Proceso','Opci&oacute;n del Sistema'],
        colModel:[
                ...
                {name:'codproceso',index:'codproceso', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomproceso',index: "nomproceso", width: 377, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomopc',index: "nomopc", width: 377, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}                
                 ],
	...
	grid = $("#listaprocesos");							
//	jQuery("#listaprocesos").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaprocesos").jqGrid('setFrozenColumns');

    jQuery("#listaprocesos").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_procesos.php?id=" + cod ;
			  } 
			  else 
			  {
	...
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_415==2 || $v_415==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_procesos.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_procesos.php\';" name="agregar" value="Agregar">';

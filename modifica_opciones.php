...
$codopc  = $_GET["id"]; //Identificador del registro
$query = "select * from opciones where codopc = '$codopc'";
...
$accion="Accede a opciones: ".$codopc."-".$nomopc;
...
function verificaopciones()
{ 
     	if (window.document.formu.codopc.value == "" || window.document.formu.nomopc.value == "") 
		    {
            ...
            if(window.document.formu.nomopc.value == "")
              {
    		    window.document.formu.nomopc.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomopc.style.backgroundColor='white';    
              }  
 

           	 //entonces (no algo esta en blanco) devuelvo el valor cadena vacia 
           	 swal("","Los datos obligatorios no deben estar en blanco:\n - C\u00f3digo,\n - Opci\u00f3n del Sistema","warning"); 
			return false;
     	    }
         else
            {
...
{
   var anterior=window.document.formu.ayuda.value;
   window.document.formu.ayuda.value=''+anterior.trim();	
   window.document.formu.ayuda.focus();  
}
</script>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR OPCIONES DEL SISTEMA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_opciones.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codopc" id="codopc" size="10" maxlength="10" readonly="" value="<?php echo $codopc; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    	...
    	<div id="LayoutGrid6">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7"/>
    				<div id="wb_Text4">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Nombre de la Opci&oacute;n: </strong></span>
    				</div>
    				<hr id="Line13"/>
    			</div>
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" id="nomopc" name="nomopc" size="100" maxlength="200" readonly="" value="<?php echo $nomopc;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomopcx" name="nomopcx" value="<?php echo $nomopc;?>"/>
    	...
    	<div id="LayoutGrid6b">
    		<div class="row">
    			<div class="col-1">
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>Texto para la Ayuda: </strong></span>
    				</div>
    				<hr id="Line13b"/>
    			</div>
    			<div class="col-2">
                    ...
                    <textarea class="form-control" id="ayuda" name="ayuda" rows="3" cols="71" spellcheck="false" onfocus="poneralcomienzo();" ><?php echo $ayuda; ?></textarea>
		...
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_414==2 || $v_414==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaopciones()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='opciones.php';"> VOLVER </a>&nbsp;]</span>

...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  {
  $codbco    = $_SESSION['codbco'];
  $nombco    = $_SESSION['nombco'];  
  }
else
  {
  $codbco     = "";
...
{ 
     	if (window.document.formu.codbco.value == "" || window.document.formu.nombco.value == "") 
		    {
            if(window.document.formu.codbco.value == "")
              {
    		    window.document.formu.codbco.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.codbco.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>BANCOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="insertar_bancos.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codbco" id="codbco" size="10" maxlength="10" value="<?php echo $codbco; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificabancos()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

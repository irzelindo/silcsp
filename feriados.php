...
$(function() {
    ...
    jQuery("#listaferiados").jqGrid({
        url:'datosferiados.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','Fecha','Motivo','Tipo'],
        colModel:[
                ...
                {name:'fecha',index:'fecha', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'motivo',index: "motivo", width: 477, editable: true, searchoptions: {attr: {maxlength: 200,size: 100,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}} ,
	...
	grid = $("#listaferiados");							
//	jQuery("#listaferiados").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaferiados").jqGrid('setFrozenColumns');

    jQuery("#listaferiados").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_feriados.php?id=" + cod ;
			  } 
			  else 
			  {
      ...
      <div class="jqGrid">
    	...
    	<?php
         if ($v_4113==2 || $v_4113==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_feriados.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_feriados.php\';" name="agregar" value="Agregar">';

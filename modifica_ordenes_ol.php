...
$query = "select * from ordtrabajo where nordentra = '$nordentra'";
...
$query3 = "select * from establecimientos where codservicio = '$codservder2'";
...
function ValidarFormulario($form)
{
  ...
  $laboratorio = $_SESSION[ 'laboratorio' ];
	...
	$sql = "select * from ordtrabajo where nordentra = '$nrordentra' and codservicio = '$codservicio1'";
    ...
    $query = "select * from establecimientos where codservicio = '$codservder1'";
		...
		pg_query( $con, "UPDATE ordtrabajo
							   SET nropaciente='$npaciente', fecharec='$fecharec',
								   horarec='$horarec', fechasal=$fechasal, urgente='$urgente',
                   codorigen='$codorigen1', codservder='$codservder1', codmedico='$codmedico',
                   recitacion='$recitacion', retira='$retira', obs='$obs', codusu= '$codusu', cod_dgvs = '$coddgvs', nom_servicio = '$nomservicio', laboratorio = '$laboratorio'
...
function GenerarMuestra($form)
{
	...
	$query2 = "select * from ordtrabajo where nordentra = '$nrordentra' and codservicio = '$codservicio1'";
	...
	while ( $rowmuestra = pg_fetch_array( $resultmuestra ) )
	{
		...
		pg_query($con, "UPDATE estrealizar er
								...
								WHERE er.nordentra = '$nrordentra' and er.codservicio = '$codservicio1' and codestudio = '$codestudio' and codtmuestra = '$codtmuestra' and er.nromuestra is null");
	}
		...
		VALUES ('$nroestudio', '$codservicio1', '$npaciente', '$fecharec', '$horarec', '$codestudio1', '1', '$nrordentra', '$codtmuestra', '$fecharec', '$horarec', '$codusu', '$codservicio1', '$codservicio1', '$codorigen1')" );
            ...
            if($conresul == 0)
            {
				...
				if($condeter != 0)
				{
					...
					VALUES ('$nrordentra', '$codservicio1', '$nroestudio', 'XXX$nroorden', '$nroorden', '$codumedida', '$codsector', '$codestudio', '$coddetermina', '001', '$codmetodo', 0)" );
					}
				}

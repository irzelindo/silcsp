...
$codestado  = $_GET["id"]; //Identificador del registro
$query = "select * from estadoresultado where codestado = '$codestado'";
...
$accion="Accede a Estados de Resultados ".$codestado."-".$nomestado;
...
function verificaestadoresultado()
{ 
     	if (window.document.formu.nomestado.value == "") 
		    {
  
            if(window.document.formu.nomestado.value == "")
              {
    		    window.document.formu.nomestado.style.backgroundColor='yellow';    
              }
            else
              {
    		    window.document.formu.nomestado.style.backgroundColor='white';    
              }  
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>ACTUALIZAR ESTADOS DE RESULTADOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_estado_resultado.php">
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" style="background-color: #CCCCCC;" name="codestado" id="codestado" size="5" maxlength="5" readonly="" value="<?php echo $codestado; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid6">
    	<div id="LayoutGrid6">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line14"/>
                    <input type="text" class="form-control" placeholder="" id="nomestado" name="nomestado" size="100" maxlength="100" value="<?php echo $nomestado;?>" onkeypress="return validarcar(event)" onchange="conMayusculas(this)" spellcheck="false"/>
                    
                    <input type="hidden" id="nomestadox" name="nomestadox" value="<?php echo $nomestado;?>"/>
	...
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				...
				<?php
	             if ($v_4311==2 || $v_4311==3) 
	                {
				     echo '<input type="button" id="Button1" onclick="verificaestadoresultado()" name="guardar" value="Guardar Datos"/>';
	                }
	             ?>                
				<hr id="Line11"/>
			</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_sintomas_detallesText1">
					<span style="color:#FF0000;font-family:Arial;font-size:13px;">[&nbsp;<a href="#" onclick="window.location.href='estado_resultado.php';"> VOLVER </a>&nbsp;]</span>
...
if ($_GET["mensage2"]==1)
    {
	echo "<script type=''>
    window.document.formu.codestado.style.backgroundColor='yellow';

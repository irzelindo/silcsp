...
if($row["codservrem"] != "")
{
	$codservrem1 = $row["codservrem"];
	$codservrem  = $row['codservrem'];
}
else
{
	if($_GET['codservrem'] != '')
	{
		$codservrem = $_GET['codservrem'];
		$codservrem1= "";
		$_SESSION['codservrem'] = "";
	}
	else
	{
		$codservrem = $_SESSION['codservrem'];
	}
...
<script>
	$(document).ready(function(){
			...
			$("#reporte1").click(function(){
				...
				var codorigen   	= jQuery("#codorigen").val();
				var codservder  	= jQuery("#codservder").val();
				var hasta	    		= jQuery("#hasta").val();
				var desde  				= jQuery("#desde").val();

				window.open('reporte_resultado_general.php?codsector='+codsector+'&codestudio='+codestudio+'&codservicio='+codservicio+'&codorigen='+codorigen+'&codservder='+codservder+'&hasta='+hasta+'&desde='+desde, '_blank');
			...
			$("#reporte2").click(function(){
				...
				window.open('reporte_resultado_general_excel.php?codsector='+codsector+'&codestudio='+codestudio+'&codservicio='+codservicio+'&codorigen='+codorigen+'&codservder='+codservder+'&hasta='+hasta+'&desde='+desde, '_blank');
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>REPORTE DE LISTA DE RESULTADOS</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<div id="wb_LayoutGrid4">
	<div id="LayoutGrid4">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line4"/>
				<select name="Combobox1" size="1" id="Combobox1" <?php if($codservrem1 != ''){ echo 'disabled';} ?> style="<?php if($codservrem1 != ''){echo "background-color: #DCDCDC";}?>">
				<option value=""></option>
				<?php
					$tabla_dpto = pg_query($link, "select * from establecimientos order by codservicio");
					while($depto = pg_fetch_array($tabla_dpto))
					{
					   if($depto['codservicio'] == $codservrem)
					   {
...
<div id="wb_LayoutGrid6">
	<div id="LayoutGrid6">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line14"/>
				<input type="date" id="desde" name="desde" value="<?php echo $desde; ?>" spellcheck="false"/>
				<hr id="Line15"/>
			</div>
		</div>
	</div>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line12"/>
				<input type="date" id="hasta" name="hasta" value="<?php echo $hasta; ?>" spellcheck="false"/>
				<hr id="Line16"/>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_reporte_bitacoraImage1">
					<a href="#" id="reporte1"><img src="images/navegador.png" id="reporte_bitacoraImage1" alt=""/></a>
				</div>
				<hr id="Line17"/>
				<hr id="Line18"/>
			</div>
			<div class="col-2">
				...
				<div id="wb_reporte_bitacoraImage2">
					<a href="#" id="reporte2"><img src="images/planilla.png" id="reporte_bitacoraImage2" alt=""/></a>
				</div>
			</div>
		</div>
	</div>
...
<div id="wb_LayoutGrid9">
	<div id="LayoutGrid9">
		<div class="row">
			<div class="col-1">
				<div id="wb_Text8">
					<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">© 2018 Laboratorio Central de Salud Pública. Todos los derechos reservados.<br/>

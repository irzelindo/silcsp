...
if ($_GET['mensage']==1 || $_GET['mensage']==2 || $_GET['mensage']==3 || $_GET['mensage']==4 || $_GET['mensage']==5)
    ...
    $codigo_opc=$_SESSION['codigo_opc'];
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br />
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>VACIAR BITACORA DE AUDITORIA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><br />
					<br />
					</span>
				</div>
			</div>
...
<form name="formu" method="post" action="actualiza_bitacora.php">
...
<div id="wb_LayoutGrid4">
	<div id="LayoutGrid4">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line4"/>
				<select name="codigo_usu" size="1" id="codigo_usu">
					<option value = ""></option>
                  <?php
    				...
    				{
                         ?>
      			          <option value = "<?php echo $row['codusu'];?> "> 
    			          <?php echo $row['nomyape'];?></option>
                    <?php
    				}
    			  ?>
				</select>
...
<div id="wb_LayoutGrid5">
	<div id="LayoutGrid5">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line1"/>
				<select name="codigo_opc" size="1" id="codigo_opc">
                
					<option value = ""></option>
                  <?php
    				$tabla_opc = pg_query("select * from opciones order by codopc");
    				while($row = pg_fetch_array($tabla_opc)) 
    				{
                         ?>
      			          <option value = "<?php echo $row['codopc'];?> "> 
    			          <?php echo $row['nomopc'].' &nbsp;&nbsp;&nbsp;('.$row['codopc'].")";?></option>
                    <?php
    				}
    			  ?>
				</select>
...
<div id="wb_LayoutGrid6">
	<div id="LayoutGrid6">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line14"/>
				<input type="date" id="fecha1" name="fecha1" value="<?php echo $fecha1;?>" spellcheck="false"/>
				<hr id="Line15"/>
			</div>
		</div>
	</div>
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			...
			<div class="col-2">
				<hr id="Line12"/>
				<input type="date" id="fecha2" name="fecha2" value="<?php echo $fecha2;?>" spellcheck="false"/>
				<hr id="Line16"/>
			</div>
		</div>
	</div>
    ...
    <div id="wb_LayoutGrid6b">
    	<div id="LayoutGrid6b">
    				...
    				<hr id="Line7b"/>
    				<div id="wb_Text4b">
    					<div style="color:#FF0000;padding: 10px;"><strong><u>LEA CON ATENCI&Oacute;N</u></strong>: Con esta opci&oacute;n eliminar&aacute; los registros de auditoria correspondientes a un periodo de tiempo que usted seleccione, usuario y acci&oacute;n del sistema. Es un proceso delicado, por lo que se recomienda previamente efectuar un BACK-UP de los datos de la base.</div>
    				</div>
    				<hr id="Line13b"/>
...
<div id="wb_LayoutGrid8">
	<div id="LayoutGrid8">
		<div class="row">
			<div class="col-1">
				<hr id="Line17"/>
				<input type="button" id="Button1" onclick="submitir()" name="guardar" value="Confirmar"/>
				<hr id="Line18"/>
			</div>
			<div class="col-2">
			</div>
...
if ($_GET["mensage"]==4) 
 {
	echo "<script type=''>
      swal('','Debe indicar al menos un par\u00e1metro !','error');
      </script>"; 
 }
if ($_GET["mensage"]==1 || $_GET["mensage"]==2)
 {
	echo "<script type=''>
      swal('','Fecha incorrecta !','error');
      </script>"; 
 }                         
if ($_GET["mensage"]==5)
 {
	echo "<script type=''>
      swal('','RANGO de fechas incorrecto !','error');
      </script>"; 
 }                         
if ($_GET["mensage"]==99)
 {
	echo "<script type=''>
      swal('','Se han eliminado los registros de las fechas seleccionadas','success');
      </script>"; 
 }  

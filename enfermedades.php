...
$(function() {
    ...
    jQuery("#listaenfermedades").jqGrid({
        url:'datosenfermedades.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Enfermedad de Notificaci&oacute;n Obligatoria'],
        colModel:[
				{name:'modificar', width:100, resizable:false, align:"center",sorttype:"int", editable: false, editoptions:{maxlength:"50"}, search: false},
                {name:'codenferm',index: "codenferm", width: 827, editable: true, searchoptions: {attr: {maxlength: 100,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
	...
	grid = $("#listaenfermedades");							
//	jQuery("#listaenfermedades").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaenfermedades").jqGrid('setFrozenColumns');

    jQuery("#listaenfermedades").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listaenfermedades"></table>
        <div id="perpage"></div>
      </div>        
        <br />

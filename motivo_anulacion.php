...
$(function() {
    ...
    jQuery("#listamotivoanulacion").jqGrid({
        url:'datosmotivoanulacion.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colNames:['Revisar','Borrar','C&oacute;digo','Motivo de Anulaci&oacute;n'],
        colModel:[
                ...
                {name:'codanula',index:'codanula', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'nomanula',index: "nomanula", width: 727, editable: true, searchoptions: {attr: {maxlength: 250,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}
                 ],
                                  
                caption: "MOTIVOS DE ANULACIONES",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],
	...
	grid = $("#listamotivoanulacion");							
//	jQuery("#listamotivoanulacion").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listamotivoanulacion").jqGrid('setFrozenColumns');

    jQuery("#listamotivoanulacion").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_motivo_anulacion.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listamotivoanulacion"></table>
        <div id="perpage"></div>
      </div>        
        <br />
    	...
    	<?php
         if ($v_443==2 || $v_443==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_motivo_anulacion.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_motivo_anulacion.php\';" name="agregar" value="Agregar">';

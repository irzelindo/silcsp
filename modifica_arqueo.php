			...
			<div class="row">
			  <div class="col-3">
				  <hr id="turnos_detallesLine7">
					<button type="button" id="Buttonc" class="btn btn-primary btn-lg" onclick="openImprimir()">Imprimir Arqueo</button>
			  </div>
		  </div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-1">
					...
					<?php
						 ...
						 {
							echo '<button type="button" id="Buttonc" class="btn btn-primary btn-lg" onclick="xajax_ValidarFormulario(xajax.getFormValues(formu));">Guardar Datos</button>';
						 }
					?>

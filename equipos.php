...
$(function() {
    ...
    jQuery("#listaequipos").jqGrid({
        url:'datosequipos.php',
        datatype: 'json',
        mtype: 'GET',
    	loadonce:true,
        height: 320,
        ...
        colModel:[
                ...
                {name:'codequipo',index:'codequipo', width:100, align:"center", editable: true, searchoptions: {attr: {maxlength: 10,size: 7,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}},
                {name:'decripcion',index: "decripcion", width: 477, editable: true, searchoptions: {attr: {maxlength: 200,size: 100,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}} ,
                {name:'tipo',index: "tipo", width: 277, editable: true, searchoptions: {attr: {maxlength: 80,size: 80,style: "width:auto;padding:1;max-width:100%;height:3em;float:left"}}}              
                 ],
                                  
                caption: "EQUIPOS ANALIZADORES",
                ignoreCase:true,                
                pager: '#perpage',
                rowNum:7,
                rowList:[7,15,30],
	...
	grid = $("#listaequipos");							
//	jQuery("#listaequipos").jqGrid('navGrid','#perpage',{edit:false,add:false,del:false,search:false},{},{},{},{closeAfterSearch:true, showQuery: true},{});
	jQuery("#listaequipos").jqGrid('setFrozenColumns');

    jQuery("#listaequipos").jqGrid('filterToolbar', {stringResult: true, searchOnEnter: false, defaultSearch : "cn"});
...
{ 
	swal({
			...
			.then((willDelete) => {
			  if (willDelete) 
			  { 	     
				window.location = "eliminar_equipos.php?id=" + cod ;
			  } 
			  else 
			  {
...
<div id="page1Layer1">
	<div id="page1Layer1_Container">
      ...
      <div class="jqGrid">
        <br/>
        <table id="listaequipos"></table>
        <div id="perpage"></div>
      </div>        
        <br />

    	<?php
         if ($v_4312==2 || $v_4312==3) 
            {
    	     //echo '<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href=\'nuevo_equipos.php\';">Agregar</span></button>';
             
             echo '<input type="submit" id="Button1" onclick="window.location.href=\'nuevo_equipos.php\';" name="agregar" value="Agregar">';

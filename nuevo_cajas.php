...
if ($_GET["mensage2"]==2 || $_GET["mensage2"]==1)
  ...
  $nomcaja     = $_SESSION['nomcaja'];    
  $region      = $_SESSION['region'];
  $codservicio = $_SESSION['codservicio'];
  $codusuc     = $_SESSION['codusuc'];
  }
else
  {
  $codcaja     = "";
...
<form name="formu" method="post" action="insertar_cajas.php">
    ...
    <div id="wb_LayoutGrid5">
    	<div id="LayoutGrid5">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line1"/>
    				<select name="codservicio" size="1" id="codservicio" onchange="Limpiar2()" onfocus="ComponerLista(window.document.formu.region.value)">
    					<option value=""></option>
                        <?php
    ...
    <div id="wb_LayoutGrid4">
    	<div id="LayoutGrid4">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line4"/>
                    <input type="text" class="form-control" placeholder="" name="codcaja" id="codcaja" size="10" maxlength="10" value="<?php echo $codcaja; ?>" onkeypress="return validarcar(event)" spellcheck="false"/>
    ...
    <div id="wb_LayoutGrid5">
    	<div id="LayoutGrid5">
    		<div class="row">
    			...
    			<div class="col-2">
    				<hr id="Line1"/>
    				<select name="codusuc" size="1" id="codusuc" onfocus="ComponerLista2(window.document.formu.codservicio.value)">
    					<option value=""></option>
                        <?php
...
<div id="wb_LayoutGrid7">
	<div id="LayoutGrid7">
		<div class="row">
			<div class="col-1">
				<hr id="Line16"/>
				<input type="button" id="Button1" onclick="verificacajas()" name="guardar" value="Guardar Datos"/>
				<hr id="Line11"/>
			</div>
			<div class="col-2">
			</div>

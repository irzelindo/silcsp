...
<script>
	$(document).ready(function(){
			...
			$("#reporte1").click(function(){
				...
				var nordentra = jQuery( "#ci" ).val();

				window.open('reporte_movimiento_muestra.php?nordentra='+nordentra, '_blank');
			...
			$("#reporte2").click(function(){
				...
				window.open('reporte_movimiento_muestra_excel.php?nordentra='+nordentra, '_blank');
		...
		<div class="row">
			<div class="col-1">
				...
				<div id="wb_Text1">
					...
					<br/>
					</strong></span><span style="color:#808080;font-family:Verdana;font-size:16px;"><strong>MOVIMIENTO DE MUESTRA</strong></span><span style="color:#000000;font-family:Arial;font-size:13px;"><strong><br/>
					</strong><br/>
					<br/>
					</span>
				</div>
...
<div id="wb_LayoutGrid4">
	<div id="LayoutGrid4">
		<div class="row">
			...
			<d<div class="col-2">
				<hr id="Line14"/>
				<input type="text" id="ci" name="ci" value="" spellcheck="false"/>
				<hr id="Line15"/>
			</div>
		</div>
	</div>
